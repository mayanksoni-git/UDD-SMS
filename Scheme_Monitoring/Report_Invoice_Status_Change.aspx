<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true"
    CodeFile="Report_Invoice_Status_Change.aspx.cs" Inherits="Report_Invoice_Status_Change" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" ValidateRequest="false" %>
                    ...
                    <div class="page-content">
                            ...
                            <div class="col-sm-12">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtFromDate" runat="server" CssClass="form-control date-picker" autocomplete="off" data-date-format="dd/mm/yyyy"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="ddlInvoiceStatus" runat="server" CssClass="form-control"></asp:DropDownList>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="control-label no-padding-right">Employee</label>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <br />
                                        <asp:CheckBox ID="chkShowUpToDate" Text="Show Up To Date Status Only" runat="server" CssClass="checkbox"></asp:CheckBox>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
