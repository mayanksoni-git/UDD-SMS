<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin_PMS.master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeFile="CreateMasterPlan.aspx.cs" Inherits="CreateMasterPlan" EnableEventValidation="false" ValidateRequest="false" %>
                                ...
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Create Master Plan</li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header align-items-center d-flex">
                                        <h4 class="card-title mb-0 flex-grow-1" id="head2" runat="server">Create Master Plan</h4>
                                        <a href="MasterPlan.aspx" class="filter-btn" style="float: right"><i class="icon-download"></i>Go To List</a>
                                    </div>
                                    <!-- end card header -->
                                    <div class="card-body">
                                            ...
                                            <div class="row gy-4">
                                                ...
                                                <div class="col-xxl-2 col-md-6">
                                                    <div id="divPopulation" runat="server">
                                                        <asp:Label ID="lblPopulation" runat="server" Text="Population" CssClass="form-label"></asp:Label>
                                                        <asp:TextBox ID="txtPopulation" runat="server" CssClass="form-control" onkeyup="isNumericVal(this);" TextMode="Number"></asp:TextBox>
                                                    </div>
                                                </div>

                                                <div class="col-xxl-3 col-md-6">
                                                    <div id="divArea" runat="server">
                                                        <asp:Label ID="lblArea" runat="server" Text="Area(In Square Meter)" CssClass="form-label fw-bold me-1"></asp:Label>
                                                        <asp:TextBox ID="txtArea" runat="server" placeholder="1000.5" CssClass="form-control"></asp:TextBox>
                                                    </div>
                                                </div>

                                                <div class="col-xxl-3 col-md-6">
                                                    <asp:Label ID="lblMasterPlanDoc" runat="server" Text="Upload Master Plan Doc" CssClass="form-label"></asp:Label>
                                                    <asp:FileUpload ID="fileUploadMasterPlanDoc" runat="server" CssClass="form-control" />
                                                    
                                                    <asp:RegularExpressionValidator ID="revFileUpload" runat="server"
                                                        ControlToValidate="fileUploadMasterPlanDoc"
                                                ...
                                                <div class="col-xxl-3 col-md-6">
                                                    <asp:HyperLink ID="hypMasterPlanDocEdit" runat="server" Target="_blank" Text="Click To View Master Plan Doc" Visible="false">
                                                 ...
                                                 <div class="col-xxl-12 col-md-6 text-center">
                                                    <div>
                                                        ...
                                                        <asp:HiddenField ID="hfMasterPlanId" runat="server" />
                                                    </div>
                                                </div>
                                            </div>
