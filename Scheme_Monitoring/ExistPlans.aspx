<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/TemplateMasterAdmin_PMS.master" CodeFile="ExistPlans.aspx.cs" Inherits="ExistPlans" %>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0">Existing Project</h4>
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Home</a></li>
                                            <li class="breadcrumb-item">Annual Action Plan</li>
                                            <li class="breadcrumb-item active">Existing Project</li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header align-items-center d-flex">
                                        <h4 class="card-title mb-0 flex-grow-1">Existing Project<label id="message" runat="server" style="float:right;color:red;font-weight:bold"></label></h4>
                                    </div>
                                    <!-- end card header -->
                                    <div class="card-body">
                                                 ...
                                                 <div class="col-xxl-3 col-md-6">
                                                  ...
                                                  <div class="col-xxl-3 col-md-6">
                                                    <div id="div6" runat="server">
                                                        <asp:Label ID="Label4" runat="server" Text="Status" CssClass="form-label fw-bold me-1"></asp:Label>
                                                         <asp:RadioButton ID="rdoYes" runat="server" Text="Functional" GroupName="YesNo"  />
                                                         <asp:RadioButton ID="rdoNo" runat="server" Text="Non-functional" GroupName="YesNo" />
                                                    </div>
                                                </div>
                                                    <div class="col-xxl-3 col-md-6">
                                                    <div id="div2" runat="server">
                                                        <asp:Label ID="Label2" runat="server" Text="Remark" CssClass="form-label fw-bold me-1"></asp:Label>
             ...
             <div class="container-fluid">
                 <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header align-items-center d-flex">
                                        <h4 class="card-title mb-0 flex-grow-1">Existing Project List</h4>
                                                ...
                                                <asp:GridView runat="server" ID="grdPost" CssClass="display table table-bordered"   AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdPost_PreRender">
                                                    <Columns>
                                                       ...
                                                       <asp:TemplateField HeaderText="Delete">
                                                        <ItemTemplate>
                                                             <asp:Button ID="btnDelete" runat="server" Text='Delete' CommandName="DeleteAnnualAction" OnCommand="btnDelete_Command" CommandArgument='<%# Eval("exPlanId") %>' CssClass="btn btn-danger drill_btn" />
                                                         </ItemTemplate>
