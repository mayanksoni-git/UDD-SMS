...
public partial class MasterProjectWork_Road_Reinst : System.Web.UI.Page
{
    ...
    {
        get_tbl_ProjectWork_Road_Reinstatement();
    }

    protected void get_tbl_ProjectWork_Road_Reinstatement()
    {
        int District_Id = 0;
        int Zone_Id = 0;
        int Circle_Id = 0;
        ...
        DataSet ds = new DataSet();
        ds = (new DataLayer()).get_tbl_ProjectWork_Road_Reinstatement(Scheme_Id, District_Id, Zone_Id, Circle_Id, Division_Id, ULB_Id, "", 0, txtProjectCode.Text.Trim(), 0);
        if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
        {
