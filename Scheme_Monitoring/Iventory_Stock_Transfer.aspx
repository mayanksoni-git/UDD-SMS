<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin2.master" AutoEventWireup="true" CodeFile="Iventory_Stock_Transfer.aspx.cs" Inherits="Iventory_Stock_Transfer" %>
                ...
                <ContentTemplate>
                    ...
                    <div class="page-content">
                        <div class="page-header">
                            <div class="row">
                                <h1>Item Stock Transfer (Inter Office)</h1>
                            </div>
                        </div>
                        </br>
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="table-header">
                                            Choose Office From Where Stock is To Be Transfered
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div id="divEntry" runat="server" visible="false">
                                                    ...
                                                    <div style="overflow: auto">
                                                        <asp:GridView ID="grdPost" runat="server" CssClass="display table table-bordered" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdPost_PreRender" OnRowDataBound="grdPost_RowDataBound">
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Qty To Be Transfred">
                                                                    <ItemTemplate>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <div class="table-header">
                                                Choose Office To Where Stock is To Be Transfered
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-4">
                                            <div class="form-group">
                                                <asp:Label ID="lblZoneHH" runat="server" Text="Zone" CssClass="control-label no-padding-right"></asp:Label>
                                                <asp:DropDownList ID="ddlZoneD" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlZoneD_SelectedIndexChanged"></asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="col-xs-4">
                                            <div class="form-group">
                                                <asp:Label ID="lblCircleHH" runat="server" Text="Circle" CssClass="control-label no-padding-right"></asp:Label>
                                                <asp:DropDownList ID="ddlCircleD" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlCircleD_SelectedIndexChanged"></asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="col-xs-4">
                                            <div class="form-group">
                                                <asp:Label ID="lblDivisionHH" runat="server" Text="Division" CssClass="control-label no-padding-right"></asp:Label>
                                                <asp:DropDownList ID="ddlDivisionD" runat="server" CssClass="form-control"></asp:DropDownList>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-3">
                                            <div class="form-group">
                                                <br />
                                                <asp:Button ID="btnTransfer" Text="Transfer Selected Stocks" OnClick="btnTransfer_Click" runat="server" CssClass="btn btn-danger"></asp:Button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
