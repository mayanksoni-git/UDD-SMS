...
public partial class Report_Invoice_Status_Change_ADP : System.Web.UI.Page
{
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        DataSet ds = new DataSet();
        ds = (new DataLayer()).get_ADP_Invoice_Status_History(Zone_Id, Circle_Id, Division_Id, Project_Id, txtFromDate.Text.Trim(), txtTillDate.Text.Trim(), InvoiceStatus_Id, 0, 0, 0, 0);
        if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
        {
