<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true"
    CodeFile="MasterParentQualification.aspx.cs" Inherits="MasterParentQualification" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" ValidateRequest="false" %>
        ...
        <div class="main-content-inner">
            ...
            <asp:UpdatePanel ID="up" runat="server">
                <ContentTemplate>
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div style="overflow: auto">
                                            <asp:GridView ID="grdPost" runat="server" CssClass="display table table-bordered" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdPost_PreRender">
                                                <Columns>
                                                    <asp:BoundField DataField="ParentQualification_Id" HeaderText="ParentQualification_Id">
                                                    ...
                                                    <asp:BoundField DataField="ParentQualification_Name" HeaderText="Qualification Criteria" />
                                                    <%-- <asp:TemplateField HeaderText="ParentQualification">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtParentQualificationG" Enabled="false" runat="server" CssClass="form-control" Text='<%# Eval("ParentQualification_Name") %>'></asp:TextBox>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>--%>
                            ...
                            <div class="col-md-12">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <asp:Label ID="lblParentQualification" runat="server" Text="Qualification Criteria*" CssClass="control-label no-padding-right"></asp:Label>
                                        <asp:TextBox ID="txtParentQualification" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                    ...
                    <asp:HiddenField ID="hf_ParentQualification_Id" runat="server" Value="0" />
                </ContentTemplate>
            </asp:UpdatePanel>
