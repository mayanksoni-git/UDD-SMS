<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true"
    CodeFile="CreateEMB_TokenApprove.aspx.cs" Inherits="CreateEMB_TokenApprove" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" ValidateRequest="false" %>
                        ...
                        <div id="divEntry" runat="server" visible="false">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="col-md-12">
                                        <div style="overflow: auto">
                                            <asp:GridView ID="grdEMB" runat="server" CssClass="display table table-bordered" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdEMB_PreRender" OnRowDataBound="grdEMB_RowDataBound">
                                                <Columns>
                                                ...
                                                <asp:BoundField HeaderText="BOQ Sr.No." DataField="PackageBOQ_Sr_No" />
                                                    ...
                                                    <asp:BoundField DataField="PackageEMB_RateEstimated" HeaderText="Rate Estimated" />
                                                    <asp:BoundField DataField="PackageEMB_RateQuoted" HeaderText="Rate Quoted" />
                                        ...
                                        <asp:GridView ID="grdDeductionsM" runat="server" CssClass="display table table-bordered" AutoGenerateColumns="False" EmptyDataText="No Records Found">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Deduction Value">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtDeductionValue" onkeyup="isNumericVal(this);" runat="server" CssClass="form-control" Text='<%# Eval("PackageEMBAdditional_Deduction_Value_Master") %>'></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
