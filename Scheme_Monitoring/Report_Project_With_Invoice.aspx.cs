...
public partial class Report_Project_With_Invoice : System.Web.UI.Page
{
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            Budget_From = Convert.ToInt32(txtFromRange.Text.Trim());
        }
        catch
        {
            Budget_From = 0;
        ...
        try
        {
            Budget_Till = Convert.ToInt32(txtTillRange.Text.Trim());
        }
        catch
        {
            Budget_Till = 0;
        ...
        DataSet ds = new DataSet();
        ds = (new DataLayer()).get_Project_Work_With_Invoicing(Project_Id, Zone_Id, Circle_Id, Division_Id, Budget_From, Budget_Till, txtDateFrom.Text, txtDateTill.Text);
        if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
        {
