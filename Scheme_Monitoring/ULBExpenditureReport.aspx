<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/TemplateMasterAdmin_PMS.master" CodeFile="ULBExpenditureReport.aspx.cs" Inherits="ULBExpenditureReport" %>
                         ...
                         <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0" id="HeadingSec" runat="server">ULB Expenditure Report</h4>
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Home</a></li>
                                            <li class="breadcrumb-item">Annual Action Plan Report</li>
                                            <li class="breadcrumb-item active">ULB Expenditure Report</li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <table id="sample-table-2" class="mt-5 table table-striped table-bordered table-hover">
                                                ...
                                                <thead >
                                                    <tr class="table-success">
                                                        <th style="text-align: center;font-size:26px"  colspan="4" rowspan="1"> Annual Expenditure :
                                                            <label id="AnnualULB" runat="server"></label>
                                                        </th>
                                                        </tr>
                                                    <tr>
                                                        <th style="font-size:18px" colspan="3">District :
                                                    ...
                                                    <tr>
                                                        <th style="font-size:18px" colspan="3">Year :
                                                    ...
                                                    <tr class="table-primary">
                                                        ...
                                                        <th rowspan="2">Name Of Head
                                                         ...
                                                         <th style="text-align: right" rowspan="2">New Expense
                                                        </th>
                                                         <th style="text-align: right" rowspan="2">Maintenance Expense
                                                        </th>
                                                    </tr>
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td align="left">
                                                    ...
                                                    <%#DataBinder.Eval(Container,"DataItem.ULBExpenseType_Name")%>
                                                </td>
                                                <td style="text-align: right">
                                                    <%#DataBinder.Eval(Container,"DataItem.NewAmount")%>
                                                </td>
                                                <td style="text-align: right">
                                                    <%#DataBinder.Eval(Container,"DataItem.MaintenanceAmount")%>
                                                </td>
