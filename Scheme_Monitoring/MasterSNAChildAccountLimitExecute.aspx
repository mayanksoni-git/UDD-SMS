<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true" CodeFile="MasterSNAChildAccountLimitExecute.aspx.cs" Inherits="MasterSNAChildAccountLimitExecute" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" ValidateRequest="false" %>
                                ...
                                <div style="overflow: auto">
                                    <asp:GridView ID="grdPost" runat="server" AutoGenerateColumns="False" CssClass="display table table-bordered" EmptyDataText="No Records Found" OnPreRender="grdPost_PreRender" OnRowDataBound="grdPost_RowDataBound">
                                        <Columns>
                                            ...
                                            <asp:BoundField HeaderText="Limit Assigned Curent" DataField="AssignedLimit" />
                                            <asp:BoundField HeaderText="Limit Assigned Total" DataField="SNAAccountLimit_AssignedLimit" />
                                            <asp:BoundField HeaderText="Limit Used" DataField="SNAAccountLimitUsed_UsedLimit" />
                                            <asp:BoundField HeaderText="Limit Available" DataField="SNAAccountAvailableLimit" />
                                            <asp:BoundField HeaderText="Balance As Per PNB" DataField="SNAAccountMaster_Balance" />
                                            <asp:TemplateField HeaderText="Execute">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkBalance" runat="server" OnClick="lnkBalance_Click">Execute</asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
