...
public partial class DeductionReleaseReport : System.Web.UI.Page
{
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        bool? isDefered = null;
        DataSet ds = new DataSet();
        ds = (new DataLayer()).get_tbl_Package_DeductionRelease(0, Project_Id, 0, Zone_Id, Circle_Id, Division_Id, 0, "", "", 0, 0, true, "", "", Expert_Person_Id, 0, 0, false, isDefered, 0);
        if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
        {
    ...
    protected void btnDelete_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (new DataLayer().Delete_Package_DeductionRelease(Package_ADP_Id, Person_Id))
        {
    ...
    protected void btnView_Click(object sender, ImageClickEventArgs e)
    {
        ...
        DataSet ds = new DataSet();
        ds = (new DataLayer()).get_tbl_Package_DeductionReleaseApproval_History(Package_ADP_Id);
    ...
    protected void btnRollBack_Click(object sender, ImageClickEventArgs e)
    {
        ...
        int Person_Id = Convert.ToInt32(Session["Person_Id"].ToString());
        if (new DataLayer().RollBack_Package_DeductionReleaseApproval(PackageADPApproval_Id, Person_Id))
        {
