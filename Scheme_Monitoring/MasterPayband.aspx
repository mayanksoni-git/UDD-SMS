<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin2.master" AutoEventWireup="true" CodeFile="MasterPayband.aspx.cs" Inherits="MasterPayband" %>
        ...
        <div class="main-content-inner">
            ...
            <asp:UpdatePanel ID="up" runat="server">
                <ContentTemplate>
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div style="overflow: auto">
                                            <asp:GridView ID="grdPost" runat="server" CssClass="display table table-bordered" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdPost_PreRender">
                                                <Columns>
                                                    <asp:BoundField DataField="PayBand_Id" HeaderText="PayBand_ID">
                                                    ...
                                                    <asp:BoundField DataField="PayBand_Name" HeaderText="Pay Band" />
                            ...
                            <div class="col-md-12">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <asp:Label ID="lblPayBand" runat="server" Text="Pay Band*" CssClass="control-label no-padding-right"></asp:Label>
                                        <asp:TextBox ID="txtPayBand" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                    ...
                    <asp:HiddenField ID="hf_PayBand_Id" runat="server" Value="0" />
