...
public partial class MasterEMBVendor : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Session["Vendor_Id"] == null || Session["Vendor_Id"] == null)
        {
    ...
    protected void btnEdit_Click(object sender, ImageClickEventArgs e)
    {
        ...
        DataSet ds = new DataSet();
        get_Employee_Staff_JEAPE(Convert.ToInt32(hf_ProjectWork_Id.Value), 0);
    ...
    private void get_Employee_Staff_JEAPE(int Package_Id, int Division_Id)
    {
        ...
        DataSet ds = new DataSet();
        ds = (new DataLayer()).get_Employee_Reporting("", 0, 0, Division_Id, Designation_Id, Package_Id, 0);
        if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
        {
            AllClasses.FillDropDown(ds.Tables[0], ddlJE, "Person_Name_Mobile", "Person_Id");
        }
        else
        {
            ddlJE.Items.Clear();
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        DataSet ds = new DataSet();
        ds = (new DataLayer()).get_tbl_ProjectWorkPkgVendorWise(Convert.ToInt32(Session["Vendor_Person_Id"].ToString()), Project_Id);
        if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
        {
    ...
    protected void btnSaveEMB_Click(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < grdEMB.Rows.Count; i++)
        {
            ...
            obj_tbl_PackageEMB.PackageEMB_AddedBy = Convert.ToInt32(Session["Vendor_Person_Id"].ToString());
        ...
        else
        {
            ...
            {
                if ((new DataLayer()).Insert_tbl_PackageEMB_Shadow(null, obj_tbl_PackageEMB_Li, Convert.ToInt32(ddlSearchScheme.SelectedValue), "O"))
                {
                    MessageBox.Show("Package Shadow EMB Created Successfully!");
                    reset();
                    return;
                }
                else
                {
                    MessageBox.Show("Error In Creating Package Shadow EMB!");
                    return;
                }
            }
        }
    ...
    protected void btnSaveAndForward_Click(object sender, EventArgs e)
    {
        ...
        obj_tbl_PackageEMB_Master.PackageEMB_Master_AddedBy = Convert.ToInt32(Session["Vendor_Person_Id"].ToString());
        ...
        obj_tbl_PackageEMB_Master.PackageEMB_Master_RA_BillNo = "";
        ...
        obj_tbl_PackageEMBApproval.PackageEMBApproval_AddedBy = Convert.ToInt32(Session["Vendor_Person_Id"].ToString());
        ...
        else
        {
            ...
            {
                if ((new DataLayer()).Insert_tbl_PackageEMB_Shadow(obj_tbl_PackageEMB_Master, obj_tbl_PackageEMB_Li, Convert.ToInt32(ddlSearchScheme.SelectedValue), "O"))
                {
                    MessageBox.Show("Package Shadow EMB Created Successfully!");
                    reset();
                    return;
