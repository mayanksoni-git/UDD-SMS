...
public partial class ULBIncomeExpenseReport : System.Web.UI.Page
{
    ...
    //    dt = objLoan.GetReportOfULBIncomeExpense(st,fy,ulb,type,fy);
    ...
    protected void BtnSearch_Click(object sender, EventArgs e)
    {
        ...
        var Dist = ddlCircle.SelectedValue != "" ? Convert.ToInt32(ddlCircle.SelectedValue) : 0;
        var ULB = ddlDivision.SelectedValue != "" ? Convert.ToInt32(ddlDivision.SelectedValue) : 0;
        var ULBType = ddlULBType.SelectedValue != "" ? ddlULBType.SelectedValue : "0";
        var FY = ddlFY.SelectedValue != "" ? Convert.ToInt32(ddlFY.SelectedValue) : 0;

        Response.Redirect("PrintULBIncomeExpenseReport?State=" + state+"&&District="+Dist+"&&ULB="+ULB+"&&ULBType="+ULBType+"&&FYID="+FY+"");
        //GetAllData();
    }
