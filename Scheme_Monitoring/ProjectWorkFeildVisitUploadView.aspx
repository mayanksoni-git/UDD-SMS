                ...
                <ContentTemplate>
                    ...
                    <div class="page-content">
                        <div class="page-content">
                            ...
                            <div class="row">
                                <div style="overflow: auto">
                                    <asp:GridView ID="grdPhysicalProgress" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdPhysicalProgress_PreRender">
                                        <Columns>
                        ...
                        <asp:Panel ID="Panel1" runat="server" CssClass="modalPopup1" Style="display: none; width: 950px; margin-left: -32px" Height="700px">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="col-md-12">
                                        <div style="overflow: auto">
                                            <asp:GridView ID="grdComments" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-hover" EmptyDataText="No Records Found" OnPreRender="grdComments_PreRender">
                                                <Columns>
