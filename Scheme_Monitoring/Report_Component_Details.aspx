                    ...
                    <div class="page-content">
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <h3 class="header smaller lighter blue">Component Wise Analysis Report</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="control-label no-padding-right">Component</label>
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        <div class="table-header">
                                            Component Progress Analysis Report
                                        </div>
                                        ...
                                        <div style="overflow: auto">
                                            <asp:GridView ID="grdPost" runat="server" CssClass="display table table-bordered"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="WithheldProgress" HeaderText="Withheld / Blocked Due to Other Work" />
                    ...
                    var chart = new CanvasJS.Chart("chartContainerP_ZoneWise",
                        {
                            ...
                            data: [{
                                ...
                                indexLabel: "{name} - {y}",
                                dataPoints: [
                                    { y: DashboardData.ALD, name: "No Of Component Completed", exploded: true },
                                    { y: DashboardData.AGR, name: "Total No Of Component" }
                                ]
                            }]
                        });
                    chart.render();
