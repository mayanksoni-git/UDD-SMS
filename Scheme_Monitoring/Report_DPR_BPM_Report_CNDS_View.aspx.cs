...
public partial class Report_DPR_BPM_Report_CNDS_View : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (Session["DPR_Dash_Data"] != null)
            {
                get_tbl_ProjectWorkDPR();
            }
            else
            {
                MessageBox.Show("No recirds Found");
            }
        }
    }
    ...
    protected void get_tbl_ProjectWorkDPR()
    {
        ...
        ds1 = (DataSet)Session["DPR_Dash_Data"];
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        DataSet ds1 = (new DataLayer()).get_tbl_ProjectWorkDPR_CNDS(Scheme_Id, District_Id, Zone_Id, Circle_Id, Division_Id, ULB_Id, 0, 0, 0, NodalDepartment_Id, NodalDepartmentScheme_Id, _Scheme_Id, DPR_Status.TotalDPR, Jurisdiction_In);
        if (ds1 != null && ds1.Tables.Count > 0 && ds1.Tables[0].Rows.Count > 0)
        {
