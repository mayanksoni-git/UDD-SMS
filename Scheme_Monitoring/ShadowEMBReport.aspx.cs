...
public partial class ShadowEMBReport : System.Web.UI.Page
{
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        get_tbl_PackageEMB_Approve();
    }

    private void get_tbl_PackageEMB_Approve()
    {
        int Project_Id = 0;
        int Zone_Id = 0;
        int Circle_Id = 0;
        ...
        DataSet ds = new DataSet();
        ds = (new DataLayer()).get_tbl_PackageEMB_Shadow(0, Project_Id.ToString(), 0, Zone_Id, Circle_Id, Division_Id, 0, "", "", 0, 0, 0, "", false, txtDateFrom.Text, txtDateTill.Text, 0, false, 0);
    ...
    protected void btnDelete_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (new DataLayer().Delete_EMB_Shadow(EMBMaster_Id, Person_Id))
        {
        ...
        {
            MessageBox.Show("Error in Shadow EMB Is Deletion.!!");
            return;
        }
    }
}