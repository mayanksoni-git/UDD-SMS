...
public partial class ADPReport : System.Web.UI.Page
{
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        bool? isDefered = null;
        DataSet ds = new DataSet();
        ds = (new DataLayer()).get_tbl_Package_ADP(0, Project_Id.ToString(), 0, Zone_Id, Circle_Id, Division_Id, 0, "", "", 0, 0, true, "", "", 0, 0, 0, false, isDefered, 0);
        if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
        {
    ...
    protected void btnDelete_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (new DataLayer().Delete_ADP(Package_ADP_Id, Person_Id))
        {
    ...
    protected void btnView_Click(object sender, ImageClickEventArgs e)
    {
        ...
        DataSet ds = new DataSet();
        ds = (new DataLayer()).get_tbl_ADPApproval_History(Package_ADP_Id);
    ...
    protected void btnRollBack_Click(object sender, ImageClickEventArgs e)
    {
        ...
        int Person_Id = Convert.ToInt32(Session["Person_Id"].ToString());
        if (new DataLayer().RollBack_ADP(PackageADPApproval_Id, Person_Id))
        {
