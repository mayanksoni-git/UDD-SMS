<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true" CodeFile="TATReport.aspx.cs" Inherits="TATReport" %>
            ...
            <asp:UpdatePanel ID="up" runat="server">
                <ContentTemplate>
                    ...
                    <div class="page-content">
                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="table-header">
                                   ...
                                   <div class="form-group" style="float: right; padding-right: 10px">
                                            <asp:ImageButton ID="lnkTATConfig" runat="server" OnClick="lnkTATConfig_Click" ImageUrl="~/assets/images/Data_Entry.png" Width="30px" Height="20px"></asp:ImageButton>
                                        </div>
                        ...
                        <div runat="server" visible="false" id="divData">
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <h3 class="header smaller lighter blue">Invoice TAT Report</h3>
                        ...
                        <asp:Panel ID="Panel1" runat="server" CssClass="modalPopup1" align="center" Style="display: none" ScrollBars="Auto">
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="row">
                                        <div class="col-xs-12">
                                    ...
                                    <div class="row">
                                        <asp:GridView ID="grdTATConfig" runat="server" CssClass="display table table-bordered" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdTATConfig_PreRender">
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="Designation_Name" HeaderText="Desination" />
                                                <asp:TemplateField HeaderText="TAT">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtTAT" runat="server" Text="1"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="row">
                                        <div class="col-xs-6">
                                            <br />
                                            <asp:Button ID="btnSaveTAT" runat="server" CssClass="btn btn-info" Text="Save TAT & Apply" OnClick="btnSaveTAT_Click" />
                                        </div>
                                        <div class="col-xs-6">
                                            <br />
