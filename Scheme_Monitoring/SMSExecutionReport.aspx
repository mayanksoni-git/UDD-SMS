<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true" CodeFile="SMSExecutionReport.aspx.cs" Inherits="SMSExecutionReport" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" ValidateRequest="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <br />
                                        <asp:Button ID="btnSearch" runat="server" Text="Show SMS Log" OnClick="btnSearch_Click" CssClass="btn btn-info" />
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div style="overflow: auto">
                                        <asp:GridView ID="grdSMSHistory" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="false" EmptyDataText="No Records Found" OnPreRender="grdSMSHistory_PreRender">
                                            <Columns>
                                                ...
                                                <asp:BoundField HeaderText="Mobile No" DataField="SMS_Mobile_No" />
                                                <asp:BoundField HeaderText="SMS Content" DataField="SMS_Content" />
                                                <asp:BoundField HeaderText="Added On" DataField="SMS_AddedOn" />
                                                <asp:BoundField HeaderText="Response" DataField="SMS_Response" />
                                            </Columns>
                                        </asp:GridView>
                                    </div>
                                </div>
    ...
    <script type="text/javascript">
        Sys.WebForms.PageRequestManager.getInstance().add_pageLoaded(function (evt, args) {
            jQuery(function ($) {
                var DataTableLength = $('#ctl00_ContentPlaceHolder1_grdSMSHistory').length;
                if (DataTableLength > 0) {
                    var outerHTML = $('#ctl00_ContentPlaceHolder1_grdSMSHistory')[0].outerText;
                    if (outerHTML !== "No Records Found") {
                        //initiate dataTables plugin
                        var myTable =
                            $('#ctl00_ContentPlaceHolder1_grdSMSHistory')
                        ...
                        $(document).on('click', '#ctl00_ContentPlaceHolder1_grdSMSHistory .dropdown-toggle', function (e) {
    ...
    <script type="text/javascript" language="javascript">
        function countChar(obj) {
            document.getElementById('ctl00_ContentPlaceHolder1_lblCount').innerHTML = obj.textLength;
        }
    </script>
</asp:Content>
