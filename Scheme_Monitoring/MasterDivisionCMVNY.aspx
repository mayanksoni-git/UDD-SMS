<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true" CodeFile="MasterDivisionCMVNY.aspx.cs" Inherits="MasterDivisionCMVNY" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" ValidateRequest="false" %>
                         ...
                         <div id="divCreateNew" runat="server" visible="false" class="card">
                            <div class="card-body">
                               ...
                               <div class="row">
                                   ...
                                   <div class="col-md-4">
                                        <div class="form-group">
                                            <asp:Label ID="lblQFVP" CssClass="control-label no-padding-right" Text="Is Qualified for Vision Plan" runat="server"></asp:Label>
                                            <asp:CheckBox ID="chkQFVP" runat="server" CssClass="form-control mb-2" />
                                        </div>
                                    </div>
