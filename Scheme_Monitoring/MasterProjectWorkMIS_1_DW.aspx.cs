...
public partial class MasterProjectWorkMIS_1_DW : System.Web.UI.Page
{
    ...
    protected void txtAgreementAmount_TextChanged(object sender, EventArgs e)
    {
        decimal Tender_Cost_Total = 0;

        grdPackageDetails.FooterRow.Cells[12].Text = Tender_Cost_Total.ToString();
    }
