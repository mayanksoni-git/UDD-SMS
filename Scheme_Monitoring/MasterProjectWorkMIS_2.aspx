<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true"
    CodeFile="MasterProjectWorkMIS_2.aspx.cs" Inherits="MasterProjectWorkMIS_2" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" ValidateRequest="false" %>
                                        ...
                                        <div style="overflow: auto">
                                            <asp:GridView ID="grdCallProductDtls" runat="server" CssClass="display table table-bordered" AutoGenerateColumns="false" EmptyDataText="No Records Found" ShowFooter="true" OnPreRender="grdCallProductDtls_PreRender" OnRowDataBound="grdCallProductDtls_RowDataBound">
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="GO_Total" HeaderText="Total Without Centage" ControlStyle-Font-Bold="true" />
                                                    ...
                                                    <asp:TemplateField HeaderText="Download GO Document">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkFRID" runat="server" Text="Download" GO_FilePath='<%#Eval("ProjectWorkGO_Document_Path") %>' OnClientClick="return downloadGO(this);"></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                        ...
                                        <div style="overflow: auto">
                                            <asp:GridView ID="grdULBShare" runat="server" CssClass="display table table-bordered" AutoGenerateColumns="false" EmptyDataText="No Records Found" ShowFooter="true" OnPreRender="grdULBShare_PreRender" OnRowDataBound="grdULBShare_RowDataBound">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="ULB Share Released (In Lakhs)">
                                                        <ItemTemplate>
