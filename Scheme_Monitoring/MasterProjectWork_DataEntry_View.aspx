<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true" CodeFile="MasterProjectWork_DataEntry_View.aspx.cs" Inherits="MasterProjectWork_DataEntry_View" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" ValidateRequest="false" %>
                                            ...
                                            <asp:GridView ID="grdPost" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdPost_PreRender" OnRowDataBound="grdPost_RowDataBound">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Select">
                                                        <ItemTemplate>
                                                            <asp:ImageButton ID="btnEdit" Width="80px" Height="50px" OnClick="btnEdit_Click" ImageUrl="~/assets/images/edit_btn.png" runat="server" /><br />
                                                    ...
                                                    <asp:BoundField HeaderText="GO Date" Visible="false" DataField="ProjectWork_GO_Date" />
                                                    ...
                                                    <asp:BoundField HeaderText="End Date As Per Agreement (Extended)" DataField="Target_Date_Agreement_Extended" />
