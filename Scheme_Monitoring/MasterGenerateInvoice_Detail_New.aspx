<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true" CodeFile="MasterGenerateInvoice_Detail_New.aspx.cs" Inherits="MasterGenerateInvoice_Detail_New" %>
                                        ...
                                        <asp:GridView ID="grdInvoice" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdInvoice_PreRender">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="View EMB">
                                                    <ItemTemplate>
                                                        <a href="ViewEMBDetails_New.aspx?Invoice_Id=<%# Eval("PackageInvoice_Id") %>" target="_blank">View EMB</a>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div style="float: right" runat="server" id="divChkShowEMB">
                                        <asp:CheckBox runat="server" ID="chkFilter" Text="Show Current Invoice Items ." OnCheckedChanged="chkFilter_CheckedChanged" AutoPostBack="true" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                        ...
                                        <div style="overflow: auto">
                                            <asp:GridView ID="grdBOQ" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdBOQ_PreRender" OnRowDataBound="grdBOQ_RowDataBound" ShowFooter="true">
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="PackageInvoiceItem_Total_Qty" HeaderText="Total_Qty">
                                                        <HeaderStyle CssClass="displayStyle" />
                                                        <ItemStyle CssClass="displayStyle" />
                                                        <FooterStyle CssClass="displayStyle" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="PackageInvoiceItem_RateEstimated" HeaderText="PackageInvoiceItem_RateEstimated">
                                                        <HeaderStyle CssClass="displayStyle" />
                                                        <ItemStyle CssClass="displayStyle" />
                                                        <FooterStyle CssClass="displayStyle" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="PackageInvoiceItem_RateQuoted" HeaderText="PackageInvoiceItem_RateQuoted">
                                                        <HeaderStyle CssClass="displayStyle" />
                                                        <ItemStyle CssClass="displayStyle" />
                                                        <FooterStyle CssClass="displayStyle" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="PackageInvoiceItem_GSTType" HeaderText="PackageInvoiceItem_GSTType">
                                                        <HeaderStyle CssClass="displayStyle" />
                                                        <ItemStyle CssClass="displayStyle" />
                                                        <FooterStyle CssClass="displayStyle" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="PackageInvoiceItem_GST" HeaderText="PackageInvoiceItem_GST">
                                                        <HeaderStyle CssClass="displayStyle" />
                                                        <ItemStyle CssClass="displayStyle" />
                                                        <FooterStyle CssClass="displayStyle" />
                                                    </asp:BoundField>
                                                    ...
                                                    <asp:BoundField HeaderText="Quantity (BOQ)" DataField="PackageInvoiceItem_Total_Qty" />
                                                    <asp:BoundField DataField="PackageInvoiceItem_RateEstimated_T" HeaderText="Rate Estimated (Excluding GST)" />
                                                    <asp:BoundField DataField="PackageInvoiceItem_RateQuoted_T" HeaderText="Rate Quoted (Excluding GST)" />
                                                    <asp:BoundField DataField="PackageInvoiceItem_SincePrev" HeaderText="Quantity executed Since Previous" />
                                                    <asp:BoundField DataField="PackageInvoiceItem_SincePrevAmount" HeaderText="Payment on the basis of actual measurements (Since Previous)" />
                                                        ...
                                                        <ItemTemplate>
                                                            <table class="table table-striped table-bordered table-hover">
                                                                <tbody>
                                                                    <tr>
                                                                        <td class="">
                                                                            <asp:TextBox ID="txtQty" runat="server" CssClass="form-control" Text='<%# Eval("PackageInvoiceItem_UpToDate") %>' Width="80px" MaxLength="10" onkeyup="isNumericVal(this);" AutoPostBack="true" OnTextChanged="txtQty_TextChanged"></asp:TextBox>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="">
                                                        ...
                                                        <ItemTemplate>
                                                            <table class="table table-striped table-bordered table-hover">
                                                                <tbody>
                                                                    <tr>
                                                                        <td class="">
                                                                            <asp:TextBox ID="lblPercentageToBeReleased" runat="server" Text='<%# Eval("PackageInvoiceItem_PercentageToBeReleased") %>' AutoPostBack="true" OnTextChanged="txtQty_TextChanged" Width="80px"></asp:TextBox>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="">
                                                    ...
                                                    <asp:BoundField DataField="PackageInvoiceItem_UpToDateAmount" HeaderText="Payment on the basis of actual measurements (Up To Date)" />
                                                    <asp:BoundField DataField="PackageInvoiceItem_Total_Qty_BOQ" HeaderText="Quantity executed (As Per Current MB)" />
                                                    <asp:BoundField DataField="Total_Tax" HeaderText="GST" />
                                                    <asp:BoundField HeaderText="Amount" DataField="CurrentInvoice_Total_Amount" />
                                                    ...
                                                    <asp:BoundField DataField="PackageInvoiceItem_SincePrevAmount_OnlyGST" HeaderText="PackageInvoiceItem_SincePrevAmount_OnlyGST">
                                                        <HeaderStyle CssClass="displayStyle" />
                                                        <ItemStyle CssClass="displayStyle" />
                                                        <FooterStyle CssClass="displayStyle" />
                                                    </asp:BoundField>
                                    ...
                                    <div style="overflow: auto">
                                        <asp:GridView ID="grdDeductionsM" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" EmptyDataText="No Records Found" ShowFooter="true" OnRowDataBound="grdDeductionsM_RowDataBound">
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="PackageInvoiceAdditional2_Id" HeaderText="PackageInvoiceAdditional2_Id">
                                                    <HeaderStyle CssClass="displayStyle" />
                                                    <ItemStyle CssClass="displayStyle" />
                                                    <FooterStyle CssClass="displayStyle" />
                                                </asp:BoundField>
                                                ...
                                                <asp:TemplateField HeaderText="Deduction Value">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtDeductionValue" onkeyup="isNumericVal(this);" runat="server" CssClass="form-control" Text='<%# Eval("Deduction_Value_Master") %>' AutoPostBack="true" OnTextChanged="txtDeductionValue_TextChanged1"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
