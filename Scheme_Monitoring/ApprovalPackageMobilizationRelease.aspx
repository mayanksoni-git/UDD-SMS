<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true" CodeFile="ApprovalPackageMobilizationRelease.aspx.cs" Inherits="ApprovalPackageMobilizationRelease" %>
                    ...
                    <div class="page-content">
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <div class="table-header">
                                    Select A Work Package To Approval Mobilization / Designe & Drawing Release
                        ...
                        <div id="divEntry" runat="server" visible="false">
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="table-header">
                                        Add mobilization Advance Details
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:RadioButtonList ID="rbtAdvanceType" runat="server">
                                                        ...
                                                        <asp:ListItem Value="D">Design and Drawing</asp:ListItem>
                                                        <asp:ListItem Value="S">Secured Advance</asp:ListItem>
                                                    </asp:RadioButtonList>
                                                </td>
                                                <td>
                                                    <asp:Label runat="server" ID="lblPer"></asp:Label></td>
                                                <td>
                                                    <asp:TextBox runat="server" ID="txtTotalMobilizationAmount" Text="0" ReadOnly="true"></asp:TextBox></td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="control-label no-padding-right">Remark</label>
                                            ...
                                            <div id="doc2" class="tab-pane fade">
                                                <div style="overflow: auto">
                                                    <asp:GridView ID="grdMultipleFiles" runat="server" CssClass="display table table-bordered" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnRowDataBound="grdMultipleFiles_RowDataBound">
                                                        <Columns>
                                                            <asp:BoundField DataField="Package_MobilizationAdvanceDocs_FileName" HeaderText="Package_MobilizationAdvanceDocs_FileName">
                                                                <HeaderStyle CssClass="displayStyle" />
                                                                <ItemStyle CssClass="displayStyle" />
                                                                <FooterStyle CssClass="displayStyle" />
                                                            </asp:BoundField>
                                                            ...
                                                            <asp:BoundField HeaderText="Comment" DataField="Package_MobilizationAdvanceDocs_Comments" />
                                                            <asp:BoundField HeaderText="Added By" DataField="Person_Name" />
                                                            <asp:BoundField HeaderText="Added date" DataField="Package_MobilizationAdvanceDocs_AddedOn" />
                                                        </Columns>
                                                    </asp:GridView>
                                                </div>
                                            </div>
