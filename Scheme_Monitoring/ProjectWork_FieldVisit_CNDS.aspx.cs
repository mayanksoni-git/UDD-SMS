...
public partial class ProjectWork_FieldVisit_CNDS : System.Web.UI.Page
{
    ...
    protected void get_Project_Work_FieldVisit()
    {
        int District_Id = 0;
        int Zone_Id = 0;
        int Circle_Id = 0;
        ...
        DataSet ds = new DataSet();
        ds = (new DataLayer()).get_Project_Work_FieldVisit(Scheme_Id, Zone_Id, Circle_Id, Division_Id, District_Id, ULB_Id, ChkShowPIC_NA.Checked, rbtProjectType.SelectedValue);
        if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
        {
    ...
    protected void btnAdd_Click(object sender, ImageClickEventArgs e)
    {
        ...
        hf_Physical_Progress.Value = gr.Cells[10].Text.Trim();
        hf_Financial_Progress.Value = gr.Cells[11].Text.Trim();
        mp1.Show();
    }
    ...
    protected void btnAddVisit_Click(object sender, EventArgs e)
    {
        ...
        string[] fNameArr1 = flPhoto1.FileName.Split(new char[] { '.' }, StringSplitOptions.RemoveEmptyEntries);
        string[] fNameArr2 = flPhoto2.FileName.Split(new char[] { '.' }, StringSplitOptions.RemoveEmptyEntries);
        string[] fNameArr3 = flPhoto3.FileName.Split(new char[] { '.' }, StringSplitOptions.RemoveEmptyEntries);
        ...
        obj_tbl_ProjectVisit.ProjectVisit_VisitCount = 0;
        obj_tbl_ProjectVisit.ProjectVisit_Comments = txtVisitComments.Text.Trim().Replace("'", "").Replace("--", "");
        obj_tbl_ProjectVisit.ProjectVisit_ProjectWork_Id = ProjectWork_Id;
        ...
        obj_tbl_ProjectPkgSitePics.ProjectPkgSitePics_ProjectWork_Id = ProjectWork_Id;
        ...
        string msg = "";
        if (new DataLayer().Update_tbl_ProjectDPR_WorkStatus(obj_tbl_ProjectVisit, null, obj_tbl_ProjectPkgSitePics_Li, ref msg))
        {
