...
public partial class MasterGenerateInvoice_Detail : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (Session["PersonJuridiction_DesignationId"].ToString() == "16" || Session["PersonJuridiction_DesignationId"].ToString() == "33")
            {
        ...
        else
        {
            ...
            if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
                ...
                if (ds.Tables[0].Rows[0]["ProcessConfigMaster_Qty_Editing_Allowed"].ToString() == "1")
                {
                    ...
                    {
                        TextBox lblQty = grdBOQ.Rows[i].FindControl("lblQty") as TextBox;
    ...
    private void get_tbl_PackageInvoiceAdditional2(int Invoice_Id)
    {
        DataSet ds = new DataSet();
        ds = (new DataLayer()).get_tbl_PackageInvoiceAdditional2(Invoice_Id);
        ...
        if (AllClasses.CheckDataSet(ds))
        {
            ...
            try
            {
                TotalAmount = Convert.ToDecimal(grdBOQ.FooterRow.Cells[12].Text);
            }
            catch
            {
                TotalAmount = 0;
            }
            decimal DeducationValue = 0;
            decimal Total = 0;
            ...
            {
                if (ds.Tables[0].Rows[i]["PackageInvoiceAdditional2_Deduction_Id"].ToString() == "2016")
                {
                    DeducationValue = Convert.ToDecimal(ds.Tables[0].Rows[i]["PackageInvoiceAdditional2_Deduction_Value_Master"].ToString());
                    Deductionamt = decimal.Round(((TotalAmount * DeducationValue) / 100), 2, MidpointRounding.AwayFromZero);
                    Total = (TotalAmount - Deductionamt);
                    ds.Tables[0].Rows[i]["Amount"] = Deductionamt.ToString();
                    GlobalTotal = Total;
                }
                else
                {
                ...
                if (ds.Tables[0].Rows[i]["PackageInvoiceAdditional2_Deduction_Id"].ToString() == "2017")
                {
                    DeducationValue = Convert.ToDecimal(ds.Tables[0].Rows[i]["PackageInvoiceAdditional2_Deduction_Value_Master"].ToString());
                    Deductionamt = decimal.Round(((Total * DeducationValue) / 100), 2, MidpointRounding.AwayFromZero);
                    ds.Tables[0].Rows[i]["Amount"] = Deductionamt.ToString();
                    Total = (Total + Deductionamt);
                    GlobalTotal = Total;
                    TotalAmount = Total;
                }
                if (ds.Tables[0].Rows[i]["PackageInvoiceAdditional2_Deduction_Id"].ToString() == "1013")
                {
                    DeducationValue = Convert.ToDecimal(ds.Tables[0].Rows[i]["PackageInvoiceAdditional2_Deduction_Value_Master"].ToString());
                    CGSTAmt = decimal.Round(((GlobalTotal * DeducationValue) / 100), 0, MidpointRounding.AwayFromZero);
                    ds.Tables[0].Rows[i]["Amount"] = CGSTAmt.ToString();
                    Total = (GlobalTotal + CGSTAmt);
                }
                if (ds.Tables[0].Rows[i]["PackageInvoiceAdditional2_Deduction_Id"].ToString() == "1014")
                {
                    DeducationValue = Convert.ToDecimal(ds.Tables[0].Rows[i]["PackageInvoiceAdditional2_Deduction_Value_Master"].ToString());
                    SGSTAmt = decimal.Round(((GlobalTotal * DeducationValue) / 100), 0, MidpointRounding.AwayFromZero);
                    ds.Tables[0].Rows[i]["Amount"] = SGSTAmt.ToString();
                    Total = (GlobalTotal + SGSTAmt);
                }
                ds.Tables[0].Rows[i]["Total"] = Total.ToString();
            }
            grdDeductionsM.DataSource = ds.Tables[0];
            grdDeductionsM.DataBind();
            grdDeductionsM.FooterRow.Cells[7].Text = (GlobalTotal + CGSTAmt + SGSTAmt).ToString();
        }
        else
        {
    ...
    private void get_tbl_Invoice_Details(int Invoice_Id, int Scheme_Id, bool bind_grdInvoice)
    {
        ...
        if (ds != null)
        {
            ...
            if (ds.Tables.Count > 1 && ds.Tables[1].Rows.Count > 0)
            {
                ...
                grdBOQ.FooterRow.Cells[10].Text = ds.Tables[1].Compute("sum(PackageInvoiceItem_Total_Qty_BOQ)", "").ToString();
                grdBOQ.FooterRow.Cells[12].Text = ds.Tables[1].Compute("sum(Amount)", "").ToString();
                grdBOQ.FooterRow.Cells[17].Text = ds.Tables[1].Compute("sum(Total_Amount)", "").ToString();
            }
            else
            {
        ...
        {
            grdBOQ.Columns[17].Visible = false;
            get_tbl_PackageInvoiceAdditional2(Invoice_Id);
        }
        else
        {
            grdBOQ.Columns[17].Visible = true;
        }
    ...
    private void Calculate_Total()
    {
        ...
        else
        {
            if (grdBOQ.FooterRow != null)
            {
                try
                {
                    invoice_total = decimal.Parse(grdBOQ.FooterRow.Cells[17].Text.Trim());
                }
                catch
                {
                    invoice_total = 0;
    ...
    protected void grdBOQ_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (hf_PackageInvoice_ProcessType.Value == "Global")
            {
                e.Row.Cells[15].CssClass = "displayStyle";
                e.Row.Cells[16].CssClass = "displayStyle";
            }
            else
            {
                e.Row.Cells[15].CssClass = "";
                e.Row.Cells[16].CssClass = "";
            }
        }
    ...
    protected void grdDeductionsM_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (e.Row.Cells[3].Text == "C GST" || e.Row.Cells[3].Text == "S GST")
            {
    ...
    protected void chkSelect_CheckedChanged(object sender, EventArgs e)
    {
        ...
        if (hf_PackageInvoice_ProcessType.Value == "Global")
        {
            if (grdDeductionsM.Rows.Count > 3)
            {
                TotalAmt = Convert.ToDecimal(grdDeductionsM.Rows[1].Cells[7].Text);
            }
            else
            {
                TotalAmt = Convert.ToDecimal(grdDeductionsM.Rows[0].Cells[7].Text);
            }
        }
        else
        {
            TotalAmt = Convert.ToDecimal(grdBOQ.FooterRow.Cells[12].Text.Trim());
        }
        ...
        if (chkSelect.Checked && !chkFlat.Checked)
        {
            ...
            try
            {
                txtDeductionAmount.Text = decimal.Round(((TotalAmt * DeductionValue) / 100), 2, MidpointRounding.AwayFromZero).ToString();
            }
            catch
            {
    ...
    private void Save_Data(string Mode)
    {
        ...
        obj_tbl_PackageInvoice.PackageInvoice_IsPrinted = 0;
        ...
        for (int i = 0; i < grdBOQ.Rows.Count; i++)
        {
            ...
            try
            {
                Total_Qty = Convert.ToDecimal((grdBOQ.Rows[i].Cells[15].Text));
            }
            catch
            {
                Total_Qty = 0;
            ...
            try
            {
                Total_Qty_Paid = Convert.ToDecimal((grdBOQ.Rows[i].Cells[8].Text));
            }
            catch
            {
                Total_Qty_Paid = 0;
            ...
            try
            {
                obj_tbl_PackageInvoiceItem.PackageInvoiceItem_Total_Qty_BOQ = Convert.ToDecimal(lblQty.Text.Trim());
            }
            catch
            {
            ...
            if (hf_PackageInvoice_ProcessType.Value != "Global")
            {
                ...
                for (int k = 0; k < grdTaxes.Rows.Count; k++)
                {
                    ...
                    obj_tbl_PackageInvoiceItem_Tax.PackageInvoiceItem_Tax_InvoiceId = Convert.ToInt32(grdBOQ.Rows[i].Cells[1].Text.Trim());
                    try
                    {
                    ...
                    {
                        obj_tbl_PackageInvoiceItem_Tax.PackageInvoiceItem_Tax_Value = 9;
                    }
        ...
        if (hf_PackageInvoice_ProcessType.Value == "Global")
        {
            ...
            for (int k = 0; k < grdDeductionsM.Rows.Count; k++)
            {
                ...
                if (chkSelect.Checked && chkSelect.Enabled == false)
                {
                    obj_tbl_PackageInvoiceItem_Tax.PackageInvoiceItem_Tax_AddedBy = Convert.ToInt32(Session["Person_Id"].ToString());
        ...
        for (int i = 0; i < grdDeductions2.Rows.Count; i++)
        {
            ...
            if (chkSelect2.Checked && !chkFlat2.Checked)
            {
                ...
                try
                {
                    txtDeductionAmount2.Text = decimal.Round(((Convert.ToDecimal(grdBOQ.FooterRow.Cells[15].Text.Trim()) * AdditionValue) / 100), 2, MidpointRounding.AwayFromZero).ToString();
                }
                catch
                {
        ...
        if (obj_tbl_PackageInvoiceApproval != null && divAmountTransfered.Visible && obj_tbl_PackageInvoiceApproval.PackageInvoiceApproval_Status_Id == 1 && Transfred_Amount != 0)
        {
    ...
    protected void chkSelect2_CheckedChanged(object sender, EventArgs e)
    {
        ...
        if (chkSelect2.Checked && !chkFlat2.Checked)
        {
            ...
            try
            {
                txtDeductionAmount2.Text = decimal.Round(((TotalAmt * DeductionValue2) / 100), 2, MidpointRounding.AwayFromZero).ToString();
            }
            catch
            {
                txtDeductionAmount2.Text = "0";
    ...
    protected void txtDeductionAmount2_TextChanged(object sender, EventArgs e)
    {
        ...
        if (chkFlat2.Checked && chkSelect2.Checked)
        {
            ...
            try
            {
                DeductionAmount = Convert.ToDecimal(txtDeductionAmount2.Text.Trim());
            }
            catch
            {
                DeductionAmount = 0;
            ...
            if (DeductionAmount > 0)
            {
                txtDeductionValue2.Text = decimal.Round((DeductionAmount * 100) / invoice_Total, 2, MidpointRounding.AwayFromZero).ToString();
            }
        ...
        for (int i = 0; i < grdDeductions2.Rows.Count; i++)
        {
            ...
            try
            {
                DeductionValue_Total += Convert.ToDecimal(txtDeductionAmount2.Text.Trim());
            }
            catch
            {
                DeductionValue_Total += 0;
        ...
        grdDeductions2.FooterRow.Cells[10].Text = DeductionValue_Total.ToString();
        ...
        //    try
        //    {
        //        invoice_Total = Convert.ToDecimal(grdBOQ.FooterRow.Cells[15].Text.Trim());
        //    }
        //    catch
        //    {
        //        invoice_Total = 0;
    ...
    {
        GridViewRow gr = (sender as TextBox).Parent.Parent as GridViewRow;
        TextBox lblQty = gr.FindControl("lblQty") as TextBox;
        TextBox lblPercentageToBeReleased = gr.FindControl("lblPercentageToBeReleased") as TextBox;
        Label lblAmountQuoted = gr.FindControl("lblAmountQuoted") as Label;
        decimal Rate = 0;
        try
        {

            Rate = Convert.ToDecimal(gr.Cells[9].Text);
        }
        catch
        {
            Rate = 0;
        }
        decimal PercentageAmtReleased = 0;
        try
        {

            PercentageAmtReleased = Convert.ToDecimal(lblPercentageToBeReleased.Text);
        }
        catch
        {
            PercentageAmtReleased = 0;
        }
        ...
        decimal TotalAmtWOGST = 0;
        if (PercentageAmtReleased == 0 || PercentageAmtReleased == 100)
        {
            TotalAmtWOGST = (Rate * Qty);
        }
        else
        {
            TotalAmtWOGST = (((Rate * Qty) * PercentageAmtReleased) / 100);
        }

        GridView gv = gr.FindControl("grdTaxes") as GridView;
        decimal Tax = 0;
        for (int i = 0; i < gv.Rows.Count; i++)
        {
            TextBox txtTaxesP = gv.Rows[i].FindControl("txtTaxesP") as TextBox;
            Tax = Tax + Convert.ToDecimal(txtTaxesP.Text);
        }

        decimal TaxAmt = ((TotalAmtWOGST * Tax) / 100);
        decimal TotalAmt = TotalAmtWOGST + TaxAmt;

        gr.Cells[12].Text = TotalAmtWOGST.ToString();
        lblAmountQuoted.Text = TotalAmt.ToString();

        decimal FooterQty = 0;
        decimal FooterTotalAmtWOGST = 0;
        decimal FooterTotalAmt = 0;
        for (int k = 0; k < grdBOQ.Rows.Count; k++)
        {
            lblQty = grdBOQ.Rows[k].FindControl("lblQty") as TextBox;
            lblAmountQuoted = grdBOQ.Rows[k].FindControl("lblAmountQuoted") as Label;
            try
            {
                FooterQty = FooterQty + Convert.ToDecimal(lblQty.Text);
            }
            catch
            { }
            try
            {
                FooterTotalAmtWOGST = FooterTotalAmtWOGST + Convert.ToDecimal(grdBOQ.Rows[k].Cells[12].Text);
            }
            catch
            { }
            try
            {
                FooterTotalAmt = FooterTotalAmt + Convert.ToDecimal(lblAmountQuoted.Text);
            }
            catch
            { }
        }

        grdBOQ.FooterRow.Cells[10].Text = FooterQty.ToString();
        grdBOQ.FooterRow.Cells[12].Text = FooterTotalAmtWOGST.ToString();
        grdBOQ.FooterRow.Cells[17].Text = FooterTotalAmt.ToString();

        if (hf_PackageInvoice_ProcessType.Value == "Global")
        {
            get_tbl_PackageInvoiceAdditional2(Convert.ToInt32(hf_Invoice_Id.Value));
        }
    ...
    protected void btnRevert_Click(object sender, EventArgs e)
    {
        ...
        {
            MessageBox.Show("Successfully Back to Division .");
            hf_Invoice_Id.Value = "0";
            txtComments.Text = "";
