<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true" CodeFile="ProjectWorkShilayanas_Lokarpan.aspx.cs" Inherits="ProjectWorkShilayanas_Lokarpan" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" ValidateRequest="false" %>
                    ...
                    <div class="page-content">
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <h3 class="header smaller lighter blue">Project List For Updation Of Shilanyas / Lokarpan
                                        </h3>
                                        <div class="row">
                                            <div class="col-sm-12">
                                            ...
                                            <asp:GridView ID="grdPost" runat="server" CssClass="display table table-bordered" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdPost_PreRender" OnRowDataBound="grdPost_RowDataBound">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="District">
                                                        <ItemTemplate>
                                                            <asp:DropDownList ID="ddlDistrict" runat="server" class="chosen-select form-control" data-placeholder="Choose a District..." AutoPostBack="true" OnSelectedIndexChanged="ddlDistrict_SelectedIndexChanged">
                                                            </asp:DropDownList>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="शिलान्यास">
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="लोकार्पण">
                                                        <ItemTemplate>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <br />
                                                    <asp:Button ID="btnSave" Text="Update Details" runat="server" CssClass="btn btn-inverse" OnClick="btnSave_Click"></asp:Button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
