<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true"
    CodeFile="Report_Project_With_No_Invoice.aspx.cs" Inherits="Report_Project_With_No_Invoice" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" ValidateRequest="false" %>
                    ...
                    <div class="page-content">
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <div class="table-header">
                                    List Of Projects With Financial Progress Value Not Updating Since Days
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <asp:CheckBox ID="chkRemoveFinancialAll" Text="Remove Projects For Which Financial Completed With No Further Payment is Required (Selected in PMIS Step 3)" runat="server" Checked="true"></asp:CheckBox>
                                        <br />
                                        <asp:CheckBox ID="chkRemoveFinancialPartial" Text="Remove Projects For Which Financial Completed With No Further Payment is Required Except Deduction (Selected in PMIS Step 3)" runat="server" Checked="true"></asp:CheckBox>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div runat="server" visible="false" id="divData">
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <h3 class="header smaller lighter blue">Financial Progress Value Not Updating Since Days</h3>
                                            ...
                                            <div style="overflow: auto">
                                                <asp:GridView ID="grdPost" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdPost_PreRender" OnRowDataBound="grdPost_RowDataBound">
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField HeaderText="Last Invoice Generated On" DataField="Last_Invoice_Date" />
                                                        <asp:BoundField HeaderText="Days Since Last Invoice Generated" DataField="Days_Diff" />
