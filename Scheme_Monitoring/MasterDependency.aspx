<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true"
    CodeFile="MasterDependency.aspx.cs" Inherits="MasterDependency" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" ValidateRequest="false" %>
        ...
        <div class="main-content-inner">
            ...
            <asp:UpdatePanel ID="up" runat="server">
                <ContentTemplate>
                    ...
                    <asp:HiddenField ID="hf_Dependency_Id" runat="server" Value="0" />
                </ContentTemplate>
            </asp:UpdatePanel>
