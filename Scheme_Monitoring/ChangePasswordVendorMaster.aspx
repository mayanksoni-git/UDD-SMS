<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true" CodeFile="ChangePasswordVendorMaster.aspx.cs" Inherits="ChangePasswordVendorMaster" %>
                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <h3 class="header smaller lighter blue">Vendor Master</h3>
                                        <div style="overflow: auto">
                                            <asp:GridView ID="grdPost" runat="server" CssClass="display table table-bordered" AutoGenerateColumns="False" HorizontalAlign="Left" EmptyDataText="No Records Found" OnPreRender="grdPost_PreRender" OnRowDataBound="grdPost_RowDataBound">
                                                <Columns>
                                                    ...
                                                    <asp:BoundField HeaderText="JV Details" DataField="Vendor_FirmNameJV" />
                                                    <asp:BoundField HeaderText="Vendor Name" DataField="Vendor_Name" />
                                                    <asp:BoundField HeaderText="Registred Mobile" DataField="Vendor_MobileNo" />
                                                    <asp:BoundField HeaderText="Alternate Mobile 1" DataField="Vendor_MobileNo1" />
                                                    <asp:BoundField HeaderText="Alternate Mobile 2" DataField="Vendor_MobileNo2" />
                                                    <asp:BoundField HeaderText="Password" DataField="Vendor_Password" />
                                                    <asp:TemplateField HeaderText="Total Projects">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkProjects" runat="server" OnClick="lnkProjects_Click" Text='<%# Eval("Total_Projects") %>'></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Total Packages">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkPackages" runat="server" OnClick="lnkPackages_Click" Text='<%# Eval("Total_Packages") %>'></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                            </asp:GridView>
                        ...
                        <asp:Panel ID="Panel1" runat="server" CssClass="modalPopup1" Style="display: none; width: 1000px; height: 500px; margin-left: -32px" ScrollBars="Auto">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="col-md-12">
                                        <div style="overflow: auto">
                                            <asp:GridView ID="grdPackageDetails" runat="server" CssClass="display table table-bordered" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdPost_PreRender">
                                                <Columns>
