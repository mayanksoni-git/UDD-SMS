...
public partial class ListOfAllULB_ExpenseType : System.Web.UI.Page
{
    ...
    {
        var ULBID = ddlDivision.SelectedValue;
        var check = e.CommandArgument;
        Response.Redirect("AddExpensesType.aspx?ULBID=" + ULBID + "&FYID=" + check);
    ...
    protected void BtnDelete_Command(object sender, CommandEventArgs e)
    {
        ...
        DataTable dt = new DataTable();
        dt = objLoan.DeleteULBExpenses(ULBID, FYID);
        GetAllData();
