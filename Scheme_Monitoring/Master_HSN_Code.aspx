<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin2.master" AutoEventWireup="true" CodeFile="Master_HSN_Code.aspx.cs" Inherits="Master_HSN_Code" %>
        ...
        <div class="main-content-inner">
            ...
            <asp:UpdatePanel ID="up" runat="server">
                <ContentTemplate>
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div style="overflow: auto">
                                            <asp:GridView ID="grdPost" runat="server" CssClass="display table table-bordered" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdPost_PreRender">
                                                <Columns>
                                                    <asp:BoundField DataField="HSN_Code_Id" HeaderText="HSN_Code_ID">
                                                    ...
                                                    <asp:BoundField DataField="HSN_Code_Name" HeaderText="Pay Band" />
                            ...
                            <div class="col-md-12">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <asp:Label ID="lblHSN_Code" runat="server" Text="SAC/HSN Code" CssClass="control-label no-padding-right"></asp:Label>
                                        <asp:TextBox ID="txtHSN_Code" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                    ...
                    <asp:HiddenField ID="hf_HSN_Code_Id" runat="server" Value="0" />
