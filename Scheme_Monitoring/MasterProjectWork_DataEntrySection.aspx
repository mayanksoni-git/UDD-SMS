...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <div class="container-fluid">
                ...
                <asp:UpdatePanel ID="up" runat="server">
                    <ContentTemplate>
                                                ...
                                                <div class="row gy-4">
                                                    ...
                                                    <div class="col-xxl-3 col-md-6">
                                                        <div>
                                                            ...
                                                            <asp:TextBox ID="txtBudget" ToolTip="यह मान स्वतः गणना किया जाता है। Sanctioned Cost=Project Cost + A&OE" runat="server" CssClass="form-control" Enabled="false" onkeyup="isNumericVal(this);"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                            ...
                                            <div class="live-preview">
                                                <div class="row gy-4">
                                                    ...
                                                    <div class="col-xxl-3 col-md-6">
                                                        <div>
                                                            <br />
                                                            <button class="btn btn-outline-success" onclick="return downloadRFPDocument(this);" title="Download RFP Document" runat="server" id="RFPFile">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-download" viewBox="0 0 16 16">
                                                                    <path d="M.5 9.9a.5.5 0 0 1 .5.5v2.5a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-2.5a.5.5 0 0 1 1 0v2.5a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2v-2.5a.5.5 0 0 1 .5-.5"></path>
                                                                    <path d="M7.646 11.854a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V1.5a.5.5 0 0 0-1 0v8.793L5.354 8.146a.5.5 0 1 0-.708.708z"></path>
                                                                </svg>
                                                    ...
                                                    <div class="col-xxl-3 col-md-6">
                                                        <div>
                                                            <br />
                                                            <button class="btn btn-outline-success" onclick="return downloadTechnicalBid(this);" title="Download Technical Bid Evaluation File" runat="server" id="TechnicalBidFile">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-download" viewBox="0 0 16 16">
                                                                    <path d="M.5 9.9a.5.5 0 0 1 .5.5v2.5a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-2.5a.5.5 0 0 1 1 0v2.5a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2v-2.5a.5.5 0 0 1 .5-.5"></path>
                                                                    <path d="M7.646 11.854a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V1.5a.5.5 0 0 0-1 0v8.793L5.354 8.146a.5.5 0 1 0-.708.708z"></path>
                                                                </svg>
                                                    ...
                                                    <div class="col-xxl-3 col-md-6">
                                                        <div>
                                                            <br />
                                                            <button class="btn btn-outline-success" onclick="return downloadFinancialBid(this);" title="Download Financial Bid Evaluation File" runat="server" id="FinancialBidFile">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-download" viewBox="0 0 16 16">
                                                                    <path d="M.5 9.9a.5.5 0 0 1 .5.5v2.5a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-2.5a.5.5 0 0 1 1 0v2.5a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2v-2.5a.5.5 0 0 1 .5-.5"></path>
                                                                    <path d="M7.646 11.854a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V1.5a.5.5 0 0 0-1 0v8.793L5.354 8.146a.5.5 0 1 0-.708.708z"></path>
                                                                </svg>
                        ...
                        <asp:HiddenField ID="hfRFPPath" runat="server" Value="" />
                        <asp:HiddenField ID="hfTechnicalBidPath" runat="server" Value="" />
                        <asp:HiddenField ID="hfFinancialBidPath" runat="server" Value="" />
                    </ContentTemplate>
                    <Triggers>
    ...
    <script type="text/javascript">
        ...
        function downloadRFPDocument(obj) {
            var path = document.getElementById('ctl00_ContentPlaceHolder1_hfRFPPath').value;
            if (path.trim() == "") {
                obj.href = '#';
                alert('File Not Found');
                return false;
        ...
        function downloadTechnicalBid(obj) {
            var path = document.getElementById('ctl00_ContentPlaceHolder1_hfTechnicalBidPath').value;
            if (path.trim() == "") {
                obj.href = '#';
                alert('File Not Found');
                return false;
        ...
        function downloadFinancialBid(obj) {
            var path = document.getElementById('ctl00_ContentPlaceHolder1_hfFinancialBidPath').value;
            if (path.trim() == "") {
                obj.href = '#';
                alert('File Not Found');
                return false;
