...
public partial class Report_ProjectWork_Physical_Statement : System.Web.UI.Page
{
    ...
    protected void get_Physical_Progress_Statement()
    {
        int District_Id = 0;
        int Zone_Id = 0;
        int Circle_Id = 0;
        ...
        DataSet ds = new DataSet();
        ds = (new DataLayer()).get_Physical_Progress_Statement(Scheme_Id, Zone_Id, Circle_Id, Division_Id, District_Id, ULB_Id, _Date);
        if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
        {
