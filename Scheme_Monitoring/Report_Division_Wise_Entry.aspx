                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        <div class="table-header">
                                            <%=Session["Default_Division"].ToString() %> Wise Project and Package Status Report
                                            ...
                                            <asp:GridView ID="grdPost" runat="server" CssClass="display table table-bordered" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdPost_PreRender" OnRowDataBound="grdPost_RowDataBound">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="View Package">
                                                        <ItemTemplate>
                                                            <asp:ImageButton ID="btnViewPkg" Width="20px" Height="30px" OnClick="btnViewPkg_Click" ImageUrl="~/assets/images/go.png" runat="server" />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                            </asp:GridView>
                                        ...
                                        <div style="overflow: auto">
                                            <asp:GridView ID="grdPackageDetails" runat="server" CssClass="display table table-bordered" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdPost_PreRender">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Un Freeze">
                                                        <ItemTemplate>
                                                            <asp:ImageButton ID="btnUnFreeze" Width="20px" Height="30px" OnClick="btnUnFreeze_Click" ImageUrl="~/assets/images/undo.png" runat="server" />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                            </asp:GridView>
