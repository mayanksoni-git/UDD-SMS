<%@ Page  Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true" CodeFile="PackageDeductionRelease.aspx.cs" Inherits="PackageDeductionRelease" %>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <div class="table-header">
                                    Select A Work Package TO Add Deduction Release
                                        ...
                                        <asp:GridView ID="grdDeductions" runat="server" CssClass="display table table-bordered" AutoGenerateColumns="False" EmptyDataText="No Records Found">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Deduction Release">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtDeductionRelease" onkeyup="isNumericVal(this);" runat="server" CssClass="form-control" AutoPostBack="true" OnTextChanged="txtDeductionRelease_TextChanged"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
