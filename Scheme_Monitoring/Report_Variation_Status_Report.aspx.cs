...
public partial class Report_Variation_Status_Report : System.Web.UI.Page
{
    ...
    protected void get_tbl_ProjectWorkDPR()
    {
        ...
        ds = (new DataLayer()).get_Variation_Process_Status_Summery(Scheme_Id, Zone_Id, Circle_Id, Division_Id, District_Id, ULB_Id);
        ds1 = (new DataLayer()).get_tbl_ProjectWorkVariation(Scheme_Id, District_Id, Zone_Id, Circle_Id, Division_Id, ULB_Id, 0, 0, "0", 0);
        if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
        {
            grdPost.DataSource = ds.Tables[0];
            grdPost.DataBind();

            (grdPost.FooterRow.FindControl("lnkDPRF") as LinkButton).Text = ds.Tables[0].Compute("sum(TotalPkg)", "").ToString();
            ...
            (grdPost.FooterRow.FindControl("lnkCEF") as LinkButton).Text = ds.Tables[0].Compute("sum(CE)", "").ToString();
            (grdPost.FooterRow.FindControl("lnPPRBDF") as LinkButton).Text = ds.Tables[0].Compute("sum(PPRBD_SE)", "").ToString();
            (grdPost.FooterRow.FindControl("lnVariationCompleteF") as LinkButton).Text = ds.Tables[0].Compute("sum(Variation_Complete)", "").ToString();
    ...
    protected void get_tbl_ProjectWorkDPR(int District_Id, int Zone_Id, int Circle_Id, int Division_Id, int ULB_Id, string Scheme_Id, string Designation_Id, int Office_Id)
    {
        DataSet ds1 = new DataSet();
        ds1 = (new DataLayer()).get_tbl_ProjectWorkVariation(Scheme_Id, District_Id, Zone_Id, Circle_Id, Division_Id, ULB_Id, 0, 0, Designation_Id, Office_Id);
        if (ds1 != null && ds1.Tables.Count > 0 && ds1.Tables[0].Rows.Count > 0)
        {
            grdFinancialFull.DataSource = ds1.Tables[0];
            grdFinancialFull.DataBind();
    ...
    protected void lnkDPR_Click(object sender, EventArgs e)
    {
        ...
        get_tbl_ProjectWorkDPR(District_Id, Zone_Id, Circle_Id, Division_Id, ULB_Id, Scheme_Id, "0", 0);
    }
    ...
    protected void lnkExPM_Click(object sender, EventArgs e)
    {
        ...
        get_tbl_ProjectWorkDPR(District_Id, Zone_Id, Circle_Id, Division_Id, ULB_Id, Scheme_Id, "4, 9, 1056", 1);
    }
    ...
    protected void lnkSEGM_Click(object sender, EventArgs e)
    {
        ...
        get_tbl_ProjectWorkDPR(District_Id, Zone_Id, Circle_Id, Division_Id, ULB_Id, Scheme_Id, "1035, 1040", 1);
    }
    ...
    protected void lnkZCE_Click(object sender, EventArgs e)
    {
        ...
        get_tbl_ProjectWorkDPR(District_Id, Zone_Id, Circle_Id, Division_Id, ULB_Id, Scheme_Id, "1042", 1);
    }
    ...
    protected void lnkCE_Click(object sender, EventArgs e)
    {
        ...
        get_tbl_ProjectWorkDPR(District_Id, Zone_Id, Circle_Id, Division_Id, ULB_Id, Scheme_Id, "34", 1);
    }
    ...
    protected void lnkPPRBD_Click(object sender, EventArgs e)
    {
        ...
        get_tbl_ProjectWorkDPR(District_Id, Zone_Id, Circle_Id, Division_Id, ULB_Id, Scheme_Id, "1035", 8);
    }
    ...
    protected void lnkSMD_Click(object sender, EventArgs e)
    {
        ...
        get_tbl_ProjectWorkDPR(District_Id, Zone_Id, Circle_Id, Division_Id, ULB_Id, Scheme_Id, "1", 1);
    }
    ...
    protected void lnkSLTC_Click(object sender, EventArgs e)
    {
        ...
        get_tbl_ProjectWorkDPR(District_Id, Zone_Id, Circle_Id, Division_Id, ULB_Id, Scheme_Id, "33", 9);
    }
    ...
    protected void lnkHSPSCF_Click(object sender, EventArgs e)
    {
        ...
        get_tbl_ProjectWorkDPR(District_Id, Zone_Id, Circle_Id, Division_Id, ULB_Id, Scheme_Id, "33", 10);
    }
    ...
    protected void grdFinancialFull_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            try
            {
                Designation_Id = Convert.ToInt32(e.Row.Cells[3].Text.Trim());
            }
            catch
            {
                Designation_Id = 0;
            ...
            try
            {
                Office_Id = Convert.ToInt32(e.Row.Cells[4].Text.Trim());
            }
            catch
            {
                Office_Id = 0;
    ...
    protected void btnOpenTimeline_Click(object sender, ImageClickEventArgs e)
    {
        ...
        int Package_ExtraItem_Id = Convert.ToInt32(gr.Cells[0].Text.Trim());
        DataSet ds = new DataSet();
        ds = (new DataLayer()).get_ProjectWorkVariation_Approval_History(Package_ExtraItem_Id);
    ...
    protected void lnkVariationComplete_Click(object sender, EventArgs e)
    {
        GridViewRow gr = (sender as LinkButton).Parent.Parent as GridViewRow;
        int District_Id = 0;
        int Zone_Id = 0;
    ...
    protected void lnVariationCompleteF_Click(object sender, EventArgs e)
    {
        int District_Id = 0;
        int Zone_Id = 0;
        int Circle_Id = 0;
    ...
    protected void btnDelete_Click(object sender, ImageClickEventArgs e)
    {
        ...
        try
        {
            Package_ExtraItem_Id = Convert.ToInt32(gr.Cells[0].Text.Trim());
        }
        catch
        {
        ...
        {
            if (new DataLayer().Delete_PackageVariation(Package_ExtraItem_Id, Convert.ToInt32(Session["Person_Id"].ToString())))
            {
                MessageBox.Show("Variation Details Deleted Successfully");
                return;
            }
            else
            {
                MessageBox.Show("Error in Deleting Variation Details");
                return;
            }
        }
    }
