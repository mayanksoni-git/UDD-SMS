<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true"
    CodeFile="MasterArreareNature.aspx.cs" Inherits="MasterArreareNature" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" ValidateRequest="false" %>
        ...
        <div class="main-content-inner">
            ...
            <asp:UpdatePanel ID="up" runat="server">
                <ContentTemplate>
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div style="overflow: auto">
                                            <asp:GridView ID="grdPost" runat="server" CssClass="display table table-bordered" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdPost_PreRender">
                                                <Columns>
                                                    <asp:BoundField DataField="ArreareNature_Id" HeaderText="ArreareNature_Id">
                                                    ...
                                                    <asp:BoundField DataField="ArreareNature_Name" HeaderText="ArreareNature" />
                            ...
                            <div class="col-md-12">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <asp:Label ID="lblArreareNature" runat="server" Text="Arreare Nature*" CssClass="control-label no-padding-right"></asp:Label>
                                        <asp:TextBox ID="txtArreareNature" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                    ...
                    <asp:HiddenField ID="hf_ArreareNature_Id" runat="server" Value="0" />
