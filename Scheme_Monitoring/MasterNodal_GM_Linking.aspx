<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true"
    CodeFile="MasterNodal_GM_Linking.aspx.cs" Inherits="MasterNodal_GM_Linking" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" ValidateRequest="false" %>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-3" id="divCircle" runat="server">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="ddlSearchCircle" runat="server" CssClass="form-control"></asp:DropDownList>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <br />
                                        <asp:Button ID="btnSearch" runat="server" OnClick="btnSearch_Click" Text="Search" CssClass="btn btn-warning"></asp:Button>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="form-group">
                                        <asp:GridView ID="grdDocument" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdDocument_PreRender" OnRowDataBound="grdDocument_RowDataBound">
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="NodalCircleLink_Id" HeaderText="NodalCircleLink_Id">
                                                    <HeaderStyle CssClass="displayStyle" />
                                                    <ItemStyle CssClass="displayStyle" />
                                                    <FooterStyle CssClass="displayStyle" />
                                                </asp:BoundField>
