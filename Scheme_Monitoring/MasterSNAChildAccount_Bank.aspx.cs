...
public partial class MasterSNAChildAccount_Bank : System.Web.UI.Page
{
    ...
    protected void get_tbl_ProjectWork()
    {
        ...
        ds = (new DataLayer()).get_tbl_SNAAccountMaster_PNB(Scheme_Id, 0, Zone_Id, Circle_Id, Division_Id, 0, 0);
        if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
        {
