        ...
        <div class="main-content-inner">
            ...
            <asp:UpdatePanel ID="up" runat="server">
                <ContentTemplate>
                        ...
                        <div runat="server" visible="false" id="divEntry">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <asp:Label ID="Label8" runat="server" Text="Date of Completetion Extended" CssClass="control-label no-padding-right"></asp:Label>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <asp:Label ID="Label7" runat="server" Text="GST Percentage*" CssClass="control-label no-padding-right"></asp:Label>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="ddlVendor1" runat="server" class="chosen-select form-control" data-placeholder="Choose a Contractor / Vendor..."></asp:DropDownList>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="control-label no-padding-right">Contractor (JV If Any)* </label>
                                            <asp:DropDownList ID="ddlVendor2" runat="server" class="chosen-select form-control" data-placeholder="Choose a Contractor / Vendor..."></asp:DropDownList>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <asp:Label ID="lblZoneHA" runat="server" Text="Zone" CssClass="control-label no-padding-right"></asp:Label>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <asp:Label ID="lblCircleHA" runat="server" Text="Circle" CssClass="control-label no-padding-right"></asp:Label>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <asp:Label ID="lblDivisionHA" runat="server" Text="Division" CssClass="control-label no-padding-right"></asp:Label>
                    ...
                    <asp:Panel ID="Panel1" runat="server" CssClass="modalPopup1" Style="display: none; width: 800px; margin-left: -32px; top: 2px; height: 550px" ScrollBars="Auto">
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="table-header">
