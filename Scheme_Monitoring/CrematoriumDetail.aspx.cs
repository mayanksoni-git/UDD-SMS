...
public partial class CrematoriumDetail : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["CrematoriumDetail_Id"] != null)
            {
                ...
                Load_CrematoriumDetail(crematoriumDetailId);
            }
        }
    ...
    {
        int conventional = string.IsNullOrWhiteSpace(txtConventional.Text) ? 0 : Convert.ToInt32(txtConventional.Text);
        int improvisedWood = string.IsNullOrWhiteSpace(txtImprovisedWood.Text) ? 0 : Convert.ToInt32(txtImprovisedWood.Text);
        int gas = string.IsNullOrWhiteSpace(txtGas.Text) ? 0 : Convert.ToInt32(txtGas.Text);
        int electric = string.IsNullOrWhiteSpace(txtElectric.Text) ? 0 : Convert.ToInt32(txtElectric.Text);

        int noOfPyres = conventional + improvisedWood + gas + electric;
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        tbl_CrematoriumDetail obj_CrematoriumDetail = CreateCrematoriumDetailObject(imageLocation);
    ...
    private tbl_CrematoriumDetail CreateCrematoriumDetailObject(string imageLocation)
    {
        return new tbl_CrematoriumDetail
        {
            AddedBy = Convert.ToInt32(Session["Person_Id"]),
            Year = Convert.ToInt32(ddlYear.SelectedValue),
            Month = Convert.ToInt32(ddlMonth.SelectedValue),
            Zone = Convert.ToInt32(ddlZone.SelectedValue),
            Circle = Convert.ToInt32(ddlCircle.SelectedValue),
            Division = Convert.ToInt32(ddlDivision.SelectedValue),
            NameCMTR = txtNameCMTR.Text,
            LocationCMTR = txtLocationCMTR.Text,
            Conventional = Convert.ToInt32(string.IsNullOrEmpty(txtConventional.Text) ? "0" : txtConventional.Text),
            ImprovisedWood = Convert.ToInt32(string.IsNullOrEmpty(txtImprovisedWood.Text) ? "0" : txtImprovisedWood.Text),
            Gas = Convert.ToInt32(string.IsNullOrEmpty(txtGas.Text) ? "0" : txtGas.Text),
            Electric = Convert.ToInt32(string.IsNullOrEmpty(txtElectric.Text) ? "0" : txtElectric.Text),
            NoOfPyres = Convert.ToInt32(string.IsNullOrEmpty(txtNoOfPyres.Text) ? "0" : txtNoOfPyres.Text),
            DrinkingWater = Convert.ToBoolean(Convert.ToInt32(rblDrinkingWater.SelectedValue)),
            ElecticityGrid = Convert.ToBoolean(Convert.ToInt32(rblElecticityGrid.SelectedValue)),
            Parking = Convert.ToBoolean(Convert.ToInt32(rblParking.SelectedValue)),
            Shed = Convert.ToBoolean(Convert.ToInt32(rblShed.SelectedValue)),
            Hearse = Convert.ToBoolean(Convert.ToInt32(rblHearse.SelectedValue)),
            HandPump = Convert.ToBoolean(Convert.ToInt32(rblHandPump.SelectedValue)),
            BoundaryWall = Convert.ToBoolean(Convert.ToInt32(rblBoundaryWall.SelectedValue)),
            EntryGate = Convert.ToBoolean(Convert.ToInt32(rblEntryGate.SelectedValue)),
            PrayerHall = Convert.ToBoolean(Convert.ToInt32(rblPrayerHall.SelectedValue)),
            CareTakerRoom = Convert.ToBoolean(Convert.ToInt32(rblCareTakerRoom.SelectedValue)),
            AshStorage = Convert.ToBoolean(Convert.ToInt32(rblAshStorage.SelectedValue)),
            Bathrooms = Convert.ToBoolean(Convert.ToInt32(rblBathrooms.SelectedValue)),
            Washroom = Convert.ToBoolean(Convert.ToInt32(rblWashroom.SelectedValue)),
            Registration = Convert.ToInt32(rblRegistration.SelectedValue),
            CMTRImage = imageLocation,
            FillerName = txtFillerName.Text,
            FillerContact = txtFillerContact.Text,
            TotalCMTRDone = Convert.ToInt32(string.IsNullOrEmpty(txtTotalCMTRDone.Text) ? "0" : txtTotalCMTRDone.Text)
        };
    }
    ...
    private string UploadImage()
    {
        ...
        {
            string errorMessage;
            string imageLocation = ImageUploader.UploadImage(fuCMTRImage.PostedFile, out errorMessage);
    ...
    public bool ValidateFields()
    {
        ...
        if (string.IsNullOrWhiteSpace(txtNameCMTR.Text))
        {
            MessageBox.Show("Please enter Name of Crematorium!");
            txtNameCMTR.Focus();
            return false;
        }
        if (string.IsNullOrWhiteSpace(txtLocationCMTR.Text))
        {
            MessageBox.Show("Please enter Location of Creamtorium!");
            txtLocationCMTR.Focus();
            return false;
        }
        if (string.IsNullOrWhiteSpace(txtNoOfPyres.Text))
        {
    ...
    {
        DataTable dt = objPyres.getCrematoriumDetailById(CrematoriumDetail_Id);
