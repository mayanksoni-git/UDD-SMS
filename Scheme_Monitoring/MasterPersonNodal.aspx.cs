...
public partial class MasterPersonNodal : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        {
            MessageBox.Show("Please Provide Nodal Department Name");
            txtPersonName.Focus();
            return;
        }
        ...
        obj_PersonJuridiction.PersonJuridiction_UserTypeId = 12;
        ...
        if ((new DataLayer()).Insert_Employee(obj_PersonDetail, obj_PersonJuridiction, null, Convert.ToInt32(hf_Person_Id.Value), null, null, null, null, null, null, ref msg))
        {
            if (msg == "")
            {
                ...
                {
                    MessageBox.Show("Nodal Department Updated Successfully!");
                }
                else
                {
                    MessageBox.Show("Nodal Department Created Successfully!");
                }
                reset();
                return;
            }
        ...
        {
            MessageBox.Show("Error In Creating Nodal Department!");
            return;
        }
    }
