<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true" CodeFile="Report_InvoicePendency_Details.aspx.cs" Inherits="Report_InvoicePendency_Details" MaintainScrollPositionOnPostback="true" %>
                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:RadioButtonList ID="rbtSearchBy" runat="server" AutoPostBack="True" RepeatDirection="Horizontal" OnSelectedIndexChanged="rbtSearchBy_SelectedIndexChanged">
                                            <asp:ListItem Value="1" Selected="True">Till Date</asp:ListItem>
                                ...
                                <div class="col-md-2" id="divTillDate" runat="server" visible="false">
                                    <div class="form-group">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtPendencyDays" Text="15" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <asp:CheckBox ID="chkRemoveSelected" Text="Remove Invoices Whose Payment Has Been Done" runat="server" Checked="true"></asp:CheckBox>
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <asp:CheckBoxList ID="chkDisplayRecords" runat="server" RepeatDirection="Horizontal">
                                            <asp:ListItem Text="Package Invoice" Value="I" Selected="True"></asp:ListItem>
                                            <asp:ListItem Text="Other Dept Invoice" Value="A"></asp:ListItem>
                                            <asp:ListItem Text="Moblization Advance" Value="M"></asp:ListItem>
                                            <asp:ListItem Text="Deduction Release" Value="D"></asp:ListItem>
                                        </asp:CheckBoxList>
                                    </div>
                                </div>
                            </div>
                        ...
                        <h3 class="header smaller red">Pending Invoice Details
                        </h3>
                                    ...
                                    <div class="tab-content">
                                        <div id="doc1" class="tab-pane fade active in">
                                            ...
                                            <div style="overflow: auto">
                                                <asp:GridView ID="grdInvoice" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-hover" EmptyDataText="No Records Found" OnPreRender="grdInvoice_PreRender" OnRowDataBound="grdInvoice_RowDataBound" ShowFooter="true">
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="Is_Change" HeaderText="Is_Change">
                                                            <HeaderStyle CssClass="displayStyle" />
                                                            <ItemStyle CssClass="displayStyle" />
                                                            <FooterStyle CssClass="displayStyle" />
                                                        </asp:BoundField>
                                                        ...
                                                        <asp:BoundField DataField="Date_Diff_Action" HeaderText="Days Since Pending" />
                                                    </Columns>
                                        ...
                                        <div id="doc2" class="tab-pane fade">
                                            ...
                                            <div style="overflow: auto">
                                                <asp:GridView ID="grdADP" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdADP_PreRender" OnRowDataBound="grdADP_RowDataBound" ShowFooter="true">
                                                    <Columns>
                                        ...
                                        <div id="doc3" class="tab-pane fade">
                                            ...
                                            <!-- div.dataTables_borderWrap -->
                                            <div style="overflow: auto">
                                                <asp:GridView ID="grdMA" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdMA_PreRender" OnRowDataBound="grdMA_RowDataBound" ShowFooter="true">
                                                    <Columns>
                                                        <asp:BoundField DataField="ProjectWorkPkg_Id" HeaderText="ProjectWorkPkg_Id">
                                                            <HeaderStyle CssClass="displayStyle" />
                                                            <ItemStyle CssClass="displayStyle" />
                                        ...
                                        <div id="doc4" class="tab-pane fade">
                                            ...
                                            <!-- div.dataTables_borderWrap -->
                                            <div style="overflow: auto">
                                                <asp:GridView ID="grdDeductionRelease" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdDeductionRelease_PreRender" OnRowDataBound="grdDeductionRelease_RowDataBound" ShowFooter="true">
                                                    <Columns>
                                                        <asp:BoundField DataField="ProjectWorkPkg_Id" HeaderText="ProjectWorkPkg_Id">
                                                            <HeaderStyle CssClass="displayStyle" />
                                                            <ItemStyle CssClass="displayStyle" />
