...
public partial class MasterProjectWorkSNALimit : System.Web.UI.Page
{
    ...
    protected void get_tbl_ProjectWork(string _Type)
    {
        ...
        DataSet ds = new DataSet();
        ds = (new DataLayer()).get_tbl_ProjectWork_Assign_SNA_Limit(Scheme_Id, 0, Zone_Id, Circle_Id, Division_Id, 0, _Type, 0, txtProjectCode.Text.Trim());
        if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
        {
