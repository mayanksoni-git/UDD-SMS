<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin_PMS.master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeFile="MasterPlan.aspx.cs" Inherits="MasterPlan" EnableEventValidation="false" ValidateRequest="false" %>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0">Master Plan</h4>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header align-items-center d-flex">
                                        ...
                                        <a href="CreateMasterPlan.aspx" class="filter-btn" style="float: right"><i class="icon-download"></i>Create New</a>
                                    </div>
                                    <div class="card-body">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header align-items-center d-flex">
                                <h4 class="card-title mb-0 flex-grow-1">Master Plan Report</h4>
                            </div>
                            <!-- end card header -->
                            <div class="card-body">
                                <div class="live-preview">
                                            ...
                                            <asp:GridView runat="server" ID="grdPost" AllowPaging="false" CssClass="display table table-bordered" 
                                                ...
                                                <Columns>
                                                     <asp:TemplateField HeaderText="Edit">
                                                            <ItemTemplate>                                                               
                                                                <a href="CreateMasterPlan.aspx?MasterPlanID=<%# Eval("SrNo") %>" CssClass="btn btn-primary editBTN">Edit</a>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
