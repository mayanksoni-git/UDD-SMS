<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true" CodeFile="MasterSNAChildAccountLimit.aspx.cs" Inherits="MasterSNAChildAccountLimit" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" ValidateRequest="false" %>
                    ...
                    <div class="page-content">
                                ...
                                <div style="overflow: auto">
                                    <asp:GridView ID="grdPost" runat="server" AutoGenerateColumns="False" CssClass="display table table-bordered" EmptyDataText="No Records Found" OnPreRender="grdPost_PreRender" ShowFooter="true" OnRowDataBound="grdPost_RowDataBound">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="SNAAccountMaster_ProjectWotk_Id" HeaderText="SNAAccountMaster_ProjectWotk_Id">
                                                <HeaderStyle CssClass="displayStyle" />
                                                <ItemStyle CssClass="displayStyle" />
                                                <FooterStyle CssClass="displayStyle" />
                                            </asp:BoundField>
                                            ...
                                            <asp:BoundField DataField="SNAAccountLimit_Executed" HeaderText="SNAAccountLimit_Executed">
                                                <HeaderStyle CssClass="displayStyle" />
                                                <ItemStyle CssClass="displayStyle" />
                                                <FooterStyle CssClass="displayStyle" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="SNAAccountLimit_FilePath" HeaderText="SNAAccountLimit_FilePath">
                                                <HeaderStyle CssClass="displayStyle" />
                                                <ItemStyle CssClass="displayStyle" />
                                                <FooterStyle CssClass="displayStyle" />
                                            </asp:BoundField>
                                            <asp:TemplateField HeaderText="S No.">
                                                <ItemTemplate>
                                                    ...
                                                    <br />
                                                    <b><a href='Report_AccountStatement.aspx?ProjectWork_Id=<%# Eval("SNAAccountMaster_ProjectWotk_Id") %>' target="_blank"><span style="color: red">Statement</span></a></b>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <b><a href='Report_AccountStatementSNA.aspx' target="_blank"><span style="color: yellow">Full Statement</span></a></b>
                                                </FooterTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:BoundField HeaderText="Total Limit Assigned" DataField="AssignedLimit2" />
                                            <asp:BoundField HeaderText="Assigned To Bank" DataField="Executed" />
                                            <asp:BoundField HeaderText="Added On" DataField="SNAAccountLimit_AddedOn" />
                                            <asp:TemplateField HeaderText="Upload Order">
                                                <ItemTemplate>
                                                    <asp:FileUpload ID="flUploadDoc" runat="server" />
                                                    <br />
                                                    <asp:LinkButton ID="lnkDownloadLetter" runat="server" Text="Download Order" GO_FilePath='<%#Eval("SNAAccountLimit_FilePath") %>' OnClientClick="return downloadGO(this);" Font-Bold="true"></asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:BoundField HeaderText="Vendor" DataField="List_Vendor" />
                                        </Columns>
                        ...
                        <div class="row" id="divUpload" runat="server">
                            <div class="col-sm-12">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <asp:Button ID="btnUploadDoc" Text="Upload Order" OnClick="btnUploadDoc_Click" runat="server" CssClass="btn btn-warning"></asp:Button>
                                    </div>
                                </div>
                            </div>
                        </div>
