<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true" CodeFile="Report_DPR_BPM_Report_CNDS.aspx.cs" Inherits="Report_DPR_BPM_Report_CNDS" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" ValidateRequest="false" %>
                                                            ...
                                                            <div style="overflow: auto">
                                                                <asp:GridView ID="grdPost" runat="server" CssClass="display table table-bordered" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdPost_PreRender" OnRowDataBound="grdPost_RowDataBound" ShowFooter="true">
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="PE Done">
                                                                            <ItemTemplate>
                                                                                <asp:LinkButton ID="lnkPEDone" runat="server" Text='<%# Eval("PE_Done") %>' OnClick="lnkPEDone_Click"></asp:LinkButton>
                                                                            </ItemTemplate>
                                                                            <FooterTemplate>
                                                                                <asp:LinkButton ID="lnkPEDoneF" runat="server" OnClick="lnkPEDoneF_Click" ForeColor="White"></asp:LinkButton>
                                                                            </FooterTemplate>
                                                                        </asp:TemplateField>
                                                                        <asp:TemplateField HeaderText="DPR Prepared">
                                                                            <ItemTemplate>
                                                                                <asp:LinkButton ID="lnkDPR_Prepared" runat="server" Text='<%# Eval("DPR_Prepared") %>' OnClick="lnkDPR_Prepared_Click"></asp:LinkButton>
                                                                            </ItemTemplate>
                                                                            <FooterTemplate>
                                                                                <asp:LinkButton ID="lnkDPR_PreparedF" runat="server" OnClick="lnkDPR_PreparedF_Click" ForeColor="White"></asp:LinkButton>
                                                                            </FooterTemplate>
                                                                        </asp:TemplateField>
                                                                        <asp:TemplateField HeaderText="DPR Approved From Client">
                                                                            <ItemTemplate>
                                                                                <asp:LinkButton ID="lnkEFC_PFAD_Done" runat="server" Text='<%# Eval("EFC_PFAD_Done") %>' OnClick="lnkEFC_PFAD_Done_Click"></asp:LinkButton>
                                                                            </ItemTemplate>
                                                                            <FooterTemplate>
                                                                                <asp:LinkButton ID="lnkEFC_PFAD_DoneF" runat="server" OnClick="lnkEFC_PFAD_DoneF_Click" ForeColor="White"></asp:LinkButton>
                                                                            </FooterTemplate>
                                                                        </asp:TemplateField>
                                                                        <asp:TemplateField HeaderText="Form J Filled">
                                                                            <ItemTemplate>
                                                                                <asp:LinkButton ID="lnkForm_J_Done" runat="server" Text='<%# Eval("Form_J_Done") %>' OnClick="lnkForm_J_Done_Click"></asp:LinkButton>
                                                                            </ItemTemplate>
                                                                            <FooterTemplate>
                                                                                <asp:LinkButton ID="lnkForm_J_DoneF" runat="server" OnClick="lnkForm_J_DoneF_Click" ForeColor="White"></asp:LinkButton>
                                                                            </FooterTemplate>
                                                                        </asp:TemplateField>
                                                                        <asp:TemplateField HeaderText="DPR Send To HQ For TS">
                                                                            <ItemTemplate>
                                                                                <asp:LinkButton ID="lnkDPR_Send_HQ_TS" runat="server" Text='<%# Eval("DPR_Send_HQ_TS") %>' OnClick="lnkDPR_Send_HQ_TS_Click"></asp:LinkButton>
                                                                            </ItemTemplate>
                                                                            <FooterTemplate>
                                                                                <asp:LinkButton ID="lnkDPR_Send_HQ_TSF" runat="server" OnClick="lnkDPR_Send_HQ_TSF_Click" ForeColor="White"></asp:LinkButton>
                                                                            </FooterTemplate>
                                                                        </asp:TemplateField>
                                                                        <asp:TemplateField HeaderText="TS Approved From HQ">
                                                                            <ItemTemplate>
                                                                                <asp:LinkButton ID="lnkTS_Approved_HQ" runat="server" Text='<%# Eval("TS_Approved_HQ") %>' OnClick="lnkTS_Approved_HQ_Click"></asp:LinkButton>
                                                                            </ItemTemplate>
                                                                            <FooterTemplate>
                                                                                <asp:LinkButton ID="lnkTS_Approved_HQF" runat="server" OnClick="lnkTS_Approved_HQF_Click" ForeColor="White"></asp:LinkButton>
                                                                            </FooterTemplate>
                                                                        </asp:TemplateField>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Tender Uploaded">
                                                                            <ItemTemplate>
                                                                                <asp:LinkButton ID="lnkTender_Uploaded" runat="server" Text='<%# Eval("Tender_Uploaded") %>' OnClick="lnkTender_Uploaded_Click"></asp:LinkButton>
                                                                            </ItemTemplate>
                                                                            <FooterTemplate>
                                                                                <asp:LinkButton ID="lnkTender_UploadedF" runat="server" OnClick="lnkTender_UploadedF_Click" ForeColor="White"></asp:LinkButton>
                                                                            </FooterTemplate>
                                                                        </asp:TemplateField>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="L1 Bidder Selected">
                                                                            <ItemTemplate>
                                                                                <asp:LinkButton ID="lnkL1_Selected" runat="server" Text='<%# Eval("L1_Selected") %>' OnClick="lnkL1_Selected_Click"></asp:LinkButton>
                                                                            </ItemTemplate>
                                                                            <FooterTemplate>
                                                                                <asp:LinkButton ID="lnkL1_SelectedF" runat="server" OnClick="lnkL1_SelectedF_Click" ForeColor="White"></asp:LinkButton>
                                                                            </FooterTemplate>
                                                                        </asp:TemplateField>
                                                                        <asp:TemplateField HeaderText="LOA Issued">
                                                                            <ItemTemplate>
                                                                                <asp:LinkButton ID="lnkLOA_Issued" runat="server" Text='<%# Eval("LOA_Issued") %>' OnClick="lnkLOA_Issued_Click"></asp:LinkButton>
                                                                            </ItemTemplate>
                                                                            <FooterTemplate>
                                                                                <asp:LinkButton ID="lnkLOA_IssuedF" runat="server" OnClick="lnkLOA_IssuedF_Click" ForeColor="White"></asp:LinkButton>
                                                                            </FooterTemplate>
                                                                        </asp:TemplateField>
                                                                        <asp:TemplateField HeaderText="Work Order Issued">
                                                                            <ItemTemplate>
                                                                                <asp:LinkButton ID="lnkWork_Order_Issued" runat="server" Text='<%# Eval("Work_Issued") %>' OnClick="lnkWork_Order_Issued_Click"></asp:LinkButton>
                                                                            </ItemTemplate>
                                                                            <FooterTemplate>
                                                                                <asp:LinkButton ID="lnkWork_Order_IssuedF" runat="server" OnClick="lnkWork_Order_IssuedF_Click" ForeColor="White"></asp:LinkButton>
                                                                            </FooterTemplate>
                                                                        </asp:TemplateField>
                                                                        <asp:TemplateField HeaderText="CB Signed">
                                                                            <ItemTemplate>
                                                                                <asp:LinkButton ID="lnkCB_Signed" runat="server" Text='<%# Eval("CB_Date") %>' OnClick="lnkCB_Signed_Click"></asp:LinkButton>
                                                                            </ItemTemplate>
                                                                            <FooterTemplate>
                                                                                <asp:LinkButton ID="lnkCB_signedF" runat="server" OnClick="lnkCB_signedF_Click" ForeColor="White"></asp:LinkButton>
                                                                            </FooterTemplate>
                                                                        </asp:TemplateField>
                                                                    </Columns>
