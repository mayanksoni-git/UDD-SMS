<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true"
    CodeFile="Report_Salary_Register_Zone.aspx.cs" Inherits="Report_Salary_Register_Zone" %>
                    ...
                    <div class="page-content">
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <h3 class="header smaller lighter blue">Salary Register Zone Wise</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-9">
                                <div class="form-group">
                                    <asp:Label ID="Label4" runat="server" Text="Class" CssClass="control-label no-padding-right"></asp:Label>
                                    <asp:ListBox ID="ddlClass" runat="server" SelectionMode="Multiple" class="chosen-select form-control" data-placeholder="Choose a Class..."></asp:ListBox>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <br />
                                    <asp:Button ID="btnApply" Text="Filter" runat="server" CssClass="btn btn-danger" OnClick="btnApply_Click"></asp:Button>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                                    ...
                                                    <asp:TemplateField HeaderText="S No.">
                                                     ...
                                                     <asp:TemplateField HeaderText="Zone">
                                                        <ItemTemplate>
                                                         ...
                                                         <FooterTemplate>
                                                            <asp:LinkButton ID="lnkZoneF" runat="server" OnClick="lnkZoneF_Click" Text="Total: "></asp:LinkButton>
                                                        </FooterTemplate>
                                                    </asp:TemplateField>
