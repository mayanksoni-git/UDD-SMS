<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/TemplateMasterAdmin2.master" CodeFile="MasterLeaveType.aspx.cs" Inherits="MasterLeaveType" %>
                ...
                <ContentTemplate>
                    ...
                    <div class="page-content">
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="clearfix">
                                    <asp:Button ID="btnAddNew" runat="server"  Text="Create New" OnClick="btnAddNew_Click" CssClass="btn btn-warning"></asp:Button>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div style="overflow: auto">
                                             <asp:GridView ID="grdPost" runat="server" CssClass="display table table-bordered" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdPost_PreRender">
                                                <Columns>
                                                    <asp:BoundField DataField="LeaveType_Id" HeaderText="LeaveType_ID">
                                                    ...
                                                    <asp:BoundField DataField="LeaveType_Name" HeaderText="Leave Name" />
                    ...
                    <asp:Panel ID="Panel1" runat="server" CssClass="modalPopup1" Style="display: none; width: 800px; margin-left: -32px">
                            ...
                            <div class="col-md-12">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <asp:Label ID="lblLeaveInfo" runat="server" Text="Leave Info *" CssClass="control-label no-padding-right"></asp:Label>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <asp:Button ID="btnReset" runat="server" Text="Reset" CssClass="btn" OnClick="btnReset_Click"></asp:Button>
                    ...
                    <asp:HiddenField ID="hf_LeaveName_Id" runat="server" Value="0" />
