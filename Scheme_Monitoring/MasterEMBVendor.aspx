<%@ Page Language="C#" MasterPageFile="~/TemplatePopup.master" AutoEventWireup="true"
    CodeFile="MasterEMBVendor.aspx.cs" Inherits="MasterEMBVendor" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" ValidateRequest="false" %>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <div class="table-header">
                                    Select A Work Package TO Create Shadow EMB
                        ...
                        <div id="divEntry" runat="server" visible="false">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="col-md-12">
                                        <div style="overflow: auto">
                                            <asp:GridView ID="grdEMB" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdEMB_PreRender" OnRowDataBound="grdEMB_RowDataBound" OnPageIndexChanging="GrdEMB_PageIndexChanging">
                                                <Columns>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <asp:Label ID="Label1" runat="server" Text="Forward To JE" CssClass="control-label no-padding-right"></asp:Label>
                                            <asp:DropDownList ID="ddlJE" runat="server" CssClass="form-control"></asp:DropDownList>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <br />
                                            <asp:Button ID="btnSaveAndForward" Text="Save EMB (Shadow)" OnClick="btnSaveAndForward_Click" runat="server" CssClass="btn btn-info"></asp:Button>
                                        </div>
                                    </div>
                                </div>
                            </div>
