<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin_PMS.master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeFile="WorkProposalDashboard1.aspx.cs" Inherits="WorkProposalDashboard" EnableEventValidation="false" ValidateRequest="false" %>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="card">
                                    <div class="card-header align-items-center d-flex">
                                        <h4 class="card-title mb-0 flex-grow-1">Work Proposal Dashboard</h4>
                                    </div>
                                    <div class="card-body">
