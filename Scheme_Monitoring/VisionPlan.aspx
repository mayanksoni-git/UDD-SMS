                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0" id="HeadingSec" runat="server">Karya Yojna(कार्य योजना)</h4>
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Home</a></li>
                                            <li class="breadcrumb-item">CMVNY Scheme</li>
                                            <li class="breadcrumb-item active">Karya Yojna(कार्य योजना)</li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="card" id="sectionFilter" runat="server">
                                    <div class="card-header align-items-center d-flex">
                                        ...
                                        <a href="CreateVisionPlan.aspx" class="filter-btn" style="float: right; width: 155px;"><i class="icon-download"></i>Add Karya Yojna(कार्य योजना)</a>
                                            ...
                                            <div class="row gy-4">
                                                ...
                                                <div class="col-xxl-3 col-md-6">
                                                    <div id="div1" runat="server">
                                                        <asp:Label ID="Label1" runat="server" Text="Constructed Year" CssClass="form-label"></asp:Label>
                                            ...
                                            <asp:Repeater ID="grdPost" runat="server" OnItemCommand="grdPost_ItemCommand" OnItemDataBound="grdPost_ItemDataBound">
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:Label ID="lblDivision" runat="server"><%# DataBinder.Eval(Container.DataItem, "DivName") %></asp:Label></td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <asp:Label ID="lblVPCreatedOn" runat="server"><%# DataBinder.Eval(Container.DataItem, "VPCreatedOn", "{0:dd/MM/yyyy}") %></asp:Label></td>
                                                        <td>
                                                            <asp:Label ID="lblVPUpdatedOn" runat="server"><%# DataBinder.Eval(Container.DataItem, "VPUpdatedOn", "{0:dd/MM/yyyy}") %></asp:Label></td>
                                                        <td>
