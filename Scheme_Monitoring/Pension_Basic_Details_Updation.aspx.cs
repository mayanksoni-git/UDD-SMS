...
public partial class Pension_Basic_Details_Updation : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString.Count > 0)
            {
                ...
                get_Pensioner_Details_Verification();
            }
        }
    }
    ...
    private void get_Pensioner_Details_Verification()
    {
        int Zone_Id = 0;
        int Circle_Id = 0;
        int Division_Id = 0;
        ...
        DataSet ds = new DataSet();
        ds = (new DataLayer()).get_Pensioner_Details_Verification(Zone_Id, Circle_Id, Division_Id);
    ...
    protected void btnView_Click(object sender, ImageClickEventArgs e)
    {
        ...
        string CR_No = (gr.FindControl("txtCRNo") as TextBox).Text.Trim();
        ...
        if (CR_No == "")
        {
            MessageBox.Show("Please Provide CR No");
            (gr.FindControl("txtCRNo") as TextBox).Focus();
            return;
        }
        if (DOR == "")
        {
            MessageBox.Show("Please Provide Date Of Retirement / Death");
        ...
        if (new DataLayer().Update_Pension_Data_Verification(Account_No, IFSC_Code, CR_No, DOR, PANNo, AadharNo, Convert.ToInt32(Session["Person_Id"].ToString()), Pension_Master_Dump))
        {
