<%@ Page  Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true" CodeFile="ADPReport.aspx.cs" Inherits="ADPReport" %>
                    ...
                    <div class="page-content">
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <div class="table-header">
                                    Select A Work Package To Other Departmental Report
                        ...
                        <div id="divEntry" runat="server" visible="false">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div style="overflow: auto">
                                        <asp:GridView ID="grdADPItems" runat="server" CssClass="display table table-bordered" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnRowDataBound="grdADPItems_RowDataBound">
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="Package_ADP_Item_Specification" HeaderText="Specification" />
                                                        ...
                                                        <asp:GridView ID="grdTaxes" runat="server" CssClass="display table table-bordered" AutoGenerateColumns="False" ShowHeader="false" OnRowDataBound="grdTaxes_RowDataBound" Width="250px">
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="%">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txtTaxesP" runat="server" CssClass="form-control" MaxLength="10" onkeyup="isNumericVal(this);" Text='<%# Eval("Package_ADP_Item_Tax_Value") %>' Enabled="false"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                            </Columns>
                                                        </asp:GridView>
                                    ...
                                    <div class="col-md-12">
                                        <div style="overflow: auto; height: 450px;">
                                            <asp:GridView ID="grdEMBHistory" runat="server" CssClass="display table table-bordered" AutoGenerateColumns="False" EmptyDataText="No Records Found">
                                                <Columns>
                                                    <asp:BoundField DataField="PackageADPApproval_Id" HeaderText="PackageADPApproval_Id">
                                                        <HeaderStyle CssClass="displayStyle" />
                                                        <ItemStyle CssClass="displayStyle" />
                                                        <FooterStyle CssClass="displayStyle" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="PackageADPApproval_Package_ADP_Id" HeaderText="PackageADPApproval_Package_ADP_Id">
                                                        <HeaderStyle CssClass="displayStyle" />
                                                        <ItemStyle CssClass="displayStyle" />
                                                        <FooterStyle CssClass="displayStyle" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="PackageADPApproval_Package_Id" HeaderText="PackageADPApproval_Package_Id">
                                                        <HeaderStyle CssClass="displayStyle" />
                                                        <ItemStyle CssClass="displayStyle" />
                                                        <FooterStyle CssClass="displayStyle" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="PackageADPApproval_Status_Id" HeaderText="PackageADPApproval_Status_Id">
                                                        <HeaderStyle CssClass="displayStyle" />
                                                        <ItemStyle CssClass="displayStyle" />
                                                        <FooterStyle CssClass="displayStyle" />
                                                    </asp:BoundField>
                                                    ...
                                                    <asp:BoundField DataField="PackageADPApproval_Comments" HeaderText="Comments" />
                                                    ...
                                                    <asp:BoundField DataField="PackageADPApproval_AddedOn" HeaderText="Added On" />
                        ...
                        <asp:HiddenField ID="hf_Package_ADP_Id" runat="server" Value="0" />
                    </div>
                </ContentTemplate>
            </asp:UpdatePanel>
