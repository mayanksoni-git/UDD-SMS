<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true" CodeFile="MasterProjectWorkSNALimitRevert.aspx.cs" Inherits="MasterProjectWorkSNALimitRevert" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" ValidateRequest="false" %>
                    ...
                    <div class="page-content">
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <h3 class="header smaller lighter blue">Project List To Revert Limit
                                                                ...
                                                                <table class="table table-striped table-bordered table-hover no-margin-bottom no-border-top">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            <td>Update Limit</td>
                                                                            <td>
                                                                                <asp:TextBox ID="txtLimit" runat="server" CssClass="form-control" Width="120px" Text='0'></asp:TextBox></td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                            </ItemTemplate>
