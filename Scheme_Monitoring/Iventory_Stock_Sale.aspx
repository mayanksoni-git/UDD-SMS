<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin2.master" AutoEventWireup="true" CodeFile="Iventory_Stock_Sale.aspx.cs" Inherits="Iventory_Stock_Sale" %>
                            ...
                            <div class="col-sm-12">
                                ...
                                <div id="divEntry" runat="server" visible="false">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <div class="table-header">
                                                Details Of Item Stock Consumption
                                            </div>
                                        </div>
                                    </div>                                    
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-3">
                                            <div class="form-group">
                                                <asp:Label ID="Label5" runat="server" Text="Responsible Staff" CssClass="control-label no-padding-right"></asp:Label>
                                        ...
                                        <div class="col-xs-3">
                                            <div class="form-group">
                                                <asp:Label ID="Label4" runat="server" Text="Project Code Where Item Will Be Used" CssClass="control-label no-padding-right"></asp:Label>
                                        ...
                                        <div class="col-xs-6">
                                            <div class="form-group">
                                                <asp:Label ID="Label6" runat="server" Text="Project Name Where Item Will Be Used" CssClass="control-label no-padding-right"></asp:Label>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-3">
                                            <div class="form-group">
                                                <br />
                                                <asp:Button ID="btnTransfer" Text="Update Stocks Out" OnClick="btnTransfer_Click" runat="server" CssClass="btn btn-danger"></asp:Button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
