<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin2.master" AutoEventWireup="true" CodeFile="Master_Inventory_Company.aspx.cs" Inherits="Master_Inventory_Company" %>
        ...
        <div class="main-content-inner">
            ...
            <asp:UpdatePanel ID="up" runat="server">
                <ContentTemplate>
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div style="overflow: auto">
                                            <asp:GridView ID="grdPost" runat="server" CssClass="display table table-bordered" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdPost_PreRender">
                                                <Columns>
                                                    <asp:BoundField DataField="Inventory_Company_Id" HeaderText="Inventory_Company_ID">
                                                    ...
                                                    <asp:BoundField DataField="Inventory_Company_Name" HeaderText="Pay Band" />
                            ...
                            <div class="col-md-12">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <asp:Label ID="lblInventory_Company" runat="server" Text="Inventory Company" CssClass="control-label no-padding-right"></asp:Label>
                                        <asp:TextBox ID="txtInventory_Company" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                    ...
                    <asp:HiddenField ID="hf_Inventory_Company_Id" runat="server" Value="0" />
