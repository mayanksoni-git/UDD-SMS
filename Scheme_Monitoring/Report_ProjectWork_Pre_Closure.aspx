                                                ...
                                                <div class="tabbable">
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        <div id="doc3" class="tab-pane fade">
                                                            ...
                                                            <div style="overflow: auto">
                                                                <asp:GridView ID="grdFinancialPartial" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdFinancialPartial_PreRender" OnRowDataBound="grdFinancialPartial_RowDataBound">
                                                                    <Columns>
                                                                        <asp:BoundField DataField="ProjectWork_Id" HeaderText="ProjectWork_Id">
                                                                            <HeaderStyle CssClass="displayStyle" />
                                                                            <ItemStyle CssClass="displayStyle" />
