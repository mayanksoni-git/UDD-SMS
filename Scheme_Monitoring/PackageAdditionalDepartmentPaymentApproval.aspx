<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true" CodeFile="PackageAdditionalDepartmentPaymentApproval.aspx.cs" Inherits="PackageAdditionalDepartmentPaymentApproval" %>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <div class="table-header">
                                    Select A Work Package TO Approval Other Departmental
                                    ...
                                    <div style="overflow: auto">
                                        <asp:GridView ID="grdADPItems" runat="server" CssClass="display table table-bordered" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnRowDataBound="grdADPItems_RowDataBound" ShowFooter="true">
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="ADP_Item_Amount" HeaderText="Amount" />
                                                ...
                                                <asp:BoundField DataField="ADP_Item_TotalAmount" HeaderText="Total Amount" />
                                            </Columns>
                                                ...
                                                <div style="overflow: auto">
                                                    <asp:GridView ID="grdMultipleFiles" runat="server" CssClass="display table table-bordered" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnRowDataBound="grdMultipleFiles_RowDataBound">
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField HeaderText="Order No" DataField="Package_ADPDocs_OrderNo" />
                                                            <asp:BoundField HeaderText="Comments" DataField="Package_ADPDocs_Comments" />
                                                            <asp:TemplateField HeaderText="Download">
                                                                <ItemTemplate>
                                                                    <asp:LinkButton ID="lnkDownload" runat="server" Text="Download" PersonFiles_FilePath='<%#Eval("Package_ADPDocs_FileName") %>' OnClientClick="return downloadFile(this);"></asp:LinkButton>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                        </Columns>
                                                    </asp:GridView>
