<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true"
    CodeFile="MasterULBIncome.aspx.cs" Inherits="MasterULBIncome" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" ValidateRequest="false" %>
        ...
        <div class="page-content">
            ...
            <asp:UpdatePanel ID="up" runat="server">
                <ContentTemplate>
                        ...
                        <div class="row">
                            <div class="col-12">
                                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                        <h4 class="mb-sm-0">ULB Income Type Master</h4>
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div style="overflow: auto">
                                            <asp:GridView ID="grdPost" runat="server" CssClass="display table table-bordered" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdPost_PreRender">
                                                <Columns>
                                                    <asp:BoundField DataField="ULBIncomeType_Id" HeaderText="Income Type Id">
                            ...
                            <div class="col-md-12">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <asp:Label ID="lblULBIncomeType" runat="server" Text="Income Type*" CssClass="control-label no-padding-right"></asp:Label>
                                        <asp:TextBox ID="txtULBIncomeType" runat="server" CssClass="form-control mb-2"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <asp:HiddenField ID="hf_ULBIncomeType_Id" runat="server" Value="0" />
                </ContentTemplate>
            </asp:UpdatePanel>
