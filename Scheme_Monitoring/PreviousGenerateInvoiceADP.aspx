<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true" CodeFile="PreviousGenerateInvoiceADP.aspx.cs" Inherits="PreviousGenerateInvoiceADP" %>
                    ...
                    <div class="page-content">
                        ...
                        <div id="divEntry" runat="server" visible="false">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <asp:Label ID="Label1" runat="server" Text="Bill / Ref No" CssClass="control-label no-padding-right"></asp:Label>
                                            <asp:TextBox ID="txtRABillNo" onkeyup="isNumericVal(this);" runat="server" CssClass="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <asp:Label ID="Label2" runat="server" Text="Bill / Refrence Date" CssClass="control-label no-padding-right"></asp:Label>
                        ...
                        <div id="divPreInvoiceDetails" runat="server" visible="false">
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="table-header">
                                        Previous Other Departmental Invoice Details                               
                                    </div>
                                </div>
                            </div>
                            <div class="row">
