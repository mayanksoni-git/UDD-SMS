...
public partial class Report_Invoice_Status_Change_DR : System.Web.UI.Page
{
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        DataSet ds = new DataSet();
        ds = (new DataLayer()).get_DR_Invoice_Status_History(Zone_Id, Circle_Id, Division_Id, Project_Id, txtFromDate.Text.Trim(), txtTillDate.Text.Trim(), InvoiceStatus_Id, Convert.ToInt32(Session["Person_BranchOffice_Id"].ToString()), Convert.ToInt32(Session["PersonJuridiction_DesignationId"].ToString()), 0, 0);
        if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
        {
