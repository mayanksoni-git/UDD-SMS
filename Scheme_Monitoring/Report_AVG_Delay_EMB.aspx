<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true" CodeFile="Report_AVG_Delay_EMB.aspx.cs" Inherits="Report_AVG_Delay_EMB" %>
                        ...
                        <div runat="server" visible="false" id="divData">
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <h3 class="header smaller lighter blue">Average Delay In MB Uploading</h3>
                                            ...
                                            <div style="overflow: auto">
                                                <asp:GridView ID="grdPost" runat="server" CssClass="display table table-bordered" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdPost_PreRender" ShowFooter="true" OnRowDataBound="grdPost_RowDataBound">
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="PackageEMB_Master_AddedBy" HeaderText="PackageEMB_Master_AddedBy">
                                                            <HeaderStyle CssClass="displayStyle" />
                                                            <ItemStyle CssClass="displayStyle" />
                                                            <FooterStyle CssClass="displayStyle" />
                                                        </asp:BoundField>
                                                        ...
                                                        <asp:BoundField HeaderText="MB Created By (JE)" DataField="Person_Name" />
                                                        <asp:BoundField HeaderText="JE Mobile No" DataField="Person_Mobile1" />
                                                        <asp:BoundField HeaderText="Total MB Generated" DataField="Total_MB" />
                                                        <asp:BoundField HeaderText="Average Delay In MB Uploading" DataField="AVG_Diff" />
                                                    </Columns>
                                        ...
                                        <div style="overflow: auto; height: 450px;">
                                            <asp:GridView ID="grdEMBHistory" runat="server" CssClass="display table table-bordered" AutoGenerateColumns="False" EmptyDataText="No Records Found">
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="ProjectWork_Name" HeaderText="Project" />
                                                    <asp:BoundField DataField="PackageEMB_Master_VoucherNo" HeaderText="Physical MB No" />
                                                    <asp:BoundField DataField="PackageEMB_Master_RA_BillNo" HeaderText="Running Bill No" />
                                                    <asp:BoundField DataField="MB_Date" HeaderText="Physical MB Date" />
                                                    <asp:BoundField DataField="MB_AddedOn" HeaderText="Added On Date" />
                                                    <asp:BoundField DataField="Days_Diffrence" HeaderText="Days Delay (Diffrence)" />
                                                </Columns>
                                            </asp:GridView>
                                        </div>
                                    </div>
