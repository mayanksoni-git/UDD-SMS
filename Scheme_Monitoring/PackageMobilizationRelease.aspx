<%@ Page  Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true" CodeFile="PackageMobilizationRelease.aspx.cs" Inherits="PackageMobilizationRelease" %>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <div class="table-header">
                                    Select A Work Package TO Add Mobilization / Designe & Drawing Release
                                            ...
                                            <div style="overflow: auto">
                                                <asp:GridView ID="grdPost" runat="server" CssClass="display table table-bordered" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdPost_PreRender" OnRowDataBound="grdPost_RowDataBound">
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField HeaderText="Agreement Amount" DataField="ProjectWorkPkg_AgreementAmount_RS" />
                                    ...
                                    <div style="overflow: auto">
                                        <table class="table  table-bordered table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:RadioButtonList ID="rbtAdvanceType" runat="server" AutoPostBack="true" OnSelectedIndexChanged="rbtAdvanceType_SelectedIndexChanged">
                                                ...
                                                <td>
                                                    <asp:TextBox runat="server" ID="txtPercentage" Text="0" MaxLength="6" AutoPostBack="true" OnTextChanged="txtPercentage_TextChanged"></asp:TextBox>
                                                </td>
                                                <td>
                                                    <asp:TextBox runat="server" ID="txtTotalAmount" Text="0" AutoPostBack="true" OnTextChanged="txtTotalAmount_TextChanged" ReadOnly="true"></asp:TextBox></td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
