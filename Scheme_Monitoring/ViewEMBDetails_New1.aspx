<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true" CodeFile="ViewEMBDetails_New1.aspx.cs" Inherits="ViewEMBDetails_New1" %>
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <table class="table table-striped table-bordered table-hover">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td class="">
                                                                                            <asp:Label ID="lblEMB_Qty_UpToDate" runat="server" CssClass="control-label no-padding-right" Text='<%# Eval("PackageEMB_Qty_UpToDate") %>'></asp:Label>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td class="">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <table class="table table-striped table-bordered table-hover">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td class="">
                                                                                            <asp:Label ID="lblEMB_PercentageToBeReleased" runat="server" CssClass="control-label no-padding-right" Text='<%# Eval("PackageEMB_PercentageToBeReleased") %>'></asp:Label>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <table class="table table-striped table-bordered table-hover">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td class="">
                                                                                            <asp:Label ID="lblEMB_Qty" runat="server" CssClass="control-label no-padding-right" Text='<%# Eval("PackageEMB_Qty") %>'></asp:Label>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td class="">
