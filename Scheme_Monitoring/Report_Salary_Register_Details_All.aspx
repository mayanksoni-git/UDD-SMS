<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true"
    CodeFile="Report_Salary_Register_Details_All.aspx.cs" Inherits="Report_Salary_Register_Details_All" %>
                                        ...
                                        <div style="overflow: auto">
                                            <asp:GridView ID="grdPost" runat="server" CssClass="display table table-bordered"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField HeaderText="Emp Code On Manav Sampada" DataField="HRMS_Employee_Code" />
                                                </Columns>
