...
public partial class Pension_Register_Import : System.Web.UI.Page
{
    ...
    protected void btnUpload_Click(object sender, EventArgs e)
    {
        ...
        string filePathFull = Server.MapPath(".") + "\\Pension\\" + fileName;
        string filePath = "\\Pension\\" + flUpload.FileName;
    ...
    public void OnPostImportFromExcel(FileInfo flExcel, bool Bind_Sheet_DDL, string Sheet_Name)
    {
        ...
        try
        {
            ...
            else
            {
                ...
                ViewState["PensionData"] = ds.Tables[0];
            }
        }
        catch (Exception ee)
        {
            ViewState["PensionData"] = null;
    ...
    protected void btnImport_Click(object sender, EventArgs e)
    {
        ...
        string msg = "";
        DataTable dt_Tally_Data = (DataTable)ViewState["PensionData"];
        if (new DataLayer().Insert_Pension_Register_Data(dt_Tally_Data, Zone_Id, Circle_Id, Division_Id, ref msg))
        {
