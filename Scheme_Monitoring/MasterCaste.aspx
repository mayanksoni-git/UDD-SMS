<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin2.master"  AutoEventWireup="true" CodeFile="MasterCaste.aspx.cs" Inherits="MasterCaste" %>
        ...
        <div class="main-content-inner">
            ...
            <asp:UpdatePanel ID="up" runat="server">
                <ContentTemplate>
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div style="overflow: auto">
                                            <asp:GridView ID="grdPost" runat="server" CssClass="display table table-bordered" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdPost_PreRender">
                                                <Columns>
                                                    <asp:BoundField DataField="Caste_Id" HeaderText="Caste_Id">
                                                    ...
                                                    <asp:BoundField DataField="Caste_Name" HeaderText="Caste" />
                            ...
                            <div class="col-md-12">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <asp:Label ID="lblCaste" runat="server" Text="Caste *" CssClass="control-label no-padding-right"></asp:Label>
                    ...
                    <asp:HiddenField ID="hf_Caste_Id" runat="server" Value="0" />
