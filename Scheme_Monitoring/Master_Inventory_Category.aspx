<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin2.master" AutoEventWireup="true" CodeFile="Master_Inventory_Category.aspx.cs" Inherits="Master_Inventory_Category" %>
        ...
        <div class="main-content-inner">
            ...
            <asp:UpdatePanel ID="up" runat="server">
                <ContentTemplate>
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div style="overflow: auto">
                                            <asp:GridView ID="grdPost" runat="server" CssClass="display table table-bordered" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdPost_PreRender">
                                                <Columns>
                                                    <asp:BoundField DataField="Inventory_Category_Id" HeaderText="Inventory_Category_ID">
                                                    ...
                                                    <asp:BoundField DataField="Inventory_Category_Name" HeaderText="Pay Band" />
                            ...
                            <div class="col-md-12">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <asp:Label ID="lblInventory_Category" runat="server" Text="Inventory Category" CssClass="control-label no-padding-right"></asp:Label>
                                        <asp:TextBox ID="txtInventory_Category" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                    ...
                    <asp:HiddenField ID="hf_Inventory_Category_Id" runat="server" Value="0" />
