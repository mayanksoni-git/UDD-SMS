<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin2.master" AutoEventWireup="true" CodeFile="MasterBasicGPFRate.aspx.cs" Inherits="MasterBasicGPFRate" %>
        ...
        <div class="main-content-inner">
            ...
            <asp:UpdatePanel ID="up" runat="server">
                <ContentTemplate>
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div style="overflow: auto">
                                            <asp:GridView ID="grdPost" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdPost_PreRender">
                                                <Columns>
                                                    <asp:BoundField DataField="Basic_GPF_Rate_Id" HeaderText="Basic_GPF_Rate_ID">
                                                    ...
                                                    <asp:BoundField DataField="Basic_GPF_Rate" HeaderText="Basic GPF Rate" />
                                                    <asp:BoundField DataField="Basic_GPF_Rate_EffectiveBy" HeaderText="Effective By" />
                            ...
                            <div class="col-sm-12">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <asp:Label ID="lblBasicPensionRate" runat="server" Text="Basic GPF Rate*" CssClass="control-label no-padding-right"></asp:Label>
                                        <asp:TextBox ID="txtBasicGPFRate" runat="server" CssClass="form-control" autocomplete="off" onkeyup="isNumericVal(this);"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                    ...
                    <asp:HiddenField ID="hf_Basic_GPF_Rate_Id" runat="server" Value="0" />
                </ContentTemplate>
            </asp:UpdatePanel>
