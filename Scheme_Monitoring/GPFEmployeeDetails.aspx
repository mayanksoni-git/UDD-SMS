<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin2.master" AutoEventWireup="true" CodeFile="GPFEmployeeDetails.aspx.cs" Inherits="GPFEmployeeDetails" %>
                                        ...
                                        <div style="overflow: auto">
                                            <asp:GridView ID="grdPost" runat="server" CssClass="display table table-bordered" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdPost_PreRender" OnRowDataBound="grdPost_RowDataBound">
                                                <Columns>
                                                    ...
                                                    <asp:BoundField HeaderText="FatherName" DataField="HRMSEmployee_FatherName" />
                                                    ...
                                                    <asp:TemplateField HeaderText="Add Passbook Details">
                                                        <ItemTemplate>
                                                            <asp:ImageButton ID="btnGPF" runat="server" Width="20px" Height="20px" OnClick="btnGPF_Click" ImageUrl="~/assets/images/edit.png" />

                                                            <asp:ImageButton ID="btnNps" runat="server" Width="20px" Height="20px" OnClick="btnNps_Click" ImageUrl="~/assets/images/edit.png" />

                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Print Passbook Details">
                                                    <ItemTemplate>
                                                        
                                                            <asp:Button ID="btnprintGPF" runat="server" CssClass="btn btn-minier btn-info" Text="Print" OnClick="btnprintGPF_Click"/>
                                                        
                                                        
                                                            <asp:Button ID="btnPrintNps" runat="server" CssClass="btn btn-minier btn-info" Text="Print" OnClick="btnPrintNps_Click"/>
