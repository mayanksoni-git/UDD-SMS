...
public partial class MasterPersonVendor : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        {
            MessageBox.Show("Please Provide GSTIN");
            txtGSTIN.Focus();
            return;
        }
        ...
        string msg = "";
        if ((new DataLayer()).Insert_Employee(obj_PersonDetail, obj_PersonJuridiction, null, Convert.ToInt32(hf_Person_Id.Value), null, null, null, obj_tbl_ULBAccountDtls, null,null, ref msg))
        {
            if (msg == "")
            {
