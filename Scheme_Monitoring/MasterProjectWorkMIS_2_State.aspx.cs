...
public partial class MasterProjectWorkMIS_2_State : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < grdCallProductDtls.Rows.Count; i++)
        {
            ...
            FilePath = grdCallProductDtls.Rows[i].Cells[7].Text.Trim();
            try
            {
            ...
            Allocated_Budget = StateShare_Budget + Centage_Budget;
            ...
            if (obj_tbl_ProjectWorkGO.ProjectWorkGO_TotalRelease + obj_tbl_ProjectWorkGO.ProjectWorkGO_StateShare + obj_tbl_ProjectWorkGO.ProjectWorkGO_ULBShare + obj_tbl_ProjectWorkGO.ProjectWorkGO_Centage > 0)
            {
    ...
    protected void grdCallProductDtls_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            string filePath = e.Row.Cells[7].Text.Trim().Replace("&nbsp;", "");
            if (filePath.Trim() != "")
            {
