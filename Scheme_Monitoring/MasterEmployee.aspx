<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin2.master" AutoEventWireup="true" CodeFile="MasterEmployee.aspx.cs" Inherits="MasterEmployee" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="main-content">
                ...
                <ContentTemplate>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="ddlBranchOffice" runat="server" CssClass="form-control" ></asp:DropDownList>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtEmployeeManager" runat="server" CssClass="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    <div class="row">
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="control-label no-padding-right">High School</label>
                                            <asp:TextBox ID="txtHigh" runat="server" CssClass="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="control-label no-padding-right">Inetrmediate</label>
                                            <asp:TextBox ID="txtInter" runat="server" CssClass="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="control-label no-padding-right">Graduation</label>
                                            <asp:TextBox ID="txtGraduation" runat="server" CssClass="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="control-label no-padding-right">Post Graduation</label>
                                            <asp:TextBox ID="txtPostGraduation" runat="server" CssClass="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="control-label no-padding-right">Other</label>
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <asp:Button ID="btnSave" Text="Save"  runat="server" CssClass="btn btn-info" OnClick="btnSave_Click"></asp:Button>
                                            &nbsp; &nbsp; &nbsp;
                                <asp:Button ID="btnReset" runat="server" Text="Reset" CssClass="btn"></asp:Button>
                                        </div>
                                    </div>
                                </div>
                            </div>
     ...
     <asp:HiddenField ID="hf_Person_Id" runat="server" Value="0" />
                    <asp:HiddenField ID="hf_MasterEmployee_Id" runat="server" Value="0" />
                </ContentTemplate>
            </asp:UpdatePanel>
