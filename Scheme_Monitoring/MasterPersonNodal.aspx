<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true" CodeFile="MasterPersonNodal.aspx.cs" Inherits="MasterPersonNodal" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" ValidateRequest="false" %>
                        ...
                        <div id="divCreateNew" runat="server" visible="false">
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="table-header">
                                        Create / Update Nodal Department
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="control-label no-padding-right">Contact Person Name*</label>
                            ...
                            <div class="col-xs-12">
                                <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        <h3 class="header smaller lighter blue">Nodal Department Master</h3>
                                        ...
                                        <div style="overflow: auto">
                                            <asp:GridView ID="grdPost" runat="server" CssClass="display table table-bordered" AutoGenerateColumns="False" HorizontalAlign="Left" EmptyDataText="No Records Found" OnPreRender="grdPost_PreRender" OnRowDataBound="grdPost_RowDataBound">
                                                <Columns>
                                                    ...
                                                    <asp:BoundField HeaderText="Nodal Department Name" DataField="Person_Name" />
                                                    ...
                                                    <asp:BoundField HeaderText="PAN" DataField="PersonJuridiction_PAN">
                                                    </asp:BoundField>
