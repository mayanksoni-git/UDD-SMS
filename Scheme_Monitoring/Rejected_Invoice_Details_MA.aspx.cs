...
public partial class Rejected_Invoice_Details_MA : System.Web.UI.Page
{
    ...
    private void get_tbl_MobilizationAdvance_Documents_Details(int Scheme_Id, int Package_MobilizationAdvance_Id)
    {
        DataSet ds = new DataSet();
        ds = (new DataLayer()).get_tbl_MobilizationAdvance_Documents_Details(Scheme_Id, Package_MobilizationAdvance_Id, true);
    ...
    private void get_tbl_PackageInvoiceMA()
    {
        ...
        DataSet ds = new DataSet();
        ds = (new DataLayer()).get_tbl_Package_MobilizationAdvance(0, Scheme_Id.ToString(), 0, Zone_Id, Circle_Id, Division_Id, 0, "", "", -2, -2, false, "", "", Expert_Person_Id, 0, 0, false, isDefered, 0);
        if (AllClasses.CheckDataSet(ds))
        {
    ...
    private DataSet filter_Data(DataSet ds)
    {
        ...
        dv.RowFilter = "Package_MobilizationAdvanceApproval_Status_Id = 2";
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        obj_tbl_Package_MobilizationAdvanceApproval.Package_MobilizationAdvanceApproval_Next_Organisation_Id = Convert.ToInt32(Session["Person_BranchOffice_Id"].ToString());
        obj_tbl_Package_MobilizationAdvanceApproval.Package_MobilizationAdvanceApproval_Next_Designation_Id = Convert.ToInt32(_data[0]);
        obj_tbl_Package_MobilizationAdvanceApproval.Package_MobilizationAdvanceApproval_Step_Count = Convert.ToInt32(_data[1]);
        obj_tbl_Package_MobilizationAdvanceApproval.Package_MobilizationAdvanceApproval_Additional_Status_Id = 0;
        obj_tbl_Package_MobilizationAdvanceApproval.Package_MobilizationAdvanceApproval_Package_MobilizationAdvance_Id = Convert.ToInt32(hf_Invoice_Id.Value);
    ...
    protected void btnUpload_Click(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < grdDocumentMaster.Rows.Count; i++)
        {
            ...
            if (flUpload.HasFile)
            {
                ...
                obj_tbl_Package_MobilizationAdvanceDocs.Package_MobilizationAdvanceDocs_Package_MobilizationAdvance_Id = Convert.ToInt32(hf_Invoice_Id.Value);
        ...
        obj_tbl_Package_MobilizationAdvanceApproval.Package_MobilizationAdvanceApproval_Package_MobilizationAdvance_Id = Convert.ToInt32(hf_Invoice_Id.Value);
        obj_tbl_Package_MobilizationAdvanceApproval.Package_MobilizationAdvanceApproval_Status = 1;
        obj_tbl_Package_MobilizationAdvanceApproval.Package_MobilizationAdvanceApproval_Next_Designation_Id = 35;
        obj_tbl_Package_MobilizationAdvanceApproval.Package_MobilizationAdvanceApproval_Next_Organisation_Id = 1;
        obj_tbl_Package_MobilizationAdvanceApproval.Package_MobilizationAdvanceApproval_Step_Count = 5;

        if (obj_tbl_Package_MobilizationAdvanceDocs_Li.Count > 0)
        {
            if (new DataLayer().Update_tbl_PackageMobilizationAdvance_Rejected(obj_tbl_Package_MobilizationAdvanceDocs_Li, obj_tbl_Package_MobilizationAdvanceApproval))
            {
    ...
    protected void btnRollback_Click(object sender, EventArgs e)
    {
        ...
        obj_tbl_Package_MobilizationAdvanceApproval.Package_MobilizationAdvanceApproval_Status_Id = 2;
        obj_tbl_Package_MobilizationAdvanceApproval.Package_MobilizationAdvanceApproval_Next_Organisation_Id = Convert.ToInt32(Session["Person_BranchOffice_Id"].ToString());
        obj_tbl_Package_MobilizationAdvanceApproval.Package_MobilizationAdvanceApproval_Next_Designation_Id = Convert.ToInt32(Session["PersonJuridiction_DesignationId"].ToString());
        obj_tbl_Package_MobilizationAdvanceApproval.Package_MobilizationAdvanceApproval_Step_Count = 8;
        obj_tbl_Package_MobilizationAdvanceApproval.Package_MobilizationAdvanceApproval_Additional_Status_Id = 0;
        obj_tbl_Package_MobilizationAdvanceApproval.Package_MobilizationAdvanceApproval_Package_MobilizationAdvance_Id = Convert.ToInt32(hf_Invoice_Id.Value);
        obj_tbl_Package_MobilizationAdvanceApproval.Package_MobilizationAdvanceApproval_Status = 1;
        obj_tbl_Package_MobilizationAdvanceApproval_Li.Add(obj_tbl_Package_MobilizationAdvanceApproval);
    ...
    {
        int Package_MobilizationAdvance_Id = 0;
        GridViewRow gr = (sender as ImageButton).Parent.Parent as GridViewRow;
        for (int i = 0; i < grdMA.Rows.Count; i++)
        {
            grdMA.Rows[i].BackColor = Color.Transparent;
        }
        gr.BackColor = Color.LightGreen;
        try
        {
            Package_MobilizationAdvance_Id = Convert.ToInt32(gr.Cells[3].Text.Trim());
        }
        catch
        {
            Package_MobilizationAdvance_Id = 0;
        }
        hf_Invoice_Id.Value = Package_MobilizationAdvance_Id.ToString();
        get_tbl_MobilizationAdvance_Documents_Details(Convert.ToInt32(ddlSearchScheme.SelectedValue), Package_MobilizationAdvance_Id);
    ...
    {
        GridViewExportUtil.Export("Rejected_Invoices.xls", grdMA);
    }
