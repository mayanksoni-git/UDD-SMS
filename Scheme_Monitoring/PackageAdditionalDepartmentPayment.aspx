<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true" CodeFile="PackageAdditionalDepartmentPayment.aspx.cs" Inherits="PackageAdditionalDepartmentPayment" %>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <div class="table-header">
                                    Select A Work Package TO Add Other Departmental
                        ...
                        <div id="divEntry" runat="server" visible="false">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="control-label no-padding-right">Other Dept. Items</label>
                                            <asp:DropDownList ID="ddlItems" runat="server" class="chosen-select form-control" data-placeholder="Please Choose From Pre Defined Items..."></asp:DropDownList>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <br />
                                            <asp:Button ID="btnAdd" Text="Add Selected Item" OnClick="btnAdd_Click" runat="server" CssClass="btn btn-purple"></asp:Button>
                                            &nbsp;
                                            <asp:Button ID="btnAddNew" Text="Add New Item" OnClick="btnAddNew_Click" runat="server" CssClass="btn btn-inverse"></asp:Button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <br />
                                            <asp:Button ID="btnCalculate" Text="Calculate Total" OnClick="btnCalculate_Click" runat="server" CssClass="btn btn-purple"></asp:Button>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
