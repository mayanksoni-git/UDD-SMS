...
public partial class Rejected_Invoice_Details : System.Web.UI.Page
{
    ...
    {
        DataSet ds = new DataSet();
        ds = (new DataLayer()).get_tbl_Invoice_Documents_Details(Scheme_Id, invoice_Id, true);
    ...
    private void get_tbl_PackageInvoice()
    {
        ...
        DataSet ds = new DataSet();
        ds = (new DataLayer()).get_tbl_PackageInvoice(0, Zone_Id, Circle_Id, Division_Id, Scheme_Id, -2, -2, false, "", "", Expert_Person_Id, 0, -1, false, -1, isDefered, "", 0, 0);
        if (AllClasses.CheckDataSet(ds))
        {
    ...
    private DataSet filter_Data(DataSet ds)
    {
        ...
        dv.RowFilter = "PackageInvoiceApproval_Status_Id = 2";
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        obj_tbl_PackageInvoiceApproval.PackageInvoiceApproval_Next_Organisation_Id = Convert.ToInt32(Session["Person_BranchOffice_Id"].ToString());
        obj_tbl_PackageInvoiceApproval.PackageInvoiceApproval_Next_Designation_Id = Convert.ToInt32(_data[0]);
        obj_tbl_PackageInvoiceApproval.PackageInvoiceApproval_Step_Count = Convert.ToInt32(_data[1]);
    ...
    protected void btnUpload_Click(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < grdDocumentMaster.Rows.Count; i++)
        {
            ...
            if (flUpload.HasFile)
            {
                ...
                obj_tbl_PackageInvoiceDocs.PackageInvoiceDocs_Invoice_Id = Convert.ToInt32(hf_Invoice_Id.Value);
                ...
                obj_tbl_PackageInvoiceDocs.PackageInvoiceDocs_Type = Convert.ToInt32(grdDocumentMaster.Rows[i].Cells[0].Text.Trim());
        ...
        obj_tbl_PackageInvoiceApproval.PackageInvoiceApproval_PackageInvoice_Id = Convert.ToInt32(hf_Invoice_Id.Value);
        obj_tbl_PackageInvoiceApproval.PackageInvoiceApproval_Status = 1;
        obj_tbl_PackageInvoiceApproval.PackageInvoiceApproval_Next_Designation_Id = 35;
        obj_tbl_PackageInvoiceApproval.PackageInvoiceApproval_Next_Organisation_Id = 1;
        obj_tbl_PackageInvoiceApproval.PackageInvoiceApproval_Step_Count = 5;

        if (obj_tbl_PackageInvoiceDocs_Li.Count > 0)
        {
            if (new DataLayer().Update_tbl_PackageInvoice_Rejected(obj_tbl_PackageInvoiceDocs_Li, obj_tbl_PackageInvoiceApproval))
            {
    ...
    protected void btnRollback_Click(object sender, EventArgs e)
    {
        ...
        obj_tbl_PackageInvoiceApproval.PackageInvoiceApproval_Status_Id = 2;
        obj_tbl_PackageInvoiceApproval.PackageInvoiceApproval_Next_Organisation_Id = Convert.ToInt32(Session["Person_BranchOffice_Id"].ToString());
        obj_tbl_PackageInvoiceApproval.PackageInvoiceApproval_Next_Designation_Id = Convert.ToInt32(Session["PersonJuridiction_DesignationId"].ToString()); 
        obj_tbl_PackageInvoiceApproval.PackageInvoiceApproval_Step_Count = 8;
        obj_tbl_PackageInvoiceApproval.PackageInvoiceApproval_Additional_Status_Id = 0;
        obj_tbl_PackageInvoiceApproval.PackageInvoiceApproval_PackageInvoice_Id = Convert.ToInt32(hf_Invoice_Id.Value);
        obj_tbl_PackageInvoiceApproval.PackageInvoiceApproval_Status = 1;
        obj_tbl_PackageInvoiceApproval_Li.Add(obj_tbl_PackageInvoiceApproval);
    ...
    {
        GridViewExportUtil.Export("Rejected_Invoices.xls", grdInvoice);
    }
