<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true"
    CodeFile="MasterEMBApprove_New.aspx.cs" Inherits="MasterEMBApprove_New" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" ValidateRequest="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <asp:UpdatePanel ID="up" runat="server">
                <ContentTemplate>
                    ...
                    <div class="page-content">
                            ...
                            <div class="col-sm-12">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="ddlScheme" runat="server" class="form-control"></asp:DropDownList>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                            ...
                                            <div style="overflow: auto">
                                                <asp:GridView ID="grdPost" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdPost_PreRender" OnRowDataBound="grdPost_RowDataBound">
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="PackageEMB_Master_ProcessType" HeaderText="PackageEMB_Master_ProcessType">
                                                            <HeaderStyle CssClass="displayStyle" />
                                                            <ItemStyle CssClass="displayStyle" />
                                                            <FooterStyle CssClass="displayStyle" />
                                                        </asp:BoundField>
                        ...
                        <div id="divEntry" runat="server" visible="false">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="col-md-12">
                                        <div style="overflow: auto">
                                            <asp:GridView ID="grdEMB" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdEMB_PreRender" OnRowDataBound="grdEMB_RowDataBound" ShowFooter="true">
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="PackageEMB_RateEstimated_T" HeaderText="Rate Estimated (Excluding GST)" />
                                                    <asp:BoundField DataField="PackageEMB_RateQuoted_T" HeaderText="Rate Quoted (Excluding GST)" />
                                                    <asp:BoundField DataField="PackageEMB_SincePrevQty" HeaderText="Quantity executed Since Previous" />
                                                    <asp:BoundField DataField="PackageEMB_SincePrevAmount" HeaderText="Payment on the basis of actual measurements (Since Previous)" />
                                                    <asp:TemplateField HeaderText="Quantity executed up to date as per MB">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtQty" runat="server" CssClass="form-control" Text='<%# Eval("PackageEMB_Qty_UpToDate") %>' Width="80px" MaxLength="10" onkeyup="isNumericVal(this);" onchange="return calculateQty(this);"></asp:TextBox>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Percentage Amount To Be Released">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtPercentageToBeReleased" runat="server" CssClass="form-control" MaxLength="11" onkeyup="isNumericVal(this);" Text='<%# Eval("PackageEMB_PercentageToBeReleased") %>' onchange="return calculateQty(this);"></asp:TextBox>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:BoundField DataField="PackageEMB_Amount_UpToDate" HeaderText="Payment on the basis of actual measurements (Up To Date)" />
                                                    <asp:BoundField DataField="PackageEMB_Qty" HeaderText="Quantity executed (As Per Current MB)" />
                                                    <asp:BoundField DataField="PackageEMB_TotalGST" HeaderText="GST" />
                                                    <asp:BoundField DataField="PackageEMB_Amount" HeaderText="Payment (As Per Current MB)" />
                                                    ...
                                                    <asp:BoundField DataField="PackageEMB_Qty_UpToDate" HeaderText="PackageEMB_Qty_UpToDate">
                                                        <HeaderStyle CssClass="displayStyle" />
                                                        <ItemStyle CssClass="displayStyle" />
                                                        <FooterStyle CssClass="displayStyle" />
                                                    </asp:BoundField>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-md-3">
                                        <asp:Button ID="btnGenerateCombineInvoice" Text="Generate Combine Invoice" OnClick="btnGenerateCombineInvoice_Click" runat="server" CssClass="btn btn-xs btn-pink"></asp:Button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div style="overflow: auto">
                                        <asp:GridView ID="grdDeductionsM" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" EmptyDataText="No Records Found" ShowFooter="true" OnRowDataBound="grdDeductionsM_RowDataBound">
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="PackageEMBAdditional_Id" HeaderText="PackageEMBAdditional_Id">
                                                    <HeaderStyle CssClass="displayStyle" />
                                                    <ItemStyle CssClass="displayStyle" />
                                                    <FooterStyle CssClass="displayStyle" />
                                                </asp:BoundField>
                                                ...
                                                <asp:TemplateField HeaderText="Deduction Value">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtDeductionValue" onkeyup="isNumericVal(this);" runat="server" CssClass="form-control" Text='<%# Eval("Deduction_Value_Master") %>' onchange="return re_Calculate_Total(this);"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:BoundField HeaderText="Amount" DataField="Deduction_Value_Final" />
                                            </Columns>
                                            <FooterStyle Font-Bold="true" BackColor="Black" ForeColor="White" />
                                        </asp:GridView>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div style="overflow: auto">
                                        <asp:GridView ID="grdProjectStatus" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdProjectStatus_PreRender">
                                            <Columns>
                            ...
                            <div class="row" runat="server" id="divActions" visible="false">
                                <div class="col-sm-12">

                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <br />
                                            <asp:Button ID="btnApproveAll" Text="Approve All Items" OnClick="btnApproveAll_Click" runat="server" CssClass="btn btn-purple"></asp:Button>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <br />
                                            <%--<asp:Button ID="btnGenerateBill" Text="Generate Bill (For Pre-Approved Items)" OnClick="btnGenerateBill_Click" runat="server" CssClass="btn btn-info"></asp:Button>--%>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <br />
                                            <asp:Button ID="btnUpdate" Text="Approve All Items & Generate Bill" OnClick="btnUpdate_Click" runat="server" CssClass="btn btn-warning"></asp:Button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <asp:HiddenField ID="hf_ProcessType" runat="server" Value="" />
    ...
    <script>
        ...
        var Rate_Type = 1;
        if (document.getElementById('ctl00_ContentPlaceHolder1_hf_ProcessType').value == "Global") {
            Rate_Type = 0;
        }
        function calculateQty(obj) {
            ...
            var GST = 0;
            try {
                GST = parseFloat(row.cells[11].innerHTML);
            }
            catch (ee) {
                GST = 0;
            }
            ...
            var Rate_Estimate = 0;
            try {
                Rate_Estimate = parseFloat(row.cells[19].innerHTML);
            }
            catch (ee) {
                Rate_Estimate = 0;
            }
            ...
            var Rate_Quoted = 0;
            try {
                Rate_Quoted = parseFloat(row.cells[20].innerHTML);
            }
            catch (ee) {
                Rate_Quoted = 0;
            }
            ...
            try {
                Payment_Since_Previous = parseFloat(row.cells[22].innerHTML);
            }
            catch (ee) {
            ...
            var Qty_Previous = 0;
            try {
                Qty_Previous = parseFloat(row.cells[21].innerHTML);
            }
            catch (ee) {
                Qty_Previous = 0;
            }
            ...
            try {
                Percentage_Prev = parseFloat(row.cells[14].innerHTML);
            }
            catch (ee) {
                Percentage_Prev = 0;
            }
            ...
            if (Percentage_Prev == Percentage && Quantity_executed_up_to_date == Qty_Previous) {
                Current_Qty = 0;
                row.cells[25].innerHTML = Payment_Since_Previous;
            }
            else {
                Current_Qty = Quantity_executed_up_to_date - Qty_Previous;
                if (Rate_Type == 1) {
                    row.cells[25].innerHTML = ((Quantity_executed_up_to_date * Rate_Quoted * Percentage) / 100).toFixed(2);
                }
                else {
                    row.cells[25].innerHTML = ((Quantity_executed_up_to_date * Rate_Estimate * Percentage) / 100).toFixed(2);
                }
            }



            row.cells[26].innerHTML = Current_Qty.toFixed(4);
            row.cells[28].innerHTML = (parseFloat(row.cells[25].innerHTML) - Payment_Since_Previous).toFixed(2);

            if (Rate_Type == 1) {
                row.cells[27].innerHTML = (row.cells[28].innerHTML * GST / 100).toFixed(2);
            }
            else {
                row.cells[27].innerHTML = 0;
            }
        ...
        //            //row.cells[24].innerHTML = ((Current_Qty * Rate_Quoted * Percentage) / 100).toFixed(2);
        //            row.cells[24].innerHTML = (parseFloat(row.cells[22].innerHTML) - Payment_Since_Previous).toFixed(2);
        //        }
        //    }
        //    calculate_Total_MB_Value();
        //}
        ...
        //        var current_total = 0;
        //        try {
        //            current_total = parseFloat(row.cells[24].innerHTML);
        //            if ($.isNumeric(current_total)) {
        //                totalVal += current_total;
        //            }
        //            else {
        //                totalVal += 0;
        //            }
