                        ...
                        <div id="divCreateNew" runat="server" visible="false">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-3" id="divExpert4" runat="server" visible="false">
                                        <div class="form-group">
                                            <asp:Label ID="Label8" runat="server" Text="Mapping Type" CssClass="control-label no-padding-right"></asp:Label>
                                            <asp:RadioButtonList ID="rbMappingType" runat="server" RepeatDirection="Horizontal" AutoPostBack="true" OnSelectedIndexChanged="rbMappingType_SelectedIndexChanged">
                                                <asp:ListItem Text="District Wise" Value="D"></asp:ListItem>
                                                <asp:ListItem Text="Zone Wise" Value="Z" Selected="True"></asp:ListItem>
                                            </asp:RadioButtonList>
                                        </div>
                                    </div>
                                    <div class="col-md-3" id="divExpert1" runat="server" visible="false">
                                        <div class="form-group">
                                            <asp:Label ID="Label4" runat="server" Text="Assign for Expert*" CssClass="control-label no-padding-right"></asp:Label>
                                            <asp:ListBox ID="lbDistrict" runat="server" SelectionMode="Multiple" class="chosen-select form-control" data-placeholder="Choose..."></asp:ListBox>
                                        </div>
                                    </div>
                                    <div class="col-md-3" id="divExpert2" runat="server" visible="false">
                                        <div class="form-group">
                                            <asp:Label ID="Label7" runat="server" Text="Scheme*" CssClass="control-label no-padding-right"></asp:Label>
                                            <asp:DropDownList ID="ddlProjectMasterExp" runat="server" class="form-control"></asp:DropDownList>
                                        </div>
                                    </div>
                                    <div class="col-md-1" id="divExpert3" runat="server" visible="false">
                                        <div class="form-group pull-right">
                                            <br />
                                            <asp:Button ID="btnAddExp" OnClick="btnAddExp_Click" Text="Add" runat="server" CssClass="btn btn-info"></asp:Button>
                                        </div>
                                    </div>
                                </div>
                            </div>

                            <div class="row" id="divExpert5" runat="server" visible="false">
                                <div class="col-sm-12">
                                    <div style="overflow: auto">
                                        <asp:GridView ID="grdExpertDist" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" EmptyDataText="No Records Found">
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="PersonAdditionalCharge_SchemeId" HeaderText="PersonAdditionalCharge_SchemeId">
                                                    <HeaderStyle CssClass="displayStyle" />
                                                    <ItemStyle CssClass="displayStyle" />
                                                    <FooterStyle CssClass="displayStyle" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="List_Jurisdiction_Id" HeaderText="List_Jurisdiction_Id">
                                                    <HeaderStyle CssClass="displayStyle" />
                                                    <ItemStyle CssClass="displayStyle" />
                                                    <FooterStyle CssClass="displayStyle" />
                                                </asp:BoundField>
                                                ...
                                                <asp:BoundField HeaderText="District" DataField="List_Jurisdiction_Name" />
                                                <asp:TemplateField HeaderText="Action">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="lnkDeleteDistrict" runat="server" OnClick="lnkDeleteDistrict_Click" ImageUrl="~/assets/images/delete.png" Width="20px" Height="20px"></asp:ImageButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <div class="table-header">
                                        Additional Jurisdiction (In Case Of Additional Charge)
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div style="overflow: auto">
                                        <asp:GridView ID="dgvAdditionalDivision" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnRowDataBound="dgvAdditionalDivision_RowDataBound">
                                            <Columns>
