<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin2.master" AutoEventWireup="true" CodeFile="MasterCadre.aspx.cs" Inherits="MasterCadre" %>
        ...
        <div class="main-content-inner">
            ...
            <asp:UpdatePanel ID="up" runat="server">
                <ContentTemplate>
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div style="overflow: auto">
                                            <asp:GridView ID="grdPost" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdPost_PreRender">
                                                <Columns>
                                                    <asp:BoundField DataField="Cadre_Id" HeaderText="Cadre_Id">
                                                    ...
                                                    <asp:BoundField DataField="Cadre_Old_Rate" HeaderText="GIS Rate For Employees DOJ Before 01.09.2013" />
                                                    <asp:BoundField DataField="Cadre_New_Rate" HeaderText="GIS Rate For Employees DOJ After 01.09.2013" />
                            ...
                            <div class="col-md-12">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <asp:Label ID="lblCadre" runat="server" Text="Cadre*" CssClass="control-label no-padding-right"></asp:Label>
                                        <asp:TextBox ID="txtCadre" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <asp:Label ID="Label1" runat="server" Text="GIS Rate For Employees DOJ Before 01.09.2013" CssClass="control-label no-padding-right"></asp:Label>
                                        <asp:TextBox ID="txtGIS_Old" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <asp:Label ID="Label2" runat="server" Text="GIS Rate For Employees DOJ After 01.09.2013" CssClass="control-label no-padding-right"></asp:Label>
                                        <asp:TextBox ID="txtGIS_New" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <asp:HiddenField ID="hf_Cadre_Id" runat="server" Value="0" />
