<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true"
    CodeFile="Report_Salary_Register_Circle.aspx.cs" Inherits="Report_Salary_Register_Circle" %>
                    ...
                    <div class="page-content">
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <h3 class="header smaller lighter blue">Salary Register Circle Wise</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                                                    ...
                                                    <asp:BoundField HeaderText="Zone" DataField="Zone_Name" />
                                                     <asp:TemplateField HeaderText="Circle">
                                                        <ItemTemplate>
                                                         ...
                                                         <FooterTemplate>
                                                            <asp:LinkButton ID="lnkCircleF" runat="server" OnClick="lnkCircleF_Click" Text="Total: "></asp:LinkButton>
                                                        </FooterTemplate>
                                                    </asp:TemplateField>
