<%@ Page  Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true" CodeFile="PackageMobilizationReleaseReport.aspx.cs" Inherits="PackageMobilizationReleaseReport" %>
                    ...
                    <div class="page-content">
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <div class="table-header">
                                    Select A Work Package To Mobilization Release Report
                        ...
                        <div id="divEntry" runat="server" visible="false">
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="table-header">
                                        Add Additional Mobilization Release
                                    ...
                                    <div style="overflow: auto">
                                        ...
                                        <table>
                                            <tr>
                                                <td>SR No.</td>
                                                <td>Code</td>
                                                <td>Agreement Amount (In Lakhs)</td>
                                                <td>Advance Type</td>
                                                <td>Percentage(%)</td>
                                                ...
                                                <td>
                                                    <asp:RadioButtonList ID="rbtAdvanceType" runat="server">
                                                        <asp:ListItem Value="M" Selected="True">Mobilization Advance</asp:ListItem>
                                                        <asp:ListItem Value="D">Designe and Drawing</asp:ListItem>
                                                    </asp:RadioButtonList>
                                                </td>
                                                <td>
                                                    <asp:Label runat="server" ID="lblPer"></asp:Label></td>
                                                <td>
                                                    <asp:Label runat="server" ID="lblTotalMobilizationAmount"></asp:Label></td>
                                            </tr>
                                        </table>
                        ...
                        <asp:Panel ID="Panel1" runat="server" CssClass="modalPopup1" Style="display: none; width: 1000px; height: 550px; margin-left: -32px">
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="table-header">
                                        Details Of Mobilization Release Approval History
                                    ...
                                    <div class="col-md-12">
                                        <div style="overflow: auto; height: 450px;">
                                            <asp:GridView ID="grdEMBHistory" runat="server" CssClass="display table table-bordered" AutoGenerateColumns="False" EmptyDataText="No Records Found">
                                                <Columns>
                                                    <asp:BoundField DataField="Package_MobilizationAdvanceApproval_Id" HeaderText="Package_MobilizationAdvanceApproval_Id">
                                                        <HeaderStyle CssClass="displayStyle" />
                                                        <ItemStyle CssClass="displayStyle" />
                                                        <FooterStyle CssClass="displayStyle" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="Package_MobilizationAdvanceApproval_Package_MobilizationAdvance_Id" HeaderText="Package_MobilizationAdvanceApproval_Package_MobilizationAdvance_Id">
                                                        <HeaderStyle CssClass="displayStyle" />
                                                        <ItemStyle CssClass="displayStyle" />
                                                        <FooterStyle CssClass="displayStyle" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="Package_MobilizationAdvanceApproval_Package_Id" HeaderText="Package_MobilizationAdvanceApproval_Package_Id">
                                                        <HeaderStyle CssClass="displayStyle" />
                                                        <ItemStyle CssClass="displayStyle" />
                                                        <FooterStyle CssClass="displayStyle" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="Package_MobilizationAdvanceApproval_Status_Id" HeaderText="Package_MobilizationAdvanceApproval_Status_Id">
                                                        <HeaderStyle CssClass="displayStyle" />
                                                        <ItemStyle CssClass="displayStyle" />
                                                        <FooterStyle CssClass="displayStyle" />
                                                    </asp:BoundField>
                                                    ...
                                                    <asp:BoundField DataField="Package_MobilizationAdvanceApproval_Date" HeaderText="Approval Date" />
                                                    <asp:BoundField DataField="Package_MobilizationAdvanceApproval_Status_Text" HeaderText="Action Taken" />
                                                    <asp:BoundField DataField="Package_MobilizationAdvanceApproval_Comments" HeaderText="Comments" />
                                                    ...
                                                    <asp:BoundField DataField="Package_MobilizationAdvanceApproval_AddedOn" HeaderText="Added On" />
                        ...
                        <asp:HiddenField ID="hf_Package_MobilizationAdvance_Id" runat="server" Value="0" />
                    </div>
                </ContentTemplate>
            </asp:UpdatePanel>
