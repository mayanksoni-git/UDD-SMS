<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true"
    CodeFile="MasterFeildVisitL1.aspx.cs" Inherits="MasterFeildVisitL1" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" ValidateRequest="false" %>
        ...
        <div class="main-content-inner">
            ...
            <asp:UpdatePanel ID="up" runat="server">
                <ContentTemplate>
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <asp:Label ID="Label1" runat="server" Text="Field Visit L1 Name*" CssClass="control-label no-padding-right"></asp:Label>
                                            <asp:TextBox ID="txtFeildVisitL1" runat="server" CssClass="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div style="overflow: auto">
                                            <asp:GridView ID="grdPost" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdPost_PreRender">
                                                <Columns>
                                                    <asp:BoundField DataField="FeildVisitL1_Id" HeaderText="FeildVisitL1_Id">
                                                    ...
                                                    <asp:BoundField DataField="FeildVisitL1_Name" HeaderText="Field Visit L1" />
                    ...
                    <asp:HiddenField ID="hf_FeildVisitL1_Id" runat="server" Value="0" />
                </ContentTemplate>
            </asp:UpdatePanel>
