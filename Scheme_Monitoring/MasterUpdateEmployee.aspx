<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin2.master" AutoEventWireup="true" CodeFile="MasterUpdateEmployee.aspx.cs" Inherits="MasterUpdateEmployee" %>
            ...
            <asp:UpdatePanel ID="up" runat="server">
                <ContentTemplate>
                  <div class="page-content">
                                        ...
                                        <div style="overflow: auto">
                                            <asp:GridView ID="grdPost" runat="server" CssClass="display table table-bordered" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdPost_PreRender">
                                                <Columns>
                                                    ...
                                                    <asp:BoundField HeaderText="Join Date In Service" DataField="HRMSEmployee_JoinDateInService" />
                                                    ...
                                                    <asp:TemplateField HeaderText="Delete">
                                                        <ItemTemplate>
                                                            <asp:ImageButton ID="btnDelete" Width="30px" OnClick="btnDelete_Click1" Height="30px" ImageUrl="~/assets/images/delete.png" runat="server" />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                    ...
                    <asp:HiddenField ID="hf_HRMSEmployee_Id_Id" runat="server" Value="0" />
