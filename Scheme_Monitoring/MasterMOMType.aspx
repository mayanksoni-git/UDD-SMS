<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true"
    CodeFile="MasterMOMType.aspx.cs" Inherits="MasterMOMType" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" ValidateRequest="false" %>
        ...
        <div class="main-content-inner">
            ...
            <asp:UpdatePanel ID="up" runat="server">
                <ContentTemplate>
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div style="overflow: auto">
                                            <asp:GridView ID="grdPost" runat="server" CssClass="display table table-bordered" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdPost_PreRender">
                                                <Columns>
                                                    <asp:BoundField DataField="MOMType_Id" HeaderText="MOMType_Id">
                                                    ...
                                                    <asp:BoundField DataField="MOMType_Name" HeaderText="MOM Type" />
                                                    <%-- <asp:TemplateField HeaderText="MOMType">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtMOMTypeG" Enabled="false" runat="server" CssClass="form-control" Text='<%# Eval("MOMType_Name") %>'></asp:TextBox>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>--%>
                            ...
                            <div class="col-md-12">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <asp:Label ID="lblMOMType" runat="server" Text="MOM Type*" CssClass="control-label no-padding-right"></asp:Label>
                                        <asp:TextBox ID="txtMOMType" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                    ...
                    <asp:HiddenField ID="hf_MOMType_Id" runat="server" Value="0" />
                </ContentTemplate>
            </asp:UpdatePanel>
