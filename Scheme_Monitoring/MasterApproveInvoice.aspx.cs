...
public partial class MasterApproveInvoice : System.Web.UI.Page
{
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        if (Session["UserType"].ToString() == "1")
        {
            ds = (new DataLayer()).get_tbl_ProjectWorkPkg_Invoice(0, Project_Id, 0, Zone_Id, Circle_Id, Division_Id, "", "", 0, 0, 0);
        }
        else
        {
            ds = (new DataLayer()).get_tbl_ProjectWorkPkg_Invoice(0, Project_Id, 0, Zone_Id, Circle_Id, Division_Id, "", "", Convert.ToInt32(Session["Person_BranchOffice_Id"].ToString()), Convert.ToInt32(Session["PersonJuridiction_DesignationId"].ToString()), 0);
        }
        if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
        {
    ...
    protected void btnOpenInvoice_Click(object sender, ImageClickEventArgs e)
    {
        ...
        string PackageInvoice_Type = gr.Cells[20].Text.Trim();
