<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true"
    CodeFile="Report_Pension_Register.aspx.cs" Inherits="Report_Pension_Register" %>
                    ...
                    <div class="page-content">
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <h3 class="header smaller lighter blue">Pension Register</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    &nbsp;&nbsp;&nbsp;
                                    <%--<asp:Button ID="btnGenerate" Text="Generate Salary" runat="server" CssClass="btn btn-danger" OnClick="btnGenerate_Click"></asp:Button>--%>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        <div class="table-header">
                                            Zone / Circle / Division Wise Pension Details
                                        </div>
                                        ...
                                        <div style="overflow: auto">
                                            <asp:GridView ID="grdPost" runat="server" CssClass="table table-striped table-bordered table-hover"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField HeaderText="Total Pensioners" DataField="Total_Employees" />
                                                    <asp:BoundField HeaderText="Total Pensioners Verified" DataField="Total_Employees_Verified" />
