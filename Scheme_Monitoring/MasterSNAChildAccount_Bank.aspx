<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true" CodeFile="MasterSNAChildAccount_Bank.aspx.cs" Inherits="MasterSNAChildAccount_Bank" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" ValidateRequest="false" %>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <div style="overflow: auto">
                                    <asp:GridView ID="grdPost" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-hover" EmptyDataText="No Records Found" OnPreRender="grdPost_PreRender" ShowFooter="true">
                                        <Columns>
                                            ...
                                            <%--<asp:TemplateField HeaderText="View Actual Balance (In Lakhs)">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkBalance" runat="server" OnClick="lnkBalance_Click">View Live Balance</asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>--%>
                                        </Columns>
