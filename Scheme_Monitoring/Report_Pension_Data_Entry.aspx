<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true"
    CodeFile="Report_Pension_Data_Entry.aspx.cs" Inherits="Report_Pension_Data_Entry" %>
                    ...
                    <div class="page-content">
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <h3 class="header smaller lighter blue">Pensioners Data Entry Status</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        <div class="table-header">
                                            Zone / Circle / Division Wise Pensioners Data Entry Status
                                        </div>
                                        ...
                                        <div style="overflow: auto">
                                            <asp:GridView ID="grdPost" runat="server" CssClass="table table-striped table-bordered table-hover"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField HeaderText="Total Pensioners" DataField="Total_Pensoners" />
