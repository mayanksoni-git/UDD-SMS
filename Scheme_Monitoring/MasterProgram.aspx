<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true"
    CodeFile="MasterProgram.aspx.cs" Inherits="MasterProgram" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" ValidateRequest="false" %>
...
<%--                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <asp:Label ID="lblProgram" runat="server" Text="Program*" CssClass="control-label no-padding-right"></asp:Label>
                    ...
                    <asp:HiddenField ID="hf_Program_Id" runat="server" Value="0" />
