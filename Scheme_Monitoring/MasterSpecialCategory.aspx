<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin2.master" AutoEventWireup="true" CodeFile="MasterSpecialCategory.aspx.cs" Inherits="MasterSpecialCategory" %>
        ...
        <div class="main-content-inner">
            ...
            <asp:UpdatePanel ID="up" runat="server">
                <ContentTemplate>
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div style="overflow: auto">
                                            <asp:GridView ID="grdPost" runat="server" CssClass="display table table-bordered" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdPost_PreRender">
                                                <Columns>
                                                    <asp:BoundField DataField="SpecialCategory_Id" HeaderText="SpecialCategory_ID">
                                                    ...
                                                    <asp:BoundField DataField="SpecialCategory_Name" HeaderText="SpecialCategory Name" />
                            ...
                            <div class="col-md-12">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <asp:Label ID="lblSpecialCategory" runat="server" Text="Special Category*" CssClass="control-label no-padding-right"></asp:Label>
                                        <asp:TextBox ID="txtSpecialCategory" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                    ...
                    <asp:HiddenField ID="hf_SpecialCategory_Id" runat="server" Value="0" />
