...
public partial class MasterUpdateEmployee : System.Web.UI.Page
{
    ...
    protected void btnEdit_Click(object sender, ImageClickEventArgs e)
    {
        GridViewRow gr = (sender as ImageButton).Parent.Parent as GridViewRow;
        int HRMSEmployee_Id = Convert.ToInt32(gr.Cells[0].Text.Trim());
        Response.Redirect("MasterHRMS.aspx?HRMSEmployee_Id=" + HRMSEmployee_Id.ToString());
    ...
    protected void btnDelete_Click1(object sender, ImageClickEventArgs e)
    {
        ...
        int HRMSEmployee_Id = Convert.ToInt32(gr.Cells[0].Text.Trim());
        if (new DataLayer().Delete_HRMSEmployee(HRMSEmployee_Id, Person_Id))
        {
            int Zone_Id = 0;
            int Circle_Id = 0;
            int Division_Id = 0;
