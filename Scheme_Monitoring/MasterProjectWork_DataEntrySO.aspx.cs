...
public partial class MasterProjectWork_DataEntrySO : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        string Msg = "";
        if ((new DataLayer()).Insert_tbl_ProjectWork_Data_Entry(obj_tbl_ProjectWork, obj_tbl_ProjectWorkGO_Li, obj_tbl_ProjectWorkFundingPattern_Li, null, physicalTarget, obj_tbl_ProjectWorkPkg_Li, Client, null, null, null, null, extGO, ref Msg))
        {
            if (Msg == "")
            {
