...
public partial class CreateDocForVisionPlan : System.Web.UI.Page
{
    ...
    protected void btnsave_Click(object sender, EventArgs e)
    {
        ...
        dt = objLoan.GetDocOfAnnualActionPlan(  "Insert",     division,   0,  zone,circle,  fy, Person_Id, pathProfile, "VisionPlan", "-1", 0, "1900-01-01", "9999-12-31");
    ...
    protected void Edit_Command(int?id)
    {
       ...
       // objLoan.GetAnnualActionPlan("select", ULBID, 0, 0, 0, 0, 0, "", 0, "", 0, "", "", "", "");
        dt = objLoan.GetDocOfAnnualActionPlan("selectById", 0, id, 0, 0, 0,  0,  "", "VisionPlan", "-1", 0, "1900-01-01", "9999-12-31");
    ...
    protected void BtnUpdate_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string text = clickedButton.Text;
            DataTable dt = new DataTable();
            dt = objLoan.GetDocOfAnnualActionPlan("Update", division, taskid, zone, circle, fy, Person_Id, pathProfile, "VisionPlan", "-1", 0, "1900-01-01", "9999-12-31");
