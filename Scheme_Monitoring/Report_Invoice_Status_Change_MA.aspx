<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true"
    CodeFile="Report_Invoice_Status_Change_MA.aspx.cs" Inherits="Report_Invoice_Status_Change_MA" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" ValidateRequest="false" %>
                    ...
                    <div class="page-content">
                        ...
                        <div runat="server" visible="false" id="divData">
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="table-header">
                                        Details Of Mobilization Advance / Designe and Drawing Payments Invoices
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div style="overflow: auto">
                                            <asp:GridView ID="grdInvoice" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdInvoice_PreRender" OnRowDataBound="grdInvoice_RowDataBound">
                                                ...
                                                <asp:BoundField DataField="Package_MobilizationAdvance_TotalAmount" HeaderText="ADP Amount" />
