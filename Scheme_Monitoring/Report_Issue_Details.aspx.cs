...
public partial class Report_Issue_Details : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            get_tbl_ProjectIssue(Convert.ToInt32(ddlSearchScheme.SelectedValue));
    ...
    private void get_tbl_ProjectIssue(int Scheme_Id)
    {
        ...
        {
            AllClasses.FillDropDown(ds.Tables[0], ddlIssueType, "ProjectIssue_Name", "ProjectIssue_Id");
        }
        else
        {
    ...
    private void get_Zone_Wise_Program_Details()
    {
        ...
        try
        {
            Issue_Id = Convert.ToInt32(ddlIssueType.SelectedValue);
        }
        catch
        {
            Issue_Id = 0;
        ...
        else
        {
            ...
            TillDtae = txtDateTill.Text.Trim();
        }
        DataSet ds = new DataSet();
        ds = (new DataLayer()).get_Issue_Data(Project_Id.ToString(), Zone_Id, Circle_Id, Division_Id, FromDate, TillDtae, chkShowOnlyResolved.Checked, chkExcludeResolved.Checked, Issue_Id);
