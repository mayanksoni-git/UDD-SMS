<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true" CodeFile="MasterProjectWorkSNALimitUpdate.aspx.cs" Inherits="MasterProjectWorkSNALimitUpdate" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" ValidateRequest="false" %>
                    ...
                    <div class="page-content">
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <h3 class="header smaller lighter blue">Project List To Assign Monthly Limit (Update)
                                                                ...
                                                                <table class="display table table-bordered no-margin-bottom no-border-top">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            <td>Update Limit</td>
                                                                            <td>
                                                                                <asp:TextBox ID="txtLimit" runat="server" CssClass="form-control" Width="120px" Text='<%# Eval("SNAAccountLimit_Last") %>'></asp:TextBox></td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                            </ItemTemplate>
