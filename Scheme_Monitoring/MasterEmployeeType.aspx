<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin2.master" AutoEventWireup="true" CodeFile="MasterEmployeeType.aspx.cs" Inherits="MasterEmployeeType" %>
        ...
        <div class="main-content-inner">
            ...
            <asp:UpdatePanel ID="up" runat="server">
                <ContentTemplate>
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div style="overflow: auto">
                                            <asp:GridView ID="grdPost" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdPost_PreRender">
                                                <Columns>
                                                    <asp:BoundField DataField="EmployeeType_Id" HeaderText="EmployeeType_ID">
                                                    ...
                                                    <asp:BoundField DataField="EmployeeType_Name" HeaderText="Employee Type" />
                            ...
                            <div class="col-md-12">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <asp:Label ID="lblEmployeeType" runat="server" Text="Employee Type*" CssClass="control-label no-padding-right"></asp:Label>
                            ...
                            <div class="col-md-12">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        &nbsp; &nbsp; &nbsp;
                                             <asp:Button ID="btnDelete" runat="server" OnClick="btnDelete_Click1" Text="Delete" CssClass="btn btn-warning"></asp:Button>&nbsp; &nbsp; &nbsp;
                    ...
                    <asp:HiddenField ID="hf_EmployeeType_Id" runat="server" Value="0" />
