                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        <div class="table-header">
                                            Project Wise Invoice Status Analysis Report
                                        </div>
                                            ...
                                            <asp:GridView ID="grdPost" runat="server" CssClass="display table table-bordered" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdPost_PreRender" ShowFooter="true" OnRowDataBound="grdPost_RowDataBound">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Select">
                                                        ...
                                                        <FooterTemplate>
                                                            <asp:LinkButton ID="lnkAllData" runat="server" Font-Bold="true" Text="All Projects" OnClick="lnkAllData_Click" ForeColor="White"></asp:LinkButton>
                                                        </FooterTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:BoundField DataField="Total_Invoice" HeaderText="Total Invoice Raised" />
