...
public partial class dashboard_cnds1 : System.Web.UI.Page
{    
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            get_CM_Dashboard_CNDS_1();
        }
    }
    
    private void get_CM_Dashboard_CNDS_1()
    {
        DataSet ds = new DataSet();
        ds = (new DataLayer()).get_CM_Dashboard_CNDS_1();
