<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/TemplateMasterAdmin_PMS.master" CodeFile="CreateDocForAnnualActionPlan.aspx.cs" Inherits="CreateDocForAnnualActionPlan" %>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0" id="head1" runat="server">Upload Documents for Annual Action Plan</h4>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header align-items-center d-flex">
                                        <h4 class="card-title mb-0 flex-grow-1" id="head2" runat="server">Upload Document For Annual Action Plan
                                            <label id="message" runat="server" style="float: right; color: red; font-weight: bold"></label>
                                        </h4>
                                        <a href="UploadDocForAnnualActionPlan.aspx" class="filter-btn" style="float: right"><i class="icon-download"></i>Documents List</a>
                                    </div>
                                    <!-- end card header -->
                                    <div class="card-body">
                                            ...
                                            <div class="row gy-4">
                                                ...
                                                <div class="col-xxl-3 col-md-6">
                                                    <div id="div1" runat="server">
                                                        <asp:Label ID="lblApprovedAAP" runat="server" Text="Have you uploaded the committee-approved Annual Action Plan?*" CssClass="form-label"></asp:Label>
                                                        <asp:RadioButtonList ID="rblApprovedAAP" CssClass="form-control" runat="server" RepeatDirection="Horizontal">
