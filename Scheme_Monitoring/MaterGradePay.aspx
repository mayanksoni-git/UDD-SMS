<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin2.master" AutoEventWireup="true" CodeFile="MaterGradePay.aspx.cs" Inherits="MaterGradePay" %>
        ...
        <div class="main-content-inner">
            ...
            <asp:UpdatePanel ID="up" runat="server">
                <ContentTemplate>
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div style="overflow: auto">
                                            <asp:GridView ID="grdPost" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdPost_PreRender">
                                                <Columns>
                                                    <asp:BoundField DataField="GradePay_Id" HeaderText="GradePay_ID">
                                                        <HeaderStyle CssClass="displayStyle" />
                                                        <ItemStyle CssClass="displayStyle" />
                                                        <FooterStyle CssClass="displayStyle" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="GradePay_PayScaleId" HeaderText="GradePay_PayScaleId">
                                                        <HeaderStyle CssClass="displayStyle" />
                                                        <ItemStyle CssClass="displayStyle" />
                                                        <FooterStyle CssClass="displayStyle" />
                                                    </asp:BoundField>
                                                    ...
                                                    <asp:BoundField DataField="GradePay_Value" HeaderText="Grade Pay" />
                            ...
                            <div class="col-md-12">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <asp:Label ID="lblPayScale" runat="server" Text="Pay Scale*" CssClass="control-label no-padding-right"></asp:Label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <asp:Label ID="lblGradePay" runat="server" Text="Grade Pay*" CssClass="control-label no-padding-right"></asp:Label>
                    ...
                    <asp:HiddenField ID="hf_GradePay_Id" runat="server" Value="0" />
