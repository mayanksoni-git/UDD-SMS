                ...
                <ContentTemplate>
                    ...
                    <div class="page-content">
                                    ...
                                    <div class="tab-content">
                                        <div id="doc11" class="tab-pane fade active in">
                                            <div style="overflow: auto">
                                                <asp:GridView ID="grdSummery" runat="server" AutoGenerateColumns="False" CssClass="display table table-bordered" EmptyDataText="No Records Found" OnPreRender="grdSummery_PreRender" ShowFooter="true">
                                                    <Columns>
                                        ...
                                        <div id="doc22" class="tab-pane fade">
                                            ...
                                            <div style="overflow: auto">
                                                <asp:GridView ID="grdSummeryADP" runat="server" AutoGenerateColumns="False" CssClass="display table table-bordered" EmptyDataText="No Records Found" OnPreRender="grdSummeryADP_PreRender" ShowFooter="true">
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="S No.">
                                                            <ItemTemplate>
                                                                <%# Container.DataItemIndex + 1 %>
                                        ...
                                        <div id="doc33" class="tab-pane fade">
                                            <!-- div.dataTables_borderWrap -->
                                            <div style="overflow: auto">
                                                <asp:GridView ID="grdSummeryMA" runat="server" AutoGenerateColumns="False" CssClass="display table table-bordered" EmptyDataText="No Records Found" OnPreRender="grdSummeryMA_PreRender" ShowFooter="true">
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="S No.">
                                                            <ItemTemplate>
                                                                <%# Container.DataItemIndex + 1 %>
                                        ...
                                        <div id="doc44" class="tab-pane fade">
                                            <!-- div.dataTables_borderWrap -->
                                            <div style="overflow: auto">
                                                <asp:GridView ID="grdSummeryDR" runat="server" AutoGenerateColumns="False" CssClass="display table table-bordered" EmptyDataText="No Records Found" OnPreRender="grdSummeryDR_PreRender" ShowFooter="true">
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="S No.">
                                                            <ItemTemplate>
                                                                <%# Container.DataItemIndex + 1 %>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="col-md-12">
                                    ...
                                    <div style="overflow: auto">
                                        <asp:GridView ID="grdInvoiceDashV" runat="server" AutoGenerateColumns="False" CssClass="display table table-bordered" OnPreRender="grdInvoiceDashV_PreRender" EmptyDataText="No Records Found" OnRowDataBound="grdInvoiceDashV_RowDataBound">
                                            <Columns>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="col-md-12">
                                    ...
                                    <div style="overflow: auto">
                                        <asp:GridView ID="grdADPV" runat="server" CssClass="display table table-bordered" AutoGenerateColumns="False" OnPreRender="grdADPV_PreRender" EmptyDataText="No Records Found" OnRowDataBound="grdADPV_RowDataBound">
                                            <Columns>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="col-md-12">
                                    ...
                                    <div style="overflow: auto">
                                        <asp:GridView ID="grdMAV" runat="server" CssClass="display table table-bordered" AutoGenerateColumns="False" OnPreRender="grdMAV_PreRender" EmptyDataText="No Records Found" OnRowDataBound="grdMAV_RowDataBound">
                                            <Columns>
                                                <asp:BoundField DataField="ProjectWorkPkg_Id" HeaderText="ProjectWorkPkg_Id">
                                                    <HeaderStyle CssClass="displayStyle" />
                                                    <ItemStyle CssClass="displayStyle" />
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="col-md-12">
                                    ...
                                    <div style="overflow: auto">
                                        <asp:GridView ID="grdDRV" runat="server" CssClass="display table table-bordered" AutoGenerateColumns="False" OnPreRender="grdDRV_PreRender" EmptyDataText="No Records Found" OnRowDataBound="grdDRV_RowDataBound">
                                            <Columns>
                                                <asp:BoundField DataField="ProjectWorkPkg_Id" HeaderText="ProjectWorkPkg_Id">
                                                    <HeaderStyle CssClass="displayStyle" />
                                                    <ItemStyle CssClass="displayStyle" />
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="col-md-12">
                                    <asp:GridView ID="grdAnnextureDtls" runat="server" AutoGenerateColumns="False" CssClass="display table table-bordered" EmptyDataText="No Records Found" OnPreRender="grdAnnextureDtls_PreRender">
                                        <Columns>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="col-md-12">
                                    ...
                                    <div style="overflow: auto">
                                        <asp:GridView ID="grdDataUpdationStatusReport" runat="server" AutoGenerateColumns="False" CssClass="display table table-bordered" EmptyDataText="No Records Found" OnPreRender="grdDataUpdationStatusReport_PreRender" ShowFooter="true">
                                            <Columns>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="col-md-12">
                                        ...
                                        <asp:GridView ID="grdPkgView" runat="server" AutoGenerateColumns="False" CssClass="display table table-bordered" EmptyDataText="No Records Found" OnPreRender="grdPkgView_PreRender" OnRowDataBound="grdPkgView_RowDataBound">
                                            <Columns>
                                                <asp:BoundField DataField="ProjectWorkPkg_Id" HeaderText="ProjectWorkPkg_Id">
                                                    <HeaderStyle CssClass="displayStyle" />
                                                    <ItemStyle CssClass="displayStyle" />
                        ...
                        <asp:Panel ID="Panel2" runat="server" CssClass="modalPopup1" Style="display: none; width: 400px; height: 550px; margin-left: -32px">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="col-md-12">
                                        <asp:GridView ID="grdExpertWiseDtls" runat="server" AutoGenerateColumns="False" CssClass="display table table-bordered" EmptyDataText="No Records Found" OnPreRender="grdExpertWiseDtls_PreRender" OnRowDataBound="grdExpertWiseDtls_RowDataBound" ShowFooter="true">
                                            <Columns>
