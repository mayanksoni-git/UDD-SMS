<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin2.master" AutoEventWireup="true" CodeFile="MasterBasic_Pension_Rate.aspx.cs" Inherits="MasterBasic_Pension_Rate" %>
        ...
        <div class="main-content-inner">
            ...
            <asp:UpdatePanel ID="up" runat="server">
                <ContentTemplate>
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div style="overflow: auto">
                                            <asp:GridView ID="grdPost" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdPost_PreRender">
                                                <Columns>
                                                    <asp:BoundField DataField="Basic_Pension_Rate_Id" HeaderText="Basic_Pension_Rate_ID">
                                                    ...
                                                    <asp:BoundField DataField="Basic_Pension_Rate" HeaderText="Basic Pension Rate" />
                                                    <asp:BoundField DataField="Basic_Pension_Rate_EffectiveBy" HeaderText="Effective By" />
                            ...
                            <div class="col-sm-12">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <asp:Label ID="lblBasicPensionRate" runat="server" Text="Basic Pension Rate*" CssClass="control-label no-padding-right"></asp:Label>
                                        <asp:TextBox ID="txtBasicPensionRate" runat="server" CssClass="form-control" autocomplete="off" onkeyup="isNumericVal(this);"></asp:TextBox>
                                    </div>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:Label ID="lblEffectiveBy" runat="server" Text="Effective By*" CssClass="control-label no-padding-right"></asp:Label>
                                        <asp:TextBox ID="txtEffectiveBy" runat="server" CssClass="form-control date-picker" autocomplete="off" data-date-format="dd/mm/yyyy"></asp:TextBox>
                                    </div>
                                </div>
                    ...
                    <asp:HiddenField ID="hf_Basic_Pension_Rate_Id" runat="server" Value="0" />
