                        ...
                        <div id="divCreate" runat="server">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <asp:Label ID="Label2" runat="server" Text="Sanctioned Cost (In Lakhs)*" CssClass="control-label no-padding-right"></asp:Label>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <asp:Label ID="Label4" runat="server" Text="Date Of Completion As Per Agreement" CssClass="control-label no-padding-right"></asp:Label>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="col-md-3" style="display: none">
                                        <div class="form-group">
                                            <label class="control-label no-padding-right">Financial Progress (In Lakhs) * </label>
                                            <asp:TextBox ID="TextBox1" runat="server" CssClass="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-3" style="display: none">
                                        <div class="form-group">
                                            <asp:Label ID="Label5" runat="server" Text="Total Released Amount Till Date (In Lakhs)*" CssClass="control-label no-padding-right"></asp:Label>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-3" style="display: none">
                                        <div class="form-group">
                                            <asp:Label ID="Label7" runat="server" Text="Agreement No*" CssClass="control-label no-padding-right"></asp:Label>
