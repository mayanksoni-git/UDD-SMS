<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true" CodeFile="ViewEMBDetails_New.aspx.cs" Inherits="ViewEMBDetails_New" %>
                                                            ...
                                                            <asp:GridView ID="grdEMBItems" runat="server" CssClass="display table table-bordered" AutoGenerateColumns="False" ShowHeader="true" OnPreRender="grdEMBItems_PreRender" >
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Unit">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="txtQty" runat="server" CssClass="control-label no-padding-right" Text='<%# Eval("Unit_Name") %>' Width="50px" Enabled="false"></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Quantity executed up to date as per MB">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="txtQty" runat="server" CssClass="control-label no-padding-right" Text='<%# Eval("PackageEMB_Qty_UpToDate") %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="Percentage Amount To Be Released">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="txtPercentageToBeReleased" runat="server" CssClass="control-label no-padding-right"  Text='<%# Eval("PackageEMB_PercentageToBeReleased") %>' ></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
