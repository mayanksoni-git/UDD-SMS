<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true"
    CodeFile="Report_Collection_Division.aspx.cs" Inherits="Report_Collection_Division" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" ValidateRequest="false" %>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header align-items-center d-flex">
                                        <h4 class="card-title mb-0 flex-grow-1" runat="server" id="lblScheme">----NA-----</h4>
                                    </div>
                                    <!-- end card header -->
                                    <div class="card-body">
                                                        ...
                                                        <asp:GridView ID="grdPost" runat="server" CssClass="display table table-bordered" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdPost_PreRender" ShowFooter="true" OnRowDataBound="grdPost_RowDataBound">
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Division">
                                                                    <ItemTemplate>
                                                                        <asp:LinkButton ID="lnkDivision" runat="server" Text='<%# Eval("Division_Name") %>' OnClick="lnkDivision_Click"></asp:LinkButton>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
