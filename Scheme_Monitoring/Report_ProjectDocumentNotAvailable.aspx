<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true" CodeFile="Report_ProjectDocumentNotAvailable.aspx.cs" Inherits="Report_ProjectDocumentNotAvailable" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" ValidateRequest="false" %>
                    ...
                    <div class="page-content">
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <h3 class="header smaller lighter blue">Document Not Available Report
                                        ...
                                        <div style="overflow: auto">
                                            <asp:GridView ID="grdPost" runat="server" CssClass="display table table-bordered" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdPost_PreRender" OnRowDataBound="grdPost_RowDataBound">
                                                <Columns>
                                                    ...
                                                    <asp:BoundField HeaderText="Total Packages" DataField="Total_Package" />
                                                    <asp:BoundField HeaderText="First GO" DataField="GO_1" />
                                                    <asp:BoundField HeaderText="Second GO" DataField="GO_2" />
                                                    <asp:BoundField HeaderText="Third GO" DataField="GO_3" />
                                                    <asp:BoundField HeaderText="Contract Bond" DataField="Agreement" />
                                                    <asp:BoundField HeaderText="Letter Of Intent" DataField="LOI" />
                                                    <asp:BoundField HeaderText="Contract Bond Front Page" DataField="CB_Front" />
                                                    <asp:BoundField HeaderText="Contract Bond Schedule G" DataField="Schedule_G" />
                                                    <asp:BoundField HeaderText="Agreement With Stamp" DataField="CB_Stamp" />
                                                    <asp:BoundField HeaderText="Bank Guarantee" DataField="BG" />
                                                    <asp:BoundField HeaderText="Performance Security" DataField="PS" />
                                                    <asp:BoundField HeaderText="Moblization Advance" DataField="MA" />
                                                    <asp:BoundField HeaderText="LD" DataField="LD" />
                                                    <asp:BoundField HeaderText="Time Extention" DataField="TE" />
                                                    <asp:BoundField HeaderText="Financial Closure" DataField="FC" />
                                                    <asp:BoundField HeaderText="Variation" DataField="Variation" />
                                                </Columns>
                                            </asp:GridView>
                                        </div>
                                    </div>
