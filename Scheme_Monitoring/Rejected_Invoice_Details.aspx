<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true"
    CodeFile="Rejected_Invoice_Details.aspx.cs" Inherits="Rejected_Invoice_Details" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" ValidateRequest="false" %>
                                        ...
                                        <asp:GridView ID="grdInvoice" runat="server" AutoGenerateColumns="False" CssClass="display table table-bordered" EmptyDataText="No Records Found" OnPreRender="grdInvoice_PreRender" OnRowDataBound="grdInvoice_RowDataBound">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Action">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="btnEdit" runat="server" Height="20px" ImageUrl="~/assets/images/edit.png" OnClick="btnEdit_Click" Width="20px" />
                                                        <br />
                                                                ...
                                                                <asp:GridView ID="grdDocumentMaster" runat="server" CssClass="display table table-bordered" AutoGenerateColumns="False" EmptyDataText="No Documents Configured To Upload" OnPreRender="grdDocumentMaster_PreRender" OnRowDataBound="grdDocumentMaster_RowDataBound">
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Order No">
                                                                            <ItemTemplate>
                                                                                <asp:TextBox ID="txtDocumentOrderNo" runat="server" CssClass="form-control" Text='<%# Eval("PackageInvoiceDocs_OrderNo") %>'></asp:TextBox>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Comments">
                                                                            <ItemTemplate>
                                                                                <asp:TextBox ID="txtDocumentComments" runat="server" CssClass="form-control" TextMode="MultiLine" Text='<%# Eval("PackageInvoiceDocs_Comments") %>'></asp:TextBox>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
