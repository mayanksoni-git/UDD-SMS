<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true" CodeFile="Report_Shadow_EMB_Analysis.aspx.cs" Inherits="Report_Shadow_EMB_Analysis" %>
                                ...
                                <div class="row">
                                    <div class="col-xs-6 col-sm-3 pricing-box">
                                        <div class="widget-box widget-color-dark">
                                            <div class="widget-header">
                                                <h5 class="widget-title bigger lighter">Total Shadow MB Generated</h5>
                                            </div>
                                                            ...
                                                            <div class="infobox infobox-blue">
                                                                ...
                                                                <div class="infobox-data">
                                                                    <span class="infobox-data-number" style="margin-left: 15px;">
                                                                        <asp:LinkButton ID="lnkShadowEMB" runat="server"></asp:LinkButton></span>
                                                                </div>
                                                            </div>
                                                        </li>
                                                    </ul>
                                    ...
                                    <div class="col-xs-6 col-sm-3 pricing-box">
                                        <div class="widget-box widget-color-blue">
                                            <div class="widget-header">
                                                <h5 class="widget-title bigger lighter">Converted To EMB</h5>
                                            </div>
                                                    ...
                                                    <ul class="list-unstyled spaced2">
                                                        <li>
                                                            <div class="infobox infobox-blue">
                                                                ...
                                                                <div class="infobox-data">
                                                                    <span class="infobox-data-number" style="margin-left: 15px;">
                                                                        <asp:LinkButton ID="lnkEMB" runat="server"></asp:LinkButton></span>
                                                                </div>
                                                            </div>
                                                        </li>
                                                    </ul>
                                    ...
                                    <div class="col-xs-6 col-sm-3 pricing-box">
                                        <div class="widget-box widget-color-green">
                                            <div class="widget-header">
                                                <h5 class="widget-title bigger lighter">Converted To invoice 
                                                </h5>
                                            </div>
                                            <div class="widget-body">
                                                <div class="widget-main">
                                                    <ul class="list-unstyled spaced2">
                                                        <li>
                                                            <div class="infobox infobox-blue">
                                                                ...
                                                                <div class="infobox-data">
                                                                    <span class="infobox-data-number" style="margin-left: 15px;">
                                                                        <asp:LinkButton ID="lnkInvoice" runat="server"></asp:LinkButton></span>
                                                                </div>
                                                            </div>
                                                        </li>
                                                    </ul>
                                    ...
                                    <div class="col-xs-6 col-sm-3 pricing-box">
                                        <div class="widget-box widget-color-red">
                                            <div class="widget-header">
                                                <h5 class="widget-title bigger lighter">Payment Done 
                                                </h5>
                                            </div>
                                                    ...
                                                    <ul class="list-unstyled spaced2">
                                                        <li>
                                                            <div class="infobox infobox-blue">
                                                                ...
                                                                <div class="infobox-data">
                                                                    <span class="infobox-data-number" style="margin-left: 15px;">
                                                                        <asp:LinkButton ID="lnkPaymentDone" runat="server"></asp:LinkButton></span>
                                                                </div>
                                                            </div>
                                                        </li>
                                                    </ul>
                                        ...
                                        <div style="overflow: auto">
                                            <asp:GridView ID="grdPost" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdPost_PreRender" OnRowDataBound="grdPost_RowDataBound">
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="ProjectWorkPkg_Name" HeaderText="Package Name" />
                                                    <asp:BoundField DataField="PackageEMB_Master_Date_Shadow" HeaderText="Shadow EMB Generated On" />
                                                    <asp:BoundField DataField="Total_Amount_Shadow" HeaderText="Amout Of Sahdow EMB" />
                                                    <asp:BoundField DataField="PackageEMB_Master_Date" HeaderText="EMB Generated On" />
                                                    <asp:BoundField DataField="Date_Diff_Action_Shadow" HeaderText="Time Diff Shadow EMB To EMB" />
                                                    <asp:BoundField DataField="InvoiceStatus_Name_Shadow" HeaderText="Shadow EMB Status" />
                                                    <asp:BoundField DataField="PackageEMB_Master_RA_BillNo" HeaderText="RA Bill No" />
                                                    <asp:BoundField DataField="Total_Amount" HeaderText="Amount" />
                                                    <asp:BoundField DataField="Invoice_Status1" HeaderText="Invoicing Status" />
                                                    <asp:BoundField DataField="Designation_DesignationNameI" HeaderText="Invoice Pending At Designation" />
                                                    <asp:BoundField DataField="PackageInvoiceApproval_Date" HeaderText="invoice Approval Date" />
