<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin2.master" AutoEventWireup="true" CodeFile="Master_Inventory_Type.aspx.cs" Inherits="Master_Inventory_Type" %>
        ...
        <div class="main-content-inner">
            ...
            <asp:UpdatePanel ID="up" runat="server">
                <ContentTemplate>
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div style="overflow: auto">
                                            <asp:GridView ID="grdPost" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdPost_PreRender">
                                                <Columns>
                                                    <asp:BoundField DataField="Inventory_Type_Id" HeaderText="Inventory_Type_ID">
                                                    ...
                                                    <asp:BoundField DataField="Inventory_Type_Name" HeaderText="Pay Band" />
                            ...
                            <div class="col-md-12">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <asp:Label ID="lblInventory_Type" runat="server" Text="Inventory Type" CssClass="control-label no-padding-right"></asp:Label>
                                        <asp:TextBox ID="txtInventory_Type" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                    ...
                    <asp:HiddenField ID="hf_Inventory_Type_Id" runat="server" Value="0" />
