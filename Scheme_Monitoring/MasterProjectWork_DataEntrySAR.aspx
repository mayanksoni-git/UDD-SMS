<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true" CodeFile="MasterProjectWork_DataEntrySAR.aspx.cs" Inherits="MasterProjectWork_DataEntrySAR" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" ValidateRequest="false" %>
                        ...
                        <div id="divCreate" runat="server">
                                ...
                                <div class="col-sm-12">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="control-label no-padding-right">Executing Agency* </label>
                                            <asp:DropDownList ID="ddlNodalDepartment" runat="server" class="form-control"></asp:DropDownList>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="control-label no-padding-right">Total Released Amount Till Date (In Lakhs)*</label>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="table-header">
                                        Present Status and Desirable Goal of Rejuvenation:-     
                                        <div style="float: right">
                                            <span class="label label-danger arrowed">Upload Arial Survey Report, Bethemetric Report, any other report etc..</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div style="overflow: auto">
                                                <asp:GridView ID="grdPhysicalProgress" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnRowDataBound="grdPhysicalProgress_RowDataBound">
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Proposed As Per Origional">
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Proposed As Per Actual">
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Upload Report*">
                                                            <ItemTemplate>
                                                                <asp:FileUpload ID="flUploadReport" runat="server" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                                                </asp:GridView>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <div style="overflow: auto">
                                                <asp:GridView ID="grdBaseLineData" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnRowDataBound="grdBaseLineData_RowDataBound">
                                                    <Columns>
                                                        <asp:BoundField DataField="PhysicalBaseLineData_Id" HeaderText="PhysicalBaseLineData_Id">
                                                            <HeaderStyle CssClass="displayStyle" />
                                                            <ItemStyle CssClass="displayStyle" />
                                                            <FooterStyle CssClass="displayStyle" />
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="ProjectPkg_PhysicalBaseLineData_Id" HeaderText="ProjectPkg_PhysicalBaseLineData_Id">
                                                            <HeaderStyle CssClass="displayStyle" />
                                                            <ItemStyle CssClass="displayStyle" />
                                                            <FooterStyle CssClass="displayStyle" />
                                                        </asp:BoundField>
                                                        ...
                                                        <asp:TemplateField HeaderText="Select">
                                                            <HeaderTemplate>
                                                                <asp:CheckBox ID="chkSelectAllH" runat="server" Text="Select" AutoPostBack="True" OnCheckedChanged="chkSelectAllH_CheckedChanged" />
                                                            </HeaderTemplate>
                                                            <ItemTemplate>
                                                                <asp:CheckBox ID="chkPostBaseLineData" runat="server" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:BoundField DataField="PhysicalBaseLineData_Component" HeaderText="Base Line Data" />
                                                        <asp:BoundField DataField="Unit_Name" HeaderText="Unit" />
                                                        <asp:TemplateField HeaderText="Value">
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtProgressNumber" runat="server" CssClass="form-control" onkeyup="isNumericVal(this);"></asp:TextBox>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
