<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true" CodeFile="MasterDivisionSchemeLink.aspx.cs" Inherits="MasterDivisionSchemeLink" %>
                    ...
                    <div class="page-content">
                            ...
                            <div class="col-sm-12">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <asp:Label ID="Label2" runat="server" Text="Division*" CssClass="control-label no-padding-right"></asp:Label>
                                        <asp:DropDownList ID="ddlDivision" runat="server" class="chosen-select form-control" data-placeholder="Choose a Product..." AutoPostBack="true" OnSelectedIndexChanged="ddlDivision_SelectedIndexChanged"></asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <h3 class="header smaller lighter blue">Division Scheme Linking</h3>
                                        <div class="clearfix" id="dtOptions" runat="server">
                                            
                                            <div class="pull-right tableTools-container"></div>
                                        </div>
                                        <div style="overflow: auto">
                                            <asp:GridView ID="grdDivision" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="false" OnRowDataBound="grdDivision_RowDataBound" EmptyDataText="No Records Found" OnPreRender="grdDivision_PreRender">
                                                <Columns>
