...
public partial class PackageDeductionReleaseApproval : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            {
                int Scheme_Id = 0;
                int _Package_DeductionRelease_Id = 0;
                try
                {
                    _Package_DeductionRelease_Id = Convert.ToInt32(Request.QueryString["Package_DeductionRelease_Id"].ToString().Trim());
                }
                catch
                {
                    _Package_DeductionRelease_Id = 0;
                }
                try
                {
                ...
                if (_Package_DeductionRelease_Id > 0)
                {
                    ...
                    for (int i = 0; i < grdPost.Rows.Count; i++)
                    {
                        ...
                        try
                        {
                            Package_DeductionRelease_Id = Convert.ToInt32(grdPost.Rows[i].Cells[3].Text.Trim());
                        }
                        catch
                        {
                            Package_DeductionRelease_Id = 0;
                        }
                        if (_Package_DeductionRelease_Id == Package_DeductionRelease_Id)
                        {
    ...
    protected void btnEdit_Click(object sender, ImageClickEventArgs e)
    {
        ...
        hf_Package_DeductionRelease_Id.Value = gr.Cells[3].Text.Trim();
        ...
        get_tbl_Package_DeductionRelease_Item();
    ...
    private void get_tbl_Package_DeductionRelease_Item()
    {
        DataSet ds = new DataSet();
        ds = (new DataLayer()).get_tbl_Package_DeductionRelease_Item(Convert.ToInt32(hf_Package_DeductionRelease_Id.Value));
        if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
        {
            grdDeductions.DataSource = ds.Tables[0];
            grdDeductions.DataBind();
            grdDeductions.FooterRow.Cells[5].Text = ds.Tables[0].Compute("sum(Deduction_Value)", "").ToString();
            grdDeductions.FooterRow.Cells[6].Text = ds.Tables[0].Compute("sum(DeductionReleaseAmount)", "").ToString();
            lblTotalAmount.Text = ds.Tables[0].Compute("sum(DeductionReleaseAmount)", "").ToString();
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        if (Session["UserType"].ToString() == "1")
        {
            ds = (new DataLayer()).get_tbl_Package_DeductionRelease(0, Scheme_Id, 0, Zone_Id, Circle_Id, Division_Id, 0, "", "", 0, 0, true, "", "", Expert_Person_Id, 0, 0, false, isDefered, 0);
        }
        else
        {
            ds = (new DataLayer()).get_tbl_Package_DeductionRelease(0, Scheme_Id, 0, Zone_Id, Circle_Id, Division_Id, 0, "", "", Convert.ToInt32(Session["Person_BranchOffice_Id"].ToString()), Convert.ToInt32(Session["PersonJuridiction_DesignationId"].ToString()), false, "", "", Expert_Person_Id, 0, 0, false, isDefered, 0);
        }
        if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
        {
    ...
    private void get_ProcessConfig_Current(int Scheme_Id, string _loop)
    {
        ...
        else
        {
            ...
            ds = (new DataLayer()).get_ProcessConfig_Current(Scheme_Id, "PackageDeductionRelease", Convert.ToInt32(Session["Person_BranchOffice_Id"].ToString()), Convert.ToInt32(Session["PersonJuridiction_DesignationId"].ToString()), Loop, Convert.ToInt32(hf_Package_DeductionRelease_Id.Value));
            if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
    ...
    private void get_ProcessConfigMaster_Last(int ProcessConfigMaster_Id_Current, int Scheme_Id, int Loop)
    {
        ...
        else
        {
            ...
            ds = (new DataLayer()).get_ProcessConfigMaster_Last_Package_DeductionReleaseApproval(Scheme_Id, Loop, null, null);
            if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
    ...
    protected void btnApprove_Click(object sender, EventArgs e)
    {
        ...
        List<tbl_Package_DeductionRelease_Item_Approval> obj_tbl_Package_DeductionRelease_Item_Approval_Li = new List<tbl_Package_DeductionRelease_Item_Approval>();
        for (int i = 0; i < grdDeductions.Rows.Count; i++)
        {
            ...
            tbl_Package_DeductionRelease_Item_Approval obj_tbl_Package_DeductionRelease_Item_Approval = new tbl_Package_DeductionRelease_Item_Approval();
            obj_tbl_Package_DeductionRelease_Item_Approval.Package_DeductionRelease_Item_Approval_AddedBy = Convert.ToInt32(Session["Person_Id"].ToString());
            try
            {
                obj_tbl_Package_DeductionRelease_Item_Approval.Package_DeductionRelease_Item_Approval_DeductionValue = Convert.ToDecimal(txtDeductionValue.Text.Trim());
            }
            catch
            {
                obj_tbl_Package_DeductionRelease_Item_Approval.Package_DeductionRelease_Item_Approval_DeductionValue = 0;
            }
            try
            {
                obj_tbl_Package_DeductionRelease_Item_Approval.Package_DeductionRelease_Item_Approval_DeductionReleaseAmount = Convert.ToDecimal(txtDeductionRelease.Text.Trim());
            }
            catch
            {
                obj_tbl_Package_DeductionRelease_Item_Approval.Package_DeductionRelease_Item_Approval_DeductionReleaseAmount = 0;
            }
            obj_tbl_Package_DeductionRelease_Item_Approval.Package_DeductionRelease_Item_Approval_Package_DeductionRelease_Item_Id = Convert.ToInt32(grdDeductions.Rows[i].Cells[0].Text.Trim());
            obj_tbl_Package_DeductionRelease_Item_Approval.Package_DeductionRelease_Item_Status = 1;
            obj_tbl_Package_DeductionRelease_Item_Approval_Li.Add(obj_tbl_Package_DeductionRelease_Item_Approval);
        }
        ...
        for (int i = 0; i < grdDocumentMaster.Rows.Count; i++)
        {
            ...
            if (flUpload.HasFile)
            {
                ...
                obj_tbl_Package_DeductionRelease_Docs.Package_DeductionRelease_Docs_Package_DeductionRelease_Id = Convert.ToInt32(hf_Package_DeductionRelease_Id.Value);
                ...
                obj_tbl_Package_DeductionRelease_Docs.Package_DeductionRelease_Docs_Type = Convert.ToInt32(grdDocumentMaster.Rows[i].Cells[1].Text.Trim());
        ...
        obj_tbl_Package_DeductionReleaseApproval.Package_DeductionReleaseApproval_Package_DeductionRelease_Id = Convert.ToInt32(hf_Package_DeductionRelease_Id.Value);
        ...
        obj_tbl_Package_DeductionReleaseApproval.Package_DeductionReleaseApproval_Status_Id = Convert.ToInt32(ddlStatus.SelectedValue);
        try
        {
            obj_tbl_Package_DeductionReleaseApproval.Package_DeductionReleaseApproval_Additional_Status_Id = Convert.ToInt32(ddlAdditionalReason.SelectedValue);
        }
        catch
        {
        ...
        if (divAmountTransfered.Visible && obj_tbl_Package_DeductionReleaseApproval.Package_DeductionReleaseApproval_Status_Id == 1 && Transfred_Amount != 0)
        {
            ...
            obj_tbl_FinancialTrans.FinancialTrans_Package_DeductionRelease_Id = Convert.ToInt32(hf_Package_DeductionRelease_Id.Value);
        ...
        if (divPPA.Visible)
        {
            if (hf_Scheme_Id.Value == "1013" || hf_Scheme_Id.Value == "1016")
            {
                ...
                obj_tbl_SNAAccountLimitUsed.SNAAccountLimitUsed_UsageType = "D";
                obj_tbl_SNAAccountLimitUsed.SNAAccountLimitUsed_Usage_Id = Convert.ToInt32(hf_Package_DeductionRelease_Id.Value);
        ...
        if (obj_tbl_Package_DeductionRelease_Item_Approval_Li == null || obj_tbl_Package_DeductionRelease_Item_Approval_Li.Count == 0)
        {
            MessageBox.Show("Please Select At One One Item.");
            return;
        }
        if (new DataLayer().Insert_tbl_Package_DeductionRelease_Item_Approval(obj_tbl_Package_DeductionRelease_Item_Approval_Li, obj_tbl_Package_DeductionReleaseApproval, Convert.ToInt32(Session["Person_BranchOffice_Id"].ToString()), Convert.ToInt32(Session["PersonJuridiction_DesignationId"].ToString()), Convert.ToInt32(hf_Scheme_Id.Value), Convert.ToInt32(hf_Loop.Value), obj_tbl_Package_DeductionRelease_Docs_Li, chkUpdateExisting.Checked, obj_tbl_FinancialTrans, obj_tbl_SNAAccountLimitUsed))
        {
            reset();
    ...
    protected void btnRecommend_Click(object sender, EventArgs e)
    {
        ...
        obj_tbl_Package_DeductionReleaseApproval.Package_DeductionReleaseApproval_Comments = txtComments.Text.Trim();
        obj_tbl_Package_DeductionReleaseApproval.Package_DeductionReleaseApproval_Status_Id = Convert.ToInt32(ddlStatus.SelectedValue);
        obj_tbl_Package_DeductionReleaseApproval.Package_DeductionReleaseApproval_Next_Organisation_Id = 2;
        obj_tbl_Package_DeductionReleaseApproval.Package_DeductionReleaseApproval_Next_Designation_Id = 1;
        obj_tbl_Package_DeductionReleaseApproval.Package_DeductionReleaseApproval_Step_Count = 10;
        try
        {
            obj_tbl_Package_DeductionReleaseApproval.Package_DeductionReleaseApproval_Additional_Status_Id = Convert.ToInt32(ddlAdditionalReason.SelectedValue);
        }
    ...
    protected void btnRevert_Click(object sender, EventArgs e)
    {
        ...
        if (Loop == 1)
            ...
            obj_tbl_Package_DeductionReleaseApproval.Package_DeductionReleaseApproval_Next_Designation_Id = 4;
