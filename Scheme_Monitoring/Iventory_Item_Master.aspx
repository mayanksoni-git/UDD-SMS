<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin2.master" AutoEventWireup="true" CodeFile="Iventory_Item_Master.aspx.cs" Inherits="Iventory_Item_Master" %>
                ...
                <ContentTemplate>
                    ...
                    <div class="page-content">
                        <div class="page-header">
                            <div class="row">
                                <h1>Create / Update Item Master *</h1>
                            </div>
                        </div>
                        </br>
                        <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-3">
                                                <div class="form-group">
                                                    <label class="control-label no-padding-right">DIA:</label>
                                                    <asp:TextBox ID="txtDia" runat="server" CssClass="form-control"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="col-xs-3">
                                                <div class="form-group">
                                                    <label class="control-label no-padding-right">Guage:</label>
                                                    <asp:TextBox ID="txtGuage" runat="server" CssClass="form-control"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="row">
                                            <div class="col-xs-3">
                                                <div class="form-group">
                                                    <label class="control-label no-padding-right">Length:</label>
                                                    <asp:TextBox ID="txtLength" runat="server" CssClass="form-control"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="col-xs-3">
                                                <div class="form-group">
                                                    <label class="control-label no-padding-right">Bredth:</label>
                                                    <asp:TextBox ID="txtBredth" runat="server" CssClass="form-control"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="col-xs-3">
                                                <div class="form-group">
                                                    <label class="control-label no-padding-right">Height:</label>
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-3">
                                                <div class="form-group">
                                                    <label class="control-label no-padding-right">Product Type:</label>
                                                    <asp:DropDownList ID="ddlProductType" runat="server" CssClass="form-control"></asp:DropDownList>
                                                </div>
                                            </div>
                                            <div class="col-xs-3">
                                                <div class="form-group">
                                                    <label class="control-label no-padding-right">Product Company:</label>
                                                    <asp:DropDownList ID="ddlProductCompany" runat="server" CssClass="form-control"></asp:DropDownList>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-4">
                                                <div class="form-group">
                                                    <br />
                                                    <asp:Button ID="btnReset" Text="Reset" OnClick="btnReset_Click" runat="server" CssClass="btn btn-danger"></asp:Button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
