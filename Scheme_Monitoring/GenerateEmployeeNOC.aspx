<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin2.master" AutoEventWireup="true" CodeFile="GenerateEmployeeNOC.aspx.cs" Inherits="GenerateEmployeeNOC" %>
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        <div class="table-header">
                                            Retired Employee Details For NOC Generation
                                        </div>
                                        <br />
                                        <div style="overflow: auto">
                                            <asp:GridView ID="grdPost" runat="server" CssClass="display table table-bordered" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdPost_PreRender">
                                                <Columns>
                                                    ...
                                                    <asp:BoundField HeaderText="Date Of Joining" DataField="HRMSEmployee_JoinDateInService" />
                                                    <asp:BoundField HeaderText="Date Of Retirement" DataField="HRMSEmployeeJuridiction_RetirementDate" />
                                                    <asp:BoundField HeaderText="Employee Code" DataField="HRMSEmployee_DepartmentalEmployeeCode" />
                                                    <asp:BoundField HeaderText="Manav Sampada Code" DataField="HRMSEmployee_HRMSCode" />
                                                    <asp:TemplateField HeaderText="Edit">
                                                        <ItemTemplate>
                                                            <asp:ImageButton ID="btnEdit" runat="server" Width="20px" Height="20px" OnClick="btnEdit_Click" ImageUrl="~/assets/images/edit.png" />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                            </asp:GridView>
                                                ...
                                                <div style="overflow: auto">
                                                    <asp:GridView ID="dgvQuestionnaire" runat="server" CssClass="display table table-bordered" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="dgvQuestionnaire_PreRender" OnRowDataBound="dgvQuestionnaire_RowDataBound">
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="NOCQuestionnaire_Sr" HeaderText="Serial No" />
                                                            <asp:BoundField HeaderText="DPR Questions" DataField="NOCQuestionnaire_Name" />
                                                            <asp:TemplateField HeaderText="Answer / Comments">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtNOCQuestionnaire_Answer" runat="server" CssClass="form-control"></asp:TextBox>
                                                                    <asp:RadioButtonList ID="rbtNOCQuestionnaire_Answer" runat="server" RepeatDirection="Horizontal">
                                                            ...
                                                            <asp:TemplateField HeaderText="Upload Document">
                                                                <ItemTemplate>
                                                                    <asp:FileUpload ID="flUpload" runat="server" CssClass="form-control"></asp:FileUpload>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Date">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtDateIssue" runat="server" CssClass="form-control date-picker" autocomplete="off" data-date-format="dd/mm/yyyy"></asp:TextBox>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Remark">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtNOCQuestionnaire_Remark" runat="server" CssClass="form-control"></asp:TextBox>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                        </Columns>
                                                    </asp:GridView>
