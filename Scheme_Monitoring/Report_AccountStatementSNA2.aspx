<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true"
    CodeFile="Report_AccountStatementSNA2.aspx.cs" Inherits="Report_AccountStatementSNA2" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" ValidateRequest="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                            ...
                            <div class="col-xs-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <br />
                                            <asp:RadioButtonList ID="rbtReportType" runat="server" RepeatDirection="Vertical">
                                                <asp:ListItem Text="Limit Assigned" Value="Limit" Selected="True"></asp:ListItem>
                                                <asp:ListItem Text="Expenditure As Per ePayment" Value="Expenditue ePayment"></asp:ListItem>
                                                <asp:ListItem Text="Expenditure As Per Bank" Value="Expenditue Bank"></asp:ListItem>
                                            </asp:RadioButtonList>
                                        </div>
                                    </div>
                                        ...
                                        <div style="overflow: auto">
                                            <asp:GridView ID="grdPost" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdPost_PreRender" ShowFooter="true">
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="AddedOn" HeaderText="Assigned On" />
                                            ...
                                            <asp:GridView ID="grdEPayment" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdEPayment_PreRender" ShowFooter="true">
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="SNAAccountLimitUsed_PPANumber" HeaderText="Transaction No" />
                                                    <asp:BoundField DataField="SNAAccountLimitUsed_BatchId" HeaderText="Batch Id" />
    ...
    <script type="text/javascript">
        Sys.WebForms.PageRequestManager.getInstance().add_pageLoaded(function (evt, args) {
            jQuery(function ($) {
                var DataTableLength = $('#ctl00_ContentPlaceHolder1_grdEPayment').length;
                if (DataTableLength > 0) {
                    var outerHTML = $('#ctl00_ContentPlaceHolder1_grdEPayment')[0].outerText;
                    if (outerHTML.trim() !== "No Records Found") {
                        ...
                        //initiate dataTables plugin
                        var myTable =
                            $('#ctl00_ContentPlaceHolder1_grdEPayment')
                                //.wrap("<div class='dataTables_borderWrap' />")   //if you are applying horizontal scrolling (sScrollX)
                                .DataTable({
                                    mark: true,
                                    colReorder: true,
                        ...
                        $(document).on('click', '#ctl00_ContentPlaceHolder1_grdEPayment .dropdown-toggle', function (e) {
                            e.stopImmediatePropagation();
                            e.stopPropagation();
                            //e.preventDefault();
                        });
