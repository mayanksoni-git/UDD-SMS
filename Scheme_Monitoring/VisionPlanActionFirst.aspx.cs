...
public partial class VisionPlanActionFirst : System.Web.UI.Page
{
    ...
    protected void GetEditExpenseList()
    {
        ...
        dt = objLoan.GetVisionPlan("select",0,ULB,0,state,"",dist,FY,"","","", Convert.ToInt32(Session["Person_Id"].ToString()), "",0,"","","","","","",0,0,-1,0);
    ...
    protected void grdPost_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        try
        {
            if (e.CommandName == "delete")
            {
                ...
                DataTable dt = new DataTable();
                dt = objLoan.GetVisionPlan("delete", 0, 0, pk, 0, "", 0, 0, "", "", "", Convert.ToInt32(Session["Person_Id"].ToString()), "", 0, "", "", "", "", "","",0,0,-1,0);
    ...
    protected void BtnSearch_Click(object sender, EventArgs e)
    {
        ...
        dt = objLoan.GetVisionPlan("SelectForaAction", 0, ulb, 0, state, check, dist, fy, year, "", "", Convert.ToInt32(Session["Person_Id"].ToString()), "", 0, "", priority, "", "", "","",0, VisionStatus, AkanshiULB, 0);
