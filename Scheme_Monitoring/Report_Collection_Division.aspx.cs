...
public partial class Report_Collection_Division : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            get_Circle_Wise_Details(Scheme_Id, Zone_Id, Circle_Id, Division_Id);
        }
    }

    private void get_Circle_Wise_Details(int Scheme_Id, int Zone_Id, int Circle_Id, int Division_Id)
    {
    ...
    protected void lnkDivision_Click(object sender, EventArgs e)
    {
        ...
        string Division_Id = (lnkDivision.Parent.Parent as GridViewRow).Cells[0].Text;
        string Circle_Id = (lnkDivision.Parent.Parent as GridViewRow).Cells[1].Text;
        string Zone_Id = (lnkDivision.Parent.Parent as GridViewRow).Cells[2].Text;
        int Scheme_Id = 0;
        if (Request.QueryString.Count > 0)
        {
            Scheme_Id = Convert.ToInt32(Request.QueryString[0].ToString());
