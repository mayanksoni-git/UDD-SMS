<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true" CodeFile="MasterProjectWork_Road_Reinst.aspx.cs" Inherits="MasterProjectWork_Road_Reinst" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" ValidateRequest="false" %>
                                        ...
                                        <div style="overflow: auto">
                                            <asp:GridView ID="grdPost" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdPost_PreRender" OnRowDataBound="grdPost_RowDataBound">
                                                <Columns>
                                                    ...
                                                    <asp:BoundField HeaderText="Total Length of Sewer/ Water Supply line to be laid (km)" DataField="ProjectRoadReinst_TotalLengthLaid" />
                                                    <asp:BoundField HeaderText="Total Length of Sewer/ Water Supply line laid till Date (km)" DataField="ProjectRoadReinst_TotalLengthLaid_TillDate" />
                                                    <asp:BoundField HeaderText="Length of Sewer/ Water Supply line yet to be laid (km)" DataField="ProjectRoadReinst_TotalLengthLaid_Pending" />
                                                    <asp:BoundField HeaderText="Total Road Length which has been dismantled (km) till Date" DataField="ProjectRoadReinst_TotalLengthLaid_Dismental" />
                                                    <asp:BoundField HeaderText="Total Road length made motorable (km)" DataField="ProjectRoadReinst_TotalLengthLaid_Moterable" />
                                                    <asp:BoundField HeaderText="Total Road length completely reinstated (km)" DataField="ProjectRoadReinst_TotalLengthLaid_Reinstatement" />
                                                    <asp:BoundField HeaderText="Total Road Length reinstated (including motorable) KM" DataField="ProjectRoadReinst_TotalLengthLaid_Reinstatement_And_Moterable" />
                                                    <asp:BoundField HeaderText="Comments" DataField="ProjectRoadReinst_Comments" />
                                                    <asp:TemplateField HeaderText="View Photos Uploaded">
                                                        <ItemTemplate>
                                                            <a target="_blank" href="ProjectWorkRoadGalleryView.aspx?ProjectWork_Id=<%# Eval("ProjectWork_Id") %>">View Photos</a>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                            </asp:GridView>
