<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true"
    CodeFile="Report_Salary_Register_Details.aspx.cs" Inherits="Report_Salary_Register_Details" %>
                    ...
                    <div class="page-content">
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div style="overflow: auto">
                                            <asp:GridView ID="grdPost" runat="server" CssClass="display table table-bordered"
                                                ...
                                                <Columns>
                                                    <asp:BoundField DataField="HRMS_Salary_Details_Id" HeaderText="HRMS_Salary_Details_Id">
                                                    ...
                                                    <asp:BoundField HeaderText="Name of Employee" DataField="Name" />
                        ...
                        <asp:Panel ID="Panel1" runat="server" CssClass="modalPopup1" Style="display: none; width: 1000px; height: 500px; margin-left: -32px" ScrollBars="Auto">
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="table-header">
                                        Transfer Selected Employee To Other Division
                                    </div>
                                </div>
                            </div>
                        ...
                        <asp:HiddenField runat="server" ID="hf_HRMS_Salary_Details_Id" Value="0" />
                    </div>
                </ContentTemplate>
                <Triggers>
