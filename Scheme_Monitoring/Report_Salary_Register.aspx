<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true"
    CodeFile="Report_Salary_Register.aspx.cs" Inherits="Report_Salary_Register" %>
                    ...
                    <div class="page-content">
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <h3 class="header smaller lighter blue">Salary Register</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        <div class="table-header">
                                            Zone / Circle / Division Wise Salary Details
                                        </div>
                                        ...
                                        <div style="overflow: auto">
                                            <asp:GridView ID="grdPost" runat="server" CssClass="table table-striped table-bordered table-hover"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField HeaderText="Total Employees" DataField="Total_Employees" />
                                                    <asp:BoundField HeaderText="Total Employees Verified" DataField="Total_Employees_Verified" />
