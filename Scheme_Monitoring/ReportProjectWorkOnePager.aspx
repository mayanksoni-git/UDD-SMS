<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true" CodeFile="ReportProjectWorkOnePager.aspx.cs" Inherits="ReportProjectWorkOnePager" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" ValidateRequest="false" %>
                            ...
                            <div class="col-xs-12">
                                <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        <div id="divSNAStatus" runat="server" visible="false">
                                            <div class="row">
                                                <div class="col-xs-12">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div id="div3" runat="server" class="col-md-3">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <asp:Label ID="Label1" runat="server" CssClass="control-label no-padding-right" Text="Project Code"></asp:Label>
                                                        <asp:TextBox ID="txtProjectCode" runat="server" CssClass="form-control">
                                                        </asp:TextBox>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <br />
                                                        <asp:CheckBox ID="chkVariationOnly" runat="server" Text="Show Projects In Which Variation is Done" />
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="S No.">
                                                        <ItemTemplate>
                                                            ...
                                                            <br />
                                                            <br />
                                                            <b><a href='Report_AccountStatement.aspx?ProjectWork_Id=<%# Eval("ProjectWork_Id") %>' target="_blank"><span style="color: red">a) SNA Statement</span></a></b>
                                                            <br />
                                                            <br />
                                                            <b><a href='MasterProjectWorkMIS_3.aspx?ProjectWork_Id=<%# Eval("ProjectWork_Id") %>&Id=<%# Eval("ProjectWork_Project_Id") %>' target="_blank"><span style="color: green">b) Expenditure</span></a></b>
                                                            <br />
                                                            <br />
                                                            <b><a href='MasterProjectWorkMIS_5.aspx?ProjectWork_Id=<%# Eval("ProjectWork_Id") %>&Id=<%# Eval("ProjectWork_Project_Id") %>' target="_blank"><span style="color: green">c) Document Vault</span></a></b>
                                                            <br />
                                                            <br />
                                                            <b><a target="_blank" href="ProjectWorkFeildVisitUploadView.aspx?ProjectWork_Id=<%# Eval("ProjectWork_Id") %>">d) Site Visit Report</a></b>
                                                            <br />
                                                            <a target="_blank" href="ProjectWorkGalleryView.aspx?ProjectWork_Id=<%# Eval("ProjectWork_Id") %>">e) Project Site Pics
                                                            </a>
                                                            <br />
                                                            <br />
                                                            <asp:LinkButton runat="server" ID="lnkExportBOQ" Text="f) Export BOQ" OnClick="lnkExportBOQ_Click" Font-Bold="true"></asp:LinkButton>
                                                            <br />
                                                            <br />
                                                            <a target="_blank" href="MasterProjectWorkVariationDocument?Scheme_Id=<%# Eval("ProjectWork_Project_Id") %>&Zone_Id=0&Circle_Id=0&Division_Id=0&ProjectWork_Id=<%# Eval("ProjectWork_Id") %>">g) Variation: <%# Eval("Variation") %>
                                                            </a>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="Critical Dates">
                                                        <ItemTemplate>
                                                            <table class="display table table-bordered no-margin-bottom no-border-top">
                                                                <tbody>
                                                                    <tr>
                                                                        <td>GO Date</td>
                                                                        <td><%# Eval("ProjectWork_GO_Date") %></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>Start Date As Per Agreement</td>
                                                                        <td><%# Eval("ProjectWorkPkg_Start_Date") %></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>End Date as per Agreement</td>
                                                                        <td><%# Eval("Target_Date_Agreement") %></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>Completion Date with time Extension</td>
                                                                        <td><%# Eval("Target_Date_Agreement_Extended") %></td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                        </ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="SNA Limit Assigned">
                                                        <ItemTemplate>
                                                            <table class="display table table-bordered no-margin-bottom no-border-top">
                                                                <thead>
                                                                    <tr>
                                                    ...
                                                    <asp:TemplateField HeaderText="Physical Component Details">
                                                        <ItemTemplate>
                                                            <asp:GridView ID="grdPhysicalComponent" runat="server" AutoGenerateColumns="False" CssClass="display table table-bordered"
                                                    ...
                                                    <asp:TemplateField HeaderText="Issues (If Any)">
                                                        <ItemTemplate>
                                                            <table class="display table table-bordered no-margin-bottom no-border-top">
                                                                <tbody>
                                                                    <tr>
