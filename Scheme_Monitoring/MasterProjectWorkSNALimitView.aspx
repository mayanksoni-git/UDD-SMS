<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true" CodeFile="MasterProjectWorkSNALimitView.aspx.cs" Inherits="MasterProjectWorkSNALimitView" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" ValidateRequest="false" %>
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="S No.">
                                                        <ItemTemplate>
                                                            ...
                                                            <br />
                                                            <br />
                                                            <b><a target="_blank" href="ProjectWorkFeildVisitUploadView.aspx?ProjectWork_Id=<%# Eval("ProjectWork_Id") %>">Site Visit Report</a></b>
                                                            <br />
                                                            <br />
                                                            <a target="_blank" href="ProjectWorkGalleryView.aspx?ProjectWork_Id=<%# Eval("ProjectWork_Id") %>">
                                                                <img src="assets/images/gallery.jpg" width="50px" height="50px" title="View Gallery" />
                                                            </a>
                                                            <br />
                                                            <br />
                                                            <asp:LinkButton runat="server" ID="lnkExportBOQ" Text="Export BOQ" OnClick="lnkExportBOQ_Click" Font-Bold="true"></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
