...
{
    public class PNBAccountBalRepository : RepositoryAsyn
    {
        public PNBAccountBalRepository(string connectionString) : base(connectionString) { }
        /// <summary>
        /// 
        /// </summary>
        ...
        /// <returns></returns>
        public async Task<tbl_SNAAccountBalance> get_PNBAccountBal(int SNAAccountMaster_Id)
        {
            tbl_SNAAccountBalance obj_tbl_SNAAccountBalance = get_tbl_PNBAccountBal(SNAAccountMaster_Id);
            return obj_tbl_SNAAccountBalance;
        }
        private tbl_SNAAccountBalance get_tbl_PNBAccountBal(int SNAAccountMaster_Id)
        {
