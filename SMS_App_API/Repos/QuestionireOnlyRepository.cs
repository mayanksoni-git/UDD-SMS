...
{
    public class QuestionireOnlyRepository : RepositoryAsyn
    {
        public QuestionireOnlyRepository(string connectionString) : base(connectionString) { }
        /// <summary>
        /// 
        /// </summary>
            ...
            try
            {
                ...
                if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
                {
                    for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                    {
                        ...
                        obj_tbl_ProjectQuestionnaire.obj_tbl_ProjectAnswer_Li = null;
                        ...
                        //obj_tbl_ProjectQuestionnaire.obj_tbl_ProjectAnswer_Li = get_tbl_ProjectAnswer(obj_tbl_ProjectQuestionnaire.ProjectQuestionnaire_Id);
