...
namespace ePayment_API.Repos
{
    public class SitePicSummeryRepository : RepositoryAsyn
    {
        ...
        /// <returns></returns>
        public async Task<List<tbl_ProjectUC>> get_SitePic(SearchCriteria obj_SearchCriteria)
        {
            List<tbl_ProjectUC> obj_tbl_ProjectUC_Li = get_tbl_ProjectUC(obj_SearchCriteria);
            return obj_tbl_ProjectUC_Li;
        }
        private List<tbl_ProjectUC> get_tbl_ProjectUC(SearchCriteria obj_SearchCriteria)
        {
            List<tbl_ProjectUC> obj_tbl_ProjectUC_Li = new List<tbl_ProjectUC>();
            try
            {
                DataSet ds = new DataLayer().get_DPR_UC_Details(obj_SearchCriteria.ProjectDPR_Id, obj_SearchCriteria.ProjectWork_Id);
