...
{
    public class PNBAccountBalSNARepository : RepositoryAsyn
    {
        public PNBAccountBalSNARepository(string connectionString) : base(connectionString) { }
        /// <summary>
        /// 
        /// </summary>
        ...
        /// <returns></returns>
        public async Task<tbl_SNAAccountBalance> get_PNBAccountBalSNA(int Parent_Master_Id)
        {
            tbl_SNAAccountBalance obj_tbl_SNAAccountBalance = get_tbl_PNBAccountBalSNA(Parent_Master_Id);
            return obj_tbl_SNAAccountBalance;
        }
        private tbl_SNAAccountBalance get_tbl_PNBAccountBalSNA(int Parent_Master_Id)
        {
            ...
            try
            {
                ...
                string Account_No = new DataLayer().get_tbl_SNAAccountParentMaster(Parent_Master_Id);
                #endregion
                if (Account_No != "")
                {
                    #region Plain Request
                    PNB_GetAccountBal_Req obj_PNB_GetAccountBal_Req = new PNB_GetAccountBal_Req();
                    obj_PNB_GetAccountBal_Req.Account_Number = Account_No;
                    ...
                    obj_tbl_SNA_API_History.SNA_API_History_API_Type = "Get_Account_Balance";
                    ...
                    if (obj_PNB_Global_R != null)
                    {
                        ...
                        obj_tbl_SNAAccountBalance.SNAAccountBalance_SNAAccountMaster_Id = Parent_Master_Id;
        ...
        public PNB_Global Get_Account_Balance(PNB_Global obj_PNB_Global, ref string StatusCode, ref string ReasonPhrase)
        {
            ...
            {
                client.BaseAddress = new Uri(System.Configuration.ConfigurationManager.AppSettings["API_Base_URL"] + "/Get_Account_Balance");
