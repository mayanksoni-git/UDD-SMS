...
{
    public class PNBGetPPADetailsRepository : RepositoryAsyn
    {
        public PNBGetPPADetailsRepository(string connectionString) : base(connectionString) { }
        /// <summary>
        /// 
        /// </summary>
        ...
        /// <returns></returns>
        public async Task<string> get_PNBGetPPADetails(int SNAAccountMaster_Id)
        {
            string _val = get_tbl_PNBGetPPADetails(SNAAccountMaster_Id);
            return _val;
        }
        public async Task<tbl_SNAPPADetails> get_PNBGetPPADetails(PPA_Details obj_PPA_Details)
        {
            tbl_SNAPPADetails obj_tbl_SNAPPADetails = get_tbl_PNBGetPPADetails(obj_PPA_Details);
            return obj_tbl_SNAPPADetails;
        }

        private tbl_SNAPPADetails get_tbl_PNBGetPPADetails(PPA_Details obj_PPA_Details)
        {
            ...
            obj_tbl_SNA_API_History.SNA_API_History_API_Type = "GetPPADetails";
            ...
            if (obj_PNB_Global_R != null)
            {
                ...
                obj_tbl_SNAPPADetails.SNAPPADetails_SNAAccountMaster_Id = obj_PPA_Details.PPA_Invoice_Id;
        ...
        private string get_tbl_PNBGetPPADetails(int SNAAccountMaster_Id)
        {
            string response = "false";
            PNB_Global obj_PNB_Global = new PNB_Global();
            ...
            if (Utility.CheckDataSet(ds))
            {
                ...
                #region Plain Request
                PNB_GetPPADetails_Req obj_PNB_GetPPADetails_Req = new PNB_GetPPADetails_Req();
                obj_PNB_GetPPADetails_Req.PPA_Number = "c012250313877"; //ds.Tables[0].Rows[0]["SNAAccountMaster_ACCT_NO"].ToString().Trim();
                obj_PNB_GetPPADetails_Req.Entity_Code = "AMRUT";
                obj_PNB_GetPPADetails_Req.Unique_Id = DateTime.Now.Ticks.ToString();
                string PNB_GetAccountBal_Req_json = Newtonsoft.Json.JsonConvert.SerializeObject(obj_PNB_GetPPADetails_Req);
                #endregion
        ...
        public PNB_Global Get_Account_Balance(PNB_Global obj_PNB_Global, ref string StatusCode, ref string ReasonPhrase)
        {
            ...
            {
                client.BaseAddress = new Uri(System.Configuration.ConfigurationManager.AppSettings["API_Base_URL"] + "/GetPPADetails");
